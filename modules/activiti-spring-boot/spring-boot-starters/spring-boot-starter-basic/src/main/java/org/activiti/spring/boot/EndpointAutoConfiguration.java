...
/**
 * The idea behind this module is that Spring Security could talk to the {@link org.activiti.engine.IdentityService} as
 * required.
 * 
 * @author Josh Long
 */
...
public class EndpointAutoConfiguration
{
    ...
    @Bean
    public ProcessEngineMvcEndpoint processEngineMvcEndpoint(ProcessEngineEndpoint engineEndpoint,
