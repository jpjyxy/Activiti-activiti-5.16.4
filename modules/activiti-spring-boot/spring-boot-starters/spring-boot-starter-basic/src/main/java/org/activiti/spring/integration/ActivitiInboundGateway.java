...
public class ActivitiInboundGateway extends MessagingGatewaySupport
{
    ...
    public void execute(IntegrationActivityBehavior receiveTaskActivityBehavior, ActivityExecution execution)
        throws Exception
    {
    ...
    public void signal(IntegrationActivityBehavior receiveTaskActivityBehavior, ActivityExecution execution,
