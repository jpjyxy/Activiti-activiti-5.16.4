...
public class DataSourceProcessEngineAutoConfiguration
{
    ...
    public static class DataSourceConfiguration extends AbstractProcessEngineAutoConfiguration
    {
        ...
        public SpringProcessEngineConfiguration springProcessEngineConfiguration(DataSource dataSource,
            PlatformTransactionManager transactionManager, SpringJobExecutor springJobExecutor)
            throws IOException
        {
            
            return this.baseSpringProcessEngineConfiguration(dataSource, transactionManager, springJobExecutor);
        }
    }
