...
public class IntegrationAutoConfigurationTest
{
    ...
    @Test
    public void testLaunchingGatewayProcessDefinition()
        throws Exception
    {
        ...
        List<ProcessDefinition> processDefinitionList =
            repositoryService.createProcessDefinitionQuery().processDefinitionKey(integrationGatewayProcess).list();
        ...
        org.junit.Assert.assertTrue(applicationContext.getBean(InboundGatewayConfiguration.AnalysingService.class)
            .getStringAtomicReference()
            .get()
            .equals(projectId));
    }
