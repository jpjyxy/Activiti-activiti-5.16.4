...
public class EndpointAutoConfigurationTest
{
    ...
    @Configuration
    @Import({DataSourceAutoConfiguration.class, MetricFilterAutoConfiguration.class,
        ...
        throws Throwable
    {
        ...
        ResponseEntity<Map> mapResponseEntity = restTemplate.getForEntity("http://localhost:8080/activiti/", Map.class);
