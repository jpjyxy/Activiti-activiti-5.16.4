...
public class RestApiAutoConfigurationTest
{
    ...
    @Configuration
    @Import({EmbeddedServletContainerAutoConfiguration.class, MultipartAutoConfiguration.class,
        ServerPropertiesAutoConfiguration.class, DataSourceAutoConfiguration.class,
        DataSourceProcessEngineAutoConfiguration.DataSourceConfiguration.class, RestApiAutoConfiguration.class})
     ...
     * WebMvcAutoConfiguration.class, DataSourceAutoConfiguration.class,
     * DataSourceProcessEngineAutoConfiguration.DataSourceConfiguration.class, RestApiAutoConfiguration.class }) public
        ...
        throws Throwable
    {
        ...
        String authenticationChallenge =
            "http://localhost:" + this.context.getEmbeddedServletContainer().getPort()
