...
public class SecurityAutoConfigurationTest
{
        ...
        throws Throwable
    {
        ...
        assertEquals("there should only be 1 authority", userDetailsService.loadUserByUsername("jlong")
            .getAuthorities()
            .size(), 1);
        assertEquals("there should be 2 authorities", userDetailsService.loadUserByUsername("jbarrez")
            .getAuthorities()
            .size(), 2);
    }
    ...
    public static class SecurityConfiguration
    {
        ...
        @Bean
        InitializingBean init(final IdentityService identityService)
        {
