...
public interface RestAuthenticator
{
    ...
    /**
     * Called before check is done to see if the request originates from a valid user. Allows disabling authentication
     * and authorisation for certain requests.
     * 
     * @return true, if the request requires a valid and authorised user. Return false, if the request can be executed
     *         without authentication or authorisation. If false is returned, the
