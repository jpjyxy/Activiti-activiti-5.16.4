...
public class BarDeploymentListener implements ArtifactUrlTransformer
{
    ...
    public boolean canHandle(File artifact)
    {
        ...
        try
        {
            ...
            if (m != null && m.getMainAttributes().getValue(new Attributes.Name(BUNDLE_SYMBOLICNAME)) != null
                && m.getMainAttributes().getValue(new Attributes.Name(BUNDLE_VERSION)) != null)
            {
                return false;
            }
            return true;
