...
public class BarTransformer
{
    ...
    public static void transform(URL url, OutputStream os)
        throws Exception
    {
        ...
        try
        {
            ...
            while ((e = jis.getNextEntry()) != null)
            {
                ...
                int i = n.lastIndexOf('/');
                if (-1 == i)
                {// Add root path if the .bpmn20.xml is in the root of the bar file and the value is example.bpmn20.xml
                    paths.add("/"); // Extender#checkBundle calls the HeaderParser#parseHeader and it does not parse an
                                    // empty string
                }
