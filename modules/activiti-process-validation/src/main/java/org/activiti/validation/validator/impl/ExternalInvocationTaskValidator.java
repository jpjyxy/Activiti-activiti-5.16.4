...
public abstract class ExternalInvocationTaskValidator extends ProcessLevelValidator
{
    ...
    protected void validateFieldDeclarationsForEmail(org.activiti.bpmn.model.Process process, Task task,
    ...
    protected void validateFieldDeclarationsForShell(org.activiti.bpmn.model.Process process, Task task,
        List<FieldExtension> fieldExtensions, List<ValidationError> errors)
    {
