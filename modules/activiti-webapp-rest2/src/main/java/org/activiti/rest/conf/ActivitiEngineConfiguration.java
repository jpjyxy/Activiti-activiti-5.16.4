...
public class ActivitiEngineConfiguration
{
    ...
    public DataSource dataSource()
    {
        ...
        try
        {
            ...
            Class<? extends Driver> driverClass =
                (Class<? extends Driver>)Class.forName(environment.getProperty("jdbc.driver", "org.h2.Driver"));
    ...
    public ProcessEngineConfigurationImpl processEngineConfiguration()
    {
        ...
        processEngineConfiguration.setJobExecutorActivate(Boolean.valueOf(environment.getProperty("engine.activate.jobexecutor",
            "false")));
