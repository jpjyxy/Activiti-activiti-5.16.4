...
public class DemoDataConfiguration
{
    ...
    {
        createUser("kermit", "Kermit", "The Frog", "kermit", "kermit@activiti.org", null, Arrays.asList("management",
            "sales",
            "marketing",
            "engineering",
            "user",
            "admin"), Arrays.asList("birthDate",
            "10-10-1955",
            "jobTitle",
            "Muppet",
            "location",
        ...
        String imageResource, List<String> groups, List<String> userInfo)
    {
        ...
        {
            byte[] pictureBytes =
                IoUtil.readInputStream(this.getClass().getClassLoader().getResourceAsStream(imageResource), null);
        ...
        if (modelList == null || modelList.isEmpty())
        {
            ...
            try
            {
                InputStream svgStream =
                    this.getClass().getClassLoader().getResourceAsStream("org/activiti/rest/demo/model/test.svg");
