...
public class ActivityEventsTest extends PluggableActivitiTestCase
{
    ...
    /**
     * Test starting and completed events for activity. Since these events are dispatched in the core of the PVM, not
     * all individual activity-type is tested. Rather, we test the main types (tasks, gateways, events, subprocesses).
     */
    @Deployment
     ...
     */
    @Deployment
    public void testActivitySignalEvents()
        throws Exception
    {
     ...
     */
    @Deployment
    public void testActivitySignalEventsWithinProcess()
        throws Exception
    {
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("signalProcess");
        assertNotNull(processInstance);
     ...
     */
    @Deployment
    public void testActivityMessageEvents()
        throws Exception
    {
     ...
     */
    @Deployment
    public void testActivityMessageEventsInEventSubprocess()
        throws Exception
    {
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("messageProcess");
        assertNotNull(processInstance);
     ...
     */
    @Deployment
    public void testActivityCompensationEvents()
        throws Exception
    {
     ...
     */
    @Deployment
    public void testActivityErrorEvents()
        throws Exception
    {
     ...
     */
    @Deployment
    public void testActivityErrorEventsFromBPMNError()
        throws Exception
    {
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("errorProcess");
        assertNotNull(processInstance);
