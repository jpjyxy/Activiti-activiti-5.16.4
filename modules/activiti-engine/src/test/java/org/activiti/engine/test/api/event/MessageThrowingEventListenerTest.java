...
/**
 * Test case for all {@link ActivitiEventListener}s that throw a message BPMN event when an {@link ActivitiEvent} has
 * been dispatched.
 * 
...
public class MessageThrowingEventListenerTest extends PluggableActivitiTestCase
{
    ...
    @Deployment
    public void testThrowMessageDefinedInProcessDefinition()
        throws Exception
    {
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("testMessage");
        assertNotNull(processInstance);
    ...
    @Deployment
    public void testThrowMessageInterrupting()
        throws Exception
    {
        MessageThrowingEventListener listener = null;
        try
