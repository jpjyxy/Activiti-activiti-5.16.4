...
public class JobEventsTest extends PluggableActivitiTestCase
{
     ...
     */
    @Deployment
    public void testJobEntityEvents()
        throws Exception
    {
     ...
     */
    @Deployment
    public void testRepetitionJobEntityEvents()
        throws Exception
    {
    ...
    @Deployment
    public void testJobCanceledEventOnBoundaryEvent()
        throws Exception
    {
        Clock testClock = new DefaultClockImpl();
    ...
    public void testJobCanceledEventByManagementService()
        throws Exception
    {
        // GIVEN
    ...
    public void testJobCanceledEventOnProcessRedeploy()
        throws Exception
    {
        // GIVEN
     ...
     */
    @Deployment
    public void testTimerFiredForTimerStart()
        throws Exception
    {
     ...
     */
    @Deployment
    public void testTimerFiredForIntermediateTimer()
        throws Exception
    {
     ...
     */
    @Deployment
    public void testJobEntityEventsException()
        throws Exception
    {
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("testJobEvents");
        Job theJob = managementService.createJobQuery().processInstanceId(processInstance.getId()).singleResult();
