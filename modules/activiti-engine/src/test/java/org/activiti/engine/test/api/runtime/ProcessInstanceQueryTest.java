...
public class ProcessInstanceQueryTest extends PluggableActivitiTestCase
{
    ...
    public void testQueryBySuperProcessInstanceId()
    {
        ...
        ProcessInstanceQuery query =
            runtimeService.createProcessInstanceQuery().superProcessInstanceId(superProcessInstance.getId());
    ...
    public void testQueryBySubProcessInstanceIdNested()
    {
        ...
        ProcessInstance nestedSubProcessInstance =
            runtimeService.createProcessInstanceQuery()
                .superProcessInstanceId(subProcessInstance.getId())
                .singleResult();
        assertEquals(subProcessInstance.getId(),
            runtimeService.createProcessInstanceQuery()
    ...
    public void testQueryPaging()
    {
        ...
        assertEquals(2, runtimeService.createProcessInstanceQuery()
            ...
            .listPage(0, 2)
            .size());
        assertEquals(3, runtimeService.createProcessInstanceQuery()
            .processDefinitionKey(PROCESS_DEFINITION_KEY)
            .listPage(1, 3)
            .size());
    }
    ...
    public void testQueryInvalidSorting()
    {
        try
        {
            runtimeService.createProcessInstanceQuery().orderByProcessDefinitionId().list(); // asc - desc not called ->
                                                                                             // exception
            fail();
        }
        catch (ActivitiIllegalArgumentException e)
