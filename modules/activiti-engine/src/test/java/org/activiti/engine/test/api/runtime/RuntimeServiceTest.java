...
public class RuntimeServiceTest extends PluggableActivitiTestCase
{
    ...
    public void testStartProcessInstanceByProcessInstanceBuilder()
    {
        ...
        processInstance =
            processInstanceBuilder.processDefinitionKey("oneTaskProcess")
                ...
                .processInstanceName("processName1")
                .start();
        assertNotNull(processInstance);
        assertEquals(2, runtimeService.createProcessInstanceQuery().processDefinitionKey("oneTaskProcess").count());
        ...
        processInstance =
            processInstanceBuilder.processDefinitionId(processDefinition.getId())
                .businessKey("101124")
                .processInstanceName("processName2")
                .start();
        assertNotNull(processInstance);
    ...
    public void testSignalEventReceived()
    {
        ...
        for (int executions = 3; executions > 0; executions--)
        {
            ...
            assertEquals(executions - 1, runtimeService.createExecutionQuery()
    ...
    public void testMessageEventReceived()
    {
        ...
        {
            List<Execution> page =
                runtimeService.createExecutionQuery().messageEventSubscriptionName("alert").listPage(0, 1);
        ...
        {
            List<Execution> page =
                runtimeService.createExecutionQuery().messageEventSubscriptionName("panic").listPage(0, 1);
