...
public class JobQueryTest extends PluggableActivitiTestCase
{
    ...
    /**
     * Setup will create - 3 process instances, each with one timer, each firing at t1/t2/t3 + 1 hour (see process) - 1
     * message
     */
    ...
    public void testQueryByDuedateLowerThan()
    {
        ...
        query =
            managementService.createJobQuery().duedateLowerThan(new Date(timerThreeFireTime.getTime() + ONE_SECOND));
        verifyQueryResults(query, 3);
    }
