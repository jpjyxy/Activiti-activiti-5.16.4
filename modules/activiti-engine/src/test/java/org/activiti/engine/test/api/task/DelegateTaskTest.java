...
public class DelegateTaskTest extends PluggableActivitiTestCase
{
    ...
    public void testGetCandidates()
    {
        ...
        Set<String> candidateUsers =
            (Set<String>)taskService.getVariable(task.getId(), DelegateTaskTestTaskListener.VARNAME_CANDIDATE_USERS);
        ...
        Set<String> candidateGroups =
            (Set<String>)taskService.getVariable(task.getId(), DelegateTaskTestTaskListener.VARNAME_CANDIDATE_GROUPS);
