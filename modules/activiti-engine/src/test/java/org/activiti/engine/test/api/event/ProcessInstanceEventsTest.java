...
public class ProcessInstanceEventsTest extends PluggableActivitiTestCase
{
        ...
        throws Exception
    {
        ...
        // Check update event when process-definition is supended (should cascade suspend/activate all process
        // instances)
    ...
    public void testSubProcessInstanceEvents()
        throws Exception
    {
    ...
    public void testSignalProcessInstanceStart()
        throws Exception
    {
    ...
    public void testProcessCompleted_StartEnd()
        throws Exception
    {
    ...
    public void testProcessCompleted_NoEnd()
        throws Exception
    {
    ...
    public void testProcessCompleted_ParallelGatewayNoEnd()
        throws Exception
    {
    ...
    public void testProcessCompleted_ParallelGatewayTwoEnds()
        throws Exception
    {
        this.runtimeService.startProcessInstanceByKey("noEndProcess");
    ...
    private class TestInitializedEntityEventListener implements ActivitiEventListener
    {
        ...
        public void checkEventCount(int expectedCount, ActivitiEventType eventType)
        {// count timer cancelled events
            ...
            assertEquals(eventType.name() + " event was expected " + expectedCount + " times.",
                expectedCount,
                actualCount);
        }
