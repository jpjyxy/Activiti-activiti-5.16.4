...
public class MessageStartEventTest extends PluggableActivitiTestCase
{
    ...
    public void testSameMessageNameFails()
    {
        ...
        catch (ActivitiException e)
        {
            assertTrue(e.getMessage()
                .contains("there already is a message event subscription for the message with name"));
        }
    ...
    public void testMultipleMessageStartEvents()
    {
        ...
        // starting the process using startProcessInstanceByKey is possible, the first message start event will be the
        // default:
