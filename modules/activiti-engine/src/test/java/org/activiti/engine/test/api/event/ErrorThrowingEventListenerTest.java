...
/**
 * Test case for all {@link ActivitiEventListener}s that throws an error BPMN event when an {@link ActivitiEvent} has
 * been dispatched.
 * 
...
public class ErrorThrowingEventListenerTest extends PluggableActivitiTestCase
{
    ...
    @Deployment
    public void testThrowErrorDefinedInProcessDefinition()
        throws Exception
    {
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("testError");
        assertNotNull(processInstance);
    ...
    @Deployment
    public void testThrowErrorWithErrorcode()
        throws Exception
    {
        ErrorThrowingEventListener listener = null;
        try
