...
public class BoundaryTimerNonInterruptingEventTest extends PluggableActivitiTestCase
{
    ...
    public void testMultipleTimersOnUserTask()
    {
        ...
        processEngineConfiguration.getClock().setCurrentTime(new Date(startTime.getTime()
            + ((2 * 60 * 60 * 1000) + 5000)));
        waitForJobExecutorToProcessAllJobs(5000L, 25L);
    ...
    public void testReceiveTaskWithBoundaryTimer()
    {
        ...
        // processEngineConfiguration.getClock().setCurrentTime(new Date(startTime.getTime() + ((60 * 60 * 1000) +
        // 5000)));
        // waitForJobExecutorToProcessAllJobs(5000L, 25L);
        // assertEquals(0L, jobQuery.count());
