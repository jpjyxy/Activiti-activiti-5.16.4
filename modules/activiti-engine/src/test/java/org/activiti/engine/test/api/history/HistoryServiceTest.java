...
public class HistoryServiceTest extends PluggableActivitiTestCase
{
    ...
    public void testExcludeSubprocesses()
    {
        ...
        HistoricProcessInstance historicProcessInstance =
            historyService.createHistoricProcessInstanceQuery().excludeSubprocesses(true).singleResult();
        assertNotNull(historicProcessInstance);
    ...
    public void testHistoricProcessInstanceQueryByProcessDefinitionKey()
    {
        ...
        HistoricProcessInstance historicProcessInstanceSuper =
            historyService.createHistoricProcessInstanceQuery().processDefinitionKey("orderProcess").singleResult();
    ...
    public void testHistoricTaskInstanceOrQueryByDeploymentId()
    {
        ...
        HistoricTaskInstanceQuery taskInstanceQuery =
            historyService.createHistoricTaskInstanceQuery().or().deploymentId(deployment.getId()).endOr();
        assertEquals(5, taskInstanceQuery.count());
    ...
    public void testQueryStringVariable()
    {
        ...
        HistoricProcessInstanceQuery query =
            historyService.createHistoricProcessInstanceQuery().variableValueEquals("stringVar", "abcdef");
        ...
        List<String> ids =
            new ArrayList<String>(Arrays.asList(processInstances.get(0).getId(), processInstances.get(1).getId()));
        ...
        assertEquals(3, historyService.createHistoricProcessInstanceQuery()
    ...
    /**
     * Only do one second type, as the logic is same as in {@link ProcessInstanceQueryTest} and I do not want to
     * duplicate all test case logic here. Basically copied from {@link ProcessInstanceQueryTest}
     */
    @Deployment(resources = {"org/activiti/engine/test/api/oneTaskProcess.bpmn20.xml"})
