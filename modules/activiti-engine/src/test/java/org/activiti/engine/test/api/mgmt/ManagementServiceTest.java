...
public class ManagementServiceTest extends PluggableActivitiTestCase
{
    ...
    public void testSetJobRetriesNegativeNumberOfRetries()
    {
        ...
        {
            assertTextPresent("The number of job retries must be a non-negative Integer, but '-1' has been provided.",
                re.getMessage());
        }
    }
    ...
    public void testDeleteJobThatWasAlreadyAcquired()
    {
        ...
        AcquireJobsCmd acquireJobsCmd =
            new AcquireJobsCmd(processEngineImpl.getProcessEngineConfiguration().getJobExecutor());
