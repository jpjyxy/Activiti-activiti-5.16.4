...
public class HistoricActivityInstanceTest extends PluggableActivitiTestCase
{
    ...
    public void testHistoricActivityInstanceForEventsQuery()
    {
        ...
        HistoricActivityInstance intermediateEvent =
            historyService.createHistoricActivityInstanceQuery().activityId("intermediate-event").singleResult();
    ...
    public void testHistoricActivityInstanceCalledProcessId()
    {
        ...
        HistoricActivityInstance historicActivityInstance =
            historyService.createHistoricActivityInstanceQuery().activityId("callSubProcess").singleResult();
        
        HistoricProcessInstance oldInstance =
            historyService.createHistoricProcessInstanceQuery().processDefinitionKey("calledProcess").singleResult();
    ...
    public void testSorting()
    {
        ...
        assertEquals(expectedActivityInstances, historyService.createHistoricActivityInstanceQuery()
    ...
    public void testParallelJoinEndTime()
    {
        ...
        // History contains 2 entries for parallel join (one for each path arriving in the join), should contain
        // end-time
