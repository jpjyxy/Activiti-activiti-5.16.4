...
public class PvmScopeAndEventsTest extends PvmTestCase
{
    ...
    public void testStartEndWithScopesAndNestedActivities()
    {
        ...
        PvmProcessDefinition processDefinition =
            new ProcessDefinitionBuilder("scopes and events").executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_START,
                eventCollector)
    ...
    public void testStartEndWithScopesAndNestedActivitiesNotAtInitial()
    {
        ...
        PvmProcessInstance processInstance =
            ((ProcessDefinitionImpl)processDefinition).createProcessInstanceForInitial(alternativeInitial);
        processInstance.start();
