...
public abstract class ActivitiEventDispatcherTest extends PluggableActivitiTestCase
{
    ...
    /**
     * Test adding a listener and check if events are sent to it. Also checks that after removal, no events are
     * received.
     */
        ...
        throws Exception
    {
        ...
        ActivitiEntityEventImpl event1 =
            new ActivitiEntityEventImpl(new TaskEntity(), ActivitiEventType.ENTITY_CREATED);
    ...
    /**
     * Test adding a listener and check if events are sent to it, for the types it was registered for. Also checks that
        ...
        throws Exception
    {
        ...
        ActivitiEntityEventImpl event1 =
            new ActivitiEntityEventImpl(new TaskEntity(), ActivitiEventType.ENTITY_CREATED);
        ActivitiEntityEventImpl event2 =
            new ActivitiEntityEventImpl(new TaskEntity(), ActivitiEventType.ENTITY_DELETED);
        ActivitiEntityEventImpl event3 =
            new ActivitiEntityEventImpl(new TaskEntity(), ActivitiEventType.ENTITY_UPDATED);
     ...
     */
    public void baseEntityEventListener()
        throws Exception
    {
        ...
        ActivitiEntityEventImpl createEventForExecution =
            new ActivitiEntityEventImpl(new ExecutionEntity(), ActivitiEventType.ENTITY_CREATED);
    ...
    /**
     * Test conversion of string-value (and list) in list of {@link ActivitiEventType}s, used in configuration of
     * process-engine {@link ProcessEngineConfigurationImpl#setTypedEventListeners(java.util.Map)} .
     */
    public void activitiEventTypeParsing()
        throws Exception
    {
