...
public class TransactionSubProcessTest extends PluggableActivitiTestCase
{
    ...
    public void testSimpleCaseTxSuccessful()
    {
        ...
        EventSubscriptionEntity eventSubscriptionEntity =
            createEventSubscriptionQuery().eventType("compensate")
                .activityId("tx")
        ...
        // we still have compensate event subscriptions for the compensation handlers, only now they are part of the
        // event scope
        assertEquals(5,
            createEventSubscriptionQuery().eventType("compensate")
                ...
                .count());
        assertEquals(1, createEventSubscriptionQuery().eventType("compensate")
    ...
    public void testNestedCancelInner()
    {
        ...
        assertEquals(5, createEventSubscriptionQuery().eventType("compensate")
        ...
        assertEquals(0, createEventSubscriptionQuery().eventType("compensate")
            .activityId("innerTxundoBookHotel")
            .count());
        assertEquals(0, createEventSubscriptionQuery().eventType("compensate")
            .activityId("innerTxundoBookFlight")
     ...
     * 
     * see spec page 470: "If the cancelActivity attribute is set, the Activity the Event is attached to is then
    ...
    public void testMultipleCancelBoundaryFails()
    {
        ...
        {
            if (!e.getMessage()
                .contains("multiple boundary events with cancelEventDefinition not supported on same transaction"))
            {
    ...
    public void testCancelBoundaryNoTransactionFails()
    {
        ...
        {
            if (!e.getMessage()
                .contains("boundary event with cancelEventDefinition only supported on transaction subprocesses"))
            {
                fail("different exception expected");
            }
        }
    ...
    public void testCancelEndNoTransactionFails()
    {
        ...
        {
            if (!e.getMessage()
                .contains("end event with cancelEventDefinition only supported inside transaction subprocess"))
            {
                fail("different exception expected");
            }
        }
