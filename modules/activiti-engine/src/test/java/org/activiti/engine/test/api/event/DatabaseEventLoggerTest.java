...
public class DatabaseEventLoggerTest extends PluggableActivitiTestCase
{
        ...
        throws IOException
    {
        ...
        ProcessInstance processInstance =
            runtimeService.startProcessInstanceByKeyAndTenantId("DatabaseEventLoggerProcess",
                CollectionUtil.singletonMap("testVar", "helloWorld"),
                testTenant);
        ...
        for (int i = 0; i < eventLogEntries.size(); i++)
        {
            ...
            if (i == 0)
            {
                ...
                Map<String, Object> data =
                    objectMapper.readValue(entry.getData(), new TypeReference<HashMap<String, Object>>()
                    {
                    });
        ...
        throws JsonParseException, JsonMappingException, IOException
    {
        ...
        {
            Map<String, Object> data =
                objectMapper.readValue(eventLogEntry.getData(), new TypeReference<HashMap<String, Object>>()
                {
                });
