...
public class UserTaskTest extends PluggableActivitiTestCase
{
    ...
    public void testTaskPropertiesNotNull()
    {
        ...
        // the next test verifies that if an execution creates a task, that no events are created during creation of the
        // task.
    ...
    public void testTaskCategory()
    {
        ...
        assertEquals("Task with category", taskService.createTaskQuery()
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT))
        {
            ...
            assertEquals("Task with category",
