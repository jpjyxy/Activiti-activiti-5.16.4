...
public class ProcessInstanceSuspensionTest extends PluggableActivitiTestCase
{
    ...
    @Deployment
    public void testSuspendedProcessTimerExecution()
        throws Exception
    {
        ...
        List<TimerEntity> jobs =
            commandExecutor.execute(new GetUnlockedTimersByDuedateCmd(processEngineConfiguration.getClock()
                .getCurrentTime(), new Page(0, 1)));
    ...
    {
        return processEngineConfiguration.getCommandExecutor().execute(new AcquireJobsCmd(
