...
public class ProcessDefinitionCacheTest extends PvmTestCase
{
    ...
    public void testStartProcessInstanceByIdAfterReboot()
    {
        ...
        ProcessEngine processEngine =
            new StandaloneProcessEngineConfiguration().setProcessEngineName("reboot-test")
        ...
        ProcessInstance processInstance =
            processEngine.getRuntimeService().startProcessInstanceById(processDefinitions.get(0).getId());
    ...
    public void testDeployRevisedProcessAfterDeleteOnOtherProcessEngine()
    {
        ...
        ProcessEngine processEngine1 =
            new StandaloneProcessEngineConfiguration().setProcessEngineName("reboot-test-schema")
        ...
        String deploymentId =
            repositoryService1.createDeployment()
                .addClasspathResource("org/activiti/engine/test/cache/originalProcess.bpmn20.xml")
                .deploy()
                .getId();
