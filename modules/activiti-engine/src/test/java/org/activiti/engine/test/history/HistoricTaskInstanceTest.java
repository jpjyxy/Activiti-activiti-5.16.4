...
public class HistoricTaskInstanceTest extends PluggableActivitiTestCase
{
        ...
        throws Exception
    {
        ...
        HistoricTaskInstance historicTask =
            historyService.createHistoricTaskInstanceQuery().processInstanceId(finishedInstance.getId()).singleResult();
    ...
    @Deployment
    public void testHistoricTaskInstanceOrQuery()
        throws Exception
    {
        Calendar start = Calendar.getInstance();
        start.set(Calendar.MILLISECOND, 0);
    ...
    @Deployment
    public void testHistoricIdentityLinksOnTask()
        throws Exception
    {
     ...
     */
    @Deployment
    public void testVariableUpdateOrderHistoricTaskInstance()
        throws Exception
    {
