...
public class PvmScopesAndConcurrencyTest extends PvmTestCase
{
    ...
    public void testConcurrentPathsThroughNonScopeNestedActivity()
    {
        ...
        PvmProcessDefinition processDefinition =
            new ProcessDefinitionBuilder("scopes and concurrency").executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_START,
                eventCollector)
