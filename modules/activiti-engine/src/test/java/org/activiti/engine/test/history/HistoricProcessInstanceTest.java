...
public class HistoricProcessInstanceTest extends PluggableActivitiTestCase
{
    ...
    /*
     * @Deployment(resources = {"org/activiti/engine/test/history/oneTaskProcess.bpmn20.xml"}) public void
     * testHistoricProcessInstanceVariables() { Map<String,Object> vars = new HashMap<String,Object>(); vars.put("foo",
     * "bar"); vars.put("baz", "boo");
     * 
     ...
     * assertEquals(1, historyService.createHistoricProcessInstanceQuery().processVariableEquals("foo",
    ...
    public void testHistoricProcessInstanceQuery()
    {
        ...
        // Name and name like
        assertEquals("The name", historyService.createHistoricProcessInstanceQuery()
        ...
        assertEquals("New name", historyService.createHistoricProcessInstanceQuery()
