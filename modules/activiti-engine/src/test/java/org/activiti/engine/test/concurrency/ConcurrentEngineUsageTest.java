        ...
        throws Exception
    {
            ...
            && !processEngineConfiguration.getDatabaseType().equals("db2"))
        {
            ...
            ThreadPoolExecutor executor =
                new ThreadPoolExecutor(10, 10, 1000, TimeUnit.MILLISECONDS, new ArrayBlockingQueue<Runnable>(
                    numberOfThreads));
            ...
            if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.ACTIVITY))
            {
                ...
                assertEquals(numberOfProcessesPerThread * numberOfThreads,
        ...
        while (retries > 0 && !success)
        {
            try
            {
                runtimeService.startProcessInstanceByKey("concurrentProcess",
                    Collections.singletonMap("assignee", (Object)runningUser));
                success = true;
            }
