...
public class VariablesTest extends PluggableActivitiTestCase
{
    ...
    public void testUUIDVariableAndQuery()
    {
        ...
        Task resultingTask =
            taskService.createTaskQuery().taskVariableValueEquals("conversationId", randomUUID).singleResult();
        ...
        ProcessInstance result =
            runtimeService.createProcessInstanceQuery().variableValueEquals("uuidVar", randomUUID).singleResult();
