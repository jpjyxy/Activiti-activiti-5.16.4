...
public class FullHistoryTest extends ResourceActivitiTestCase
{
    ...
    public void testHistoricVariableInstanceQueryTaskVariables()
    {
        ...
        assertEquals("setFromTask", historyService.createHistoricVariableInstanceQuery()
            .taskId(activeTask.getId())
            .singleResult()
            .getValue());
        assertEquals(activeTask.getId(), historyService.createHistoricVariableInstanceQuery()
            .taskId(activeTask.getId())
            .singleResult()
            .getTaskId());
    ...
    public void testHistoricVariableInstanceQuery()
    {
        ...
        HistoricVariableInstance historicProcessVariable =
            historyService.createHistoricVariableInstanceQuery().variableValueEquals("process", "one").singleResult();
    ...
    @Deployment
    public void testHistoricVariableUpdatesAllTypes()
        throws Exception
    {
    ...
    @Deployment
    public void testHistoricFormProperties()
        throws Exception
    {
        ...
        ProcessDefinition procDef =
            repositoryService.createProcessDefinitionQuery()
                .processDefinitionKey("historicFormPropertiesProcess")
                .singleResult();
        ...
        HistoricActivityInstance historicActivityInstance =
            historyService.createHistoricActivityInstanceQuery()
                .activityInstanceId(historicProperty1.getActivityInstanceId())
                .singleResult();
        ...
        historicActivityInstance =
            historyService.createHistoricActivityInstanceQuery()
                .activityInstanceId(historicProperty2.getActivityInstanceId())
                .singleResult();
        assertNotNull(historicActivityInstance);
        assertEquals("start", historicActivityInstance.getActivityId());
        ...
        historicActivityInstance =
            historyService.createHistoricActivityInstanceQuery().activityInstanceId(activityInstanceId).singleResult();
        assertNotNull(historicActivityInstance);
        ...
        throws Exception
    {
        ...
        assertEquals(0, historyService.createHistoricDetailQuery()
            .variableUpdates()
        ...
        assertEquals(2, historyService.createHistoricDetailQuery()
            .variableUpdates()
        ...
        throws Exception
    {
        ...
        ProcessDefinition procDef =
            repositoryService.createProcessDefinitionQuery().processDefinitionKey("oneTaskProcess").singleResult();
        ProcessInstance processInstance = formService.submitStartFormData(procDef.getId(), formProperties);
        ...
        throws Exception
    {
        ...
        ProcessDefinition procDef =
            repositoryService.createProcessDefinitionQuery().processDefinitionKey("historicDetailMixed").singleResult();
        ProcessInstance processInstance = formService.submitStartFormData(procDef.getId(), formProperties);
    ...
    public void testDeleteHistoricProcessInstance()
    {
        ...
        assertEquals(1, historyService.createHistoricProcessInstanceQuery()
            .processInstanceId(processInstance.getId())
            .count());
        assertEquals(3, historyService.createHistoricActivityInstanceQuery()
            .processInstanceId(processInstance.getId())
            .count());
        assertEquals(4, historyService.createHistoricVariableInstanceQuery()
            .processInstanceId(processInstance.getId())
            .count());
    ...
    public void testHistoricFormPropertiesOnReEnteringActivity()
    {
        ...
        ProcessInstance processInstance =
            runtimeService.startProcessInstanceByKey("HistoricFormPropertiesProcess", variables);
        assertNotNull(processInstance);
        ...
        HistoricActivityInstance historicActInst1 =
            historyService.createHistoricActivityInstanceQuery()
                .activityInstanceId(details.get(0).getActivityInstanceId())
                .singleResult();
        
        HistoricActivityInstance historicActInst2 =
            historyService.createHistoricActivityInstanceQuery()
        ...
        throws Exception
    {
        ...
        assertEquals(0, historyService.createHistoricProcessInstanceQuery()
            ...
            .count());
        // assertEquals(1, historyService.createHistoricProcessInstanceQuery().variableValueGreaterThan("longVar",
        // 12344L).count());
        // assertEquals(1,
        ...
        // 12346L).count());
        //
        // assertEquals(0, historyService.createHistoricProcessInstanceQuery().variableValueLessThan("longVar",
        // 12345L).count());
        // assertEquals(1, historyService.createHistoricProcessInstanceQuery().variableValueLessThan("longVar",
        // 12346L).count());
        // assertEquals(1, historyService.createHistoricProcessInstanceQuery().variableValueLessThanOrEqual("longVar",
        // 12345L).count());
        // assertEquals(1, historyService.createHistoricProcessInstanceQuery().variableValueLessThanOrEqual("longVar",
        // 12346L).count());
        // assertEquals(0, historyService.createHistoricProcessInstanceQuery().variableValueLessThanOrEqual("longVar",
        // 12344L).count());
    }
        ...
        throws Exception
    {
        ...
        /*
         * This is OK! The variable is set on the root execution, on a execution never run through the activity, where
         * the process instances stands when calling the set Variable. But the ActivityId of this flow node is used. So
         * the execution id's doesn't have to be equal.
         * 
         * execution id: On which execution it was set activity id: in which activity was the process instance when
    ...
    public void testReadJpaVariableValueFromHistoricVariableUpdate()
    {
        ...
        EntityManagerSessionFactory entityManagerSessionFactory =
            (EntityManagerSessionFactory)processEngineConfiguration.getSessionFactories()
        ...
        List<HistoricDetail> variableUpdates =
            historyService.createHistoricDetailQuery().processInstanceId(executionId).variableUpdates().list();
     ...
     */
    @Deployment(resources = {"org/activiti/engine/test/history/oneTaskProcess.bpmn20.xml"})
    public void testQueryHistoricTaskIncludeBinaryVariable()
        throws Exception
    {
