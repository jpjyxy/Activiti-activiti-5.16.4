...
public class AdvancedCycleBusinessCalendarTest extends PvmTestCase
{
    ...
    public void testDaylightSavingFallIso()
        throws Exception
    {
    ...
    public void testDaylightSavingSpringIso()
        throws Exception
    {
        AdvancedCycleBusinessCalendar businessCalendar = new AdvancedCycleBusinessCalendar(testingClock);
        ...
        throws Exception
    {
        ...
        assertEquals(parseCalendar("20140311-04:00:00", TimeZone.getTimeZone("UTC")).getTime(),
            businessCalendar.resolveDuedate("R2/2014-03-10T04:00:00/P1D DSTZONE:US/Eastern"));
    }
    
    public void testLegacyIsoString()
        throws Exception
    {
        AdvancedCycleBusinessCalendar businessCalendar = new AdvancedCycleBusinessCalendar(testingClock);
        ...
        assertEquals(parseCalendar("20140311-00:00:00", TimeZone.getDefault()).getTime(),
            businessCalendar.resolveDuedate("R2/2014-03-10T00:00:00/P1D"));
    }
    
    public void testDaylightSavingFallCron()
        throws Exception
    {
        AdvancedCycleBusinessCalendar businessCalendar = new AdvancedCycleBusinessCalendar(testingClock);
        ...
        assertEquals(parseCalendar("20131103-17:00:00", TimeZone.getTimeZone("UTC")).getTime(),
            businessCalendar.resolveDuedate("0 0 12 1/1 * ? * DSTZONE:US/Eastern"));
    }
    
    public void testDaylightSavingSpringCron()
        throws Exception
    {
        AdvancedCycleBusinessCalendar businessCalendar = new AdvancedCycleBusinessCalendar(testingClock);
        ...
        assertEquals(parseCalendar("20140309-16:00:00", TimeZone.getTimeZone("UTC")).getTime(),
            businessCalendar.resolveDuedate("0 0 12 1/1 * ? * DSTZONE:US/Eastern"));
    }
    ...
    public void testLegacyCronString()
        throws Exception
    {
        AdvancedCycleBusinessCalendar businessCalendar = new AdvancedCycleBusinessCalendar(testingClock);
