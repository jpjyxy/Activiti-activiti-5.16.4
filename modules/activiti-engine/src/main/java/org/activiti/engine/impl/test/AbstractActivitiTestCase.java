...
public abstract class AbstractActivitiTestCase extends PvmTestCase
{
    ...
    /**
     * Since the 'one task process' is used everywhere the actual process content doesn't matter, instead of copying
     * around the BPMN 2.0 xml one could use this method which gives a {@link BpmnModel} version of the same process
     * back.
     */
    ...
    public String deployOneTaskTestProcess()
    {
        ...
        Deployment deployment =
            repositoryService.createDeployment().addBpmnModel("oneTasktest.bpmn20.xml", bpmnModel).deploy();
    ...
    public String deployTwoTasksTestProcess()
    {
        ...
        Deployment deployment =
            repositoryService.createDeployment().addBpmnModel("twoTasksTestProcess.bpmn20.xml", bpmnModel).deploy();
