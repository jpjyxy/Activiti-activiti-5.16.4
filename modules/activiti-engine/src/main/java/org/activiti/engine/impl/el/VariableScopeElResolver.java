...
/**
 * Implementation of an {@link ELResolver} that resolves expressions with the process variables of a given
 * {@link VariableScope} as context. <br>
    ...
    public Object getValue(ELContext context, Object base, Object property)
    {
        ...
        if (base == null)
        {
            ...
            else
            {
                ...
                {
                    context.setPropertyResolved(true); // if not set, the next elResolver in the CompositeElResolver
                                                       // will be called
