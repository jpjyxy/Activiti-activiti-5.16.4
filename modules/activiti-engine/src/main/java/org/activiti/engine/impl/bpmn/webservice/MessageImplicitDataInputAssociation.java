...
/**
 * An implicit data input association between a source and a target. source is a variable in the current execution
 * context and target is a property in the message
 * 
