...
/**
 * Intercepts {@link ActivitiOptimisticLockingException} and tries to run the same command again. The number of retries
 * and the time waited between retries is configurable.
 * 
 * @author Daniel Meyer
 */
public class RetryInterceptor extends AbstractCommandInterceptor
{
    ...
    public <T> T execute(CommandConfig config, Command<T> command)
    {
        ...
        throw new ActivitiException(numOfRetries
