...
/**
 * Simple resolver implementation. This resolver handles root properties (top-level identifiers). Resolving "real"
 * properties (<code>base != null</code>) is delegated to a resolver specified at construction time.
 * 
...
public class SimpleResolver extends ELResolver
{
    ...
    /**
     * Create a read/write resolver capable of resolving top-level identifiers. Everything else is passed to the
     * supplied delegate.
     */
    ...
    /**
     * Create a resolver capable of resolving top-level identifiers, array values, list values, map values, resource
     * values and bean properties.
     */
    ...
    /**
     * Create a read/write resolver capable of resolving top-level identifiers, array values, list values, map values,
     * resource values and bean properties.
     */
