...
public interface FormService
{
    ...
    /**
     * Retrieves all data necessary for rendering a form to start a new process instance. This can be used to perform
     * rendering of the forms outside of the process engine.
     */
     ...
     * best practice.
     * 
     * Note that a business key MUST be unique for the given process definition. Process instance from different process
     * definition are allowed to have the same business key.
     * 
    ...
    /**
     * Retrieves all data necessary for rendering a form to complete a task. This can be used to perform rendering of
     * the forms outside of the process engine.
     */
     ...
     * 
     * In the Explorer app, it is assumed that the form key specifies a resource in the deployment, which is the
     * template for the form. But users are free to use this property differently.
     */
