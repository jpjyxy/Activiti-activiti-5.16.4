...
public class StartEventParseHandler extends AbstractActivityBpmnParseHandler<StartEvent>
{
    ...
    protected void selectInitial(BpmnParse bpmnParse, ActivityImpl startEventActivity, StartEvent startEvent,
    ...
    protected void createStartFormHandlers(BpmnParse bpmnParse, StartEvent startEvent,
        ProcessDefinitionEntity processDefinition)
    {
        if (processDefinition.getInitial() != null)
        {
            if (startEvent.getId().equals(processDefinition.getInitial().getId()))
            {
                ...
                startFormHandler.parseConfiguration(startEvent.getFormProperties(),
    ...
    protected void createProcessDefinitionStartEvent(BpmnParse bpmnParse, ActivityImpl startEventActivity,
        StartEvent startEvent, ProcessDefinitionEntity processDefinition)
    {
        ...
        startEventActivity.setActivityBehavior(bpmnParse.getActivityBehaviorFactory()
    ...
    protected void createScopeStartEvent(BpmnParse bpmnParse, ActivityImpl startEventActivity, StartEvent startEvent)
    {
        ...
        { // event subprocess
            ...
            EventSubProcessStartEventActivityBehavior activityBehavior =
                bpmnParse.getActivityBehaviorFactory().createEventSubProcessStartEventActivityBehavior(startEvent,
        ...
        { // "regular" subprocess
            ...
            {
                logger.warn("multiple start events not supported for subprocess", bpmnParse.getCurrentSubProcess()
                    .getId());
            }
        }
