...
public interface DeploymentBuilder
{
    ...
    /**
     * If called, no validation that the process definition is executable on the engine will be done against the process
     * definition.
     * 
     * Not recommended in general.
     */
    ...
    /**
     * If set, this deployment will be compared to any previous deployment. This means that every (non-generated)
     * resource will be compared with the provided resources of this deployment.
     */
    DeploymentBuilder enableDuplicateFiltering();
    
    /**
     * Sets the date on which the process definitions contained in this deployment will be activated. This means that
     * all process definitions will be deployed as usual, but they will be suspended from the start until the given
     * activation date.
     */
