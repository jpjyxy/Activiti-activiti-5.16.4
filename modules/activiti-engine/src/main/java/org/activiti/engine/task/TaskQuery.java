...
public interface TaskQuery extends TaskInfoQuery<TaskQuery, Task>
{
     ...
     * You can invoke {@link #taskCandidateGroupIn(List)} to include tasks that can be claimed by a user in the given
     * groups while set property <strong>dbIdentityUsed</strong> to <strong>false</strong> in process engine
     * configuration or using custom session factory of GroupIdentityManager.
     */
    ...
    /**
     * Order by due date (needs to be followed by {@link #asc()} or {@link #desc()}). This will use the default handling
     * of null values of the used database.
     * 
