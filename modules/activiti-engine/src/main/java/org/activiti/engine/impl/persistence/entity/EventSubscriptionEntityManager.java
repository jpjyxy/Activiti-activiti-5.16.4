...
public class EventSubscriptionEntityManager extends AbstractManager
{
    ...
    public List<SignalEventSubscriptionEntity> findSignalEventSubscriptionsByExecution(String executionId)
    {
        ...
        Set<SignalEventSubscriptionEntity> selectList =
            new HashSet<SignalEventSubscriptionEntity>(getDbSqlSession().selectList(query, executionId));
    ...
    public MessageEventSubscriptionEntity findMessageStartEventSubscriptionByName(String messageName, String tenantId)
    {
        ...
        MessageEventSubscriptionEntity entity =
            (MessageEventSubscriptionEntity)getDbSqlSession().selectOne("selectMessageStartEventSubscriptionByName",
                params);
        return entity;
    }
