...
public interface ProcessInstanceQuery extends Query<ProcessInstanceQuery, ProcessInstance>
{
    ...
    /**
     * Select the process instance that have as sub process instance the given process instance. Note that there will
     * always be maximum only <b>one</b> such process instance that can be the result of this query.
     */
    ...
    /**
     * Only select process instances which have a global variable with the given value. The type of variable is
    ...
    /**
     * Only select process instances which have at least one global variable with the given value. The type of variable
     * is determined based on the value, using types configured in {@link ProcessEngineConfiguration#getVariableTypes()}
     * . Byte-arrays and {@link Serializable} objects (which are not primitive type wrappers) are not supported.
     */
    ...
    /**
     * Only select process instances which have a global variable with the given name, but with a different value than
     * the passed value. Byte-arrays and {@link Serializable} objects (which are not primitive type wrappers) are not
     * supported.
     * 
     * @param name name of the variable, cannot be null.
     */
    ...
    /**
     * Only select process instances which have a variable value greater than the passed value. Booleans, Byte-arrays
    ...
    /**
     * Only select process instances which have a global variable value less than the passed value. Booleans,
     * Byte-arrays and {@link Serializable} objects (which are not primitive type wrappers) are not supported.
     * 
     * @param name variable name, cannot be null.
     * @param value variable value, cannot be null.
    ...
    /**
     * Only select process instances which have a global variable value like the given value. This be used on string
     * variables only.
     * 
     * @param name variable name, cannot be null.
    ...
    /**
     * Only select process instances which are suspended, either because the process instance itself is suspended or
     * because the corresponding process definition is suspended
     */
    ProcessInstanceQuery suspended();
    
    /**
     * Only select process instances which are active, which means that neither the process instance nor the
     * corresponding process definition are suspended.
     */
