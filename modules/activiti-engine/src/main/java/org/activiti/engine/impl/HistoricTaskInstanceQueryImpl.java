...
public class HistoricTaskInstanceQueryImpl extends
    AbstractVariableQueryImpl<HistoricTaskInstanceQuery, HistoricTaskInstance> implements HistoricTaskInstanceQuery
{
        ...
        String processInstanceBusinessKeyLikeIgnoreCase)
    {
        if (inOrStatement)
        {
            this.orQueryObject.processInstanceBusinessKeyLikeIgnoreCase =
