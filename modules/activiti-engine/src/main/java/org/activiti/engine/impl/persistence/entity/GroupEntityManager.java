...
public class GroupEntityManager extends AbstractManager implements GroupIdentityManager
{
    ...
    public void deleteGroup(String groupId)
    {
        ...
        if (group != null)
        {
            ...
            {
                getProcessEngineConfiguration().getEventDispatcher()
                    .dispatchEvent(ActivitiEventBuilder.createMembershipEvent(ActivitiEventType.MEMBERSHIPS_DELETED,
                        groupId,
                        null));
            }
    ...
    {
        return getDbSqlSession().selectListWithRawParameter("selectGroupByNativeQuery",
            parameterMap,
            firstResult,
            maxResults);
    }
