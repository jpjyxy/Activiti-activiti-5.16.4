...
/**
 * Thrown when a property could not be written to while setting the value on a {@link ValueExpression}. For example,
 * this could be triggered by trying to set a map value on an unmodifiable map.
 */
