...
public class TablePage
{
    ...
    /**
     * Identifies the index of the first result stored in this TablePage. For example in a paginated database table,
     * this value identifies the record number of the result on the first row.
     */
