...
public abstract class VariableMapper
{
    ...
    /**
     * Assign a ValueExpression to an EL variable, replacing any previously assignment to the same variable. The
     * assignment for the variable is removed if the expression is null.
     * 
     * @param variable The variable name
