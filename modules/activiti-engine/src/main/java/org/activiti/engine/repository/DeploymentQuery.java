 ...
 * 
 * Note that it is impossible to retrieve the deployment resources through the results of this operation, since that
 * would cause a huge transfer of (possibly) unneeded bytes over the wire.
 * 
