 ...
 * <code>base == null &amp;&amp; property instanceof String</code>), which are stored in a map. The properties can be
 * accessed via the {@link #getProperty(String)}, {@link #setProperty(String, Object)}, {@link #isProperty(String)} and
