 ...
 * 
 * <p>
 * This class lets you register mock objects that will then be used by the {@link MockElResolver}. It binds a map of
 * mock objects to ThreadLocal. This way, the mocks can be set up independent of how the process engine configuration is
 * built.
 * </p>
 * 
...
public class Mocks
{
    ...
    /**
     * This method lets you register a mock object. Make sure to register the {@link MockExpressionManager} with your
    ...
    /**
     * This method returns the mock object registered under the provided key or null if there is no object for the
     * provided key.
     * 
