 ...
 * @author Joram Barrez
 */
public class HistoricDetailQueryImpl extends AbstractQuery<HistoricDetailQuery, HistoricDetail> implements
    HistoricDetailQuery
{
    ...
    public List<HistoricDetail> executeList(CommandContext commandContext, Page page)
    {
        ...
        List<HistoricDetail> historicDetails =
            commandContext.getHistoricDetailEntityManager().findHistoricDetailsByQueryCriteria(this, page);
        ...
        if (historicDetails != null)
        {
            for (HistoricDetail historicDetail : historicDetails)
            {
                if (historicDetail instanceof HistoricDetailVariableInstanceUpdateEntity)
                {
                    ...
                    // ACT-863: EntityManagerFactorySession instance needed for fetching value, touch while inside
                    // context to store
                    // cached value
