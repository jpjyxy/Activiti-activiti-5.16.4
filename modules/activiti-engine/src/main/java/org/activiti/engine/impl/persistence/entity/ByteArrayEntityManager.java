...
public class ByteArrayEntityManager extends AbstractManager
{
    ...
    /**
     * Deletes the {@link ByteArrayEntity} with the given id from the database. Important: this operation will NOT do
     * any optimistic locking, to avoid loading the bytes in memory. So use this method only in conjunction with an
     * entity that has optimistic locking!.
     */
