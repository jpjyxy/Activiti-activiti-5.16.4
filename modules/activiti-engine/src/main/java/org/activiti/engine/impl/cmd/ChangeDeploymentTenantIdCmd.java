...
public class ChangeDeploymentTenantIdCmd implements Command<Void>, Serializable
{
    ...
    public Void execute(CommandContext commandContext)
    {
        ...
        commandContext.getProcessDefinitionEntityManager().updateProcessDefinitionTenantIdForDeployment(deploymentId,
            newTenantId);
        ...
        List<ProcessDefinition> processDefinitions =
            commandContext.getDbSqlSession().createProcessDefinitionQuery().deploymentId(deploymentId).list();
