 ...
 * 
 * processDefinitionId or processDefinitionKey should be set before calling {@link #start()} to start a process
 * instance.
 * 
 * 
...
public interface ProcessInstanceBuilder
{
    ...
    /**
     * Set the key of the process definition, latest version of the process definition with the given key. If
     * processDefinitionId was set this will be ignored
     **/
     ...
     * 
     * @throws ActivitiIllegalArgumentException if processDefinitionKey and processDefinitionId are null
