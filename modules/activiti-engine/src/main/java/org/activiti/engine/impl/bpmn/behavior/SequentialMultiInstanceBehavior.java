...
public class SequentialMultiInstanceBehavior extends MultiInstanceActivityBehavior
{
    ...
    /**
     * Handles the sequential case of spawning the instances. Will only create one instance, since at most one instance
     * can be active.
     */
     ...
     * {@link AbstractBpmnActivityBehavior#leave(ActivityExecution)} method. Handles the completion of one instance, and
     * executes the logic for the sequential behavior.
     */
    public void leave(ActivityExecution execution)
    {
        ...
        else
        {
            ...
            {
                // re-throw business fault so that it can be caught by an Error Intermediate Event or Error Event
                // Sub-Process in the process
                throw error;
            }
            catch (Exception e)
            {
