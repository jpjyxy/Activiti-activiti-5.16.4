...
public class UserTaskParseHandler extends AbstractActivityBpmnParseHandler<UserTask>
{
    ...
    protected void executeParse(BpmnParse bpmnParse, UserTask userTask)
    {
        ...
        activity.setActivityBehavior(bpmnParse.getActivityBehaviorFactory().createUserTaskActivityBehavior(userTask,
            taskDefinition));
    }
        ...
        ProcessDefinitionEntity processDefinition)
    {
        ...
        {
            taskDefinition.addTaskListener(taskListener.getEvent(),
                createTaskListener(bpmnParse, taskListener, userTask.getId()));
        }
        ...
        for (String customGroupIdentityLinkType : userTask.getCustomGroupIdentityLinks().keySet())
        {
            ...
            taskDefinition.addCustomGroupIdentityLinkExpression(customGroupIdentityLinkType,
