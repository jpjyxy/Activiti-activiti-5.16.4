...
/**
 * Manager class that centralises recording of all history-related operations that are originated from inside the
 * engine.
 * 
...
public class DefaultHistoryManager extends AbstractManager implements HistoryManager
{
     ...
     * 
     * @see
     * org.activiti.engine.impl.history.HistoryManagerInterface#isHistoryLevelAtLeast(org.activiti.engine.impl.history
     * .HistoryLevel)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.activiti.engine.impl.history.HistoryManagerInterface#recordProcessInstanceEnd(java.lang.String,
     ...
     * 
     * @see
     * org.activiti.engine.impl.history.HistoryManagerInterface#recordProcessInstanceStart(org.activiti.engine.impl.
     * persistence.entity.ExecutionEntity)
     */
    @Override
     ...
     * 
     * @see
     * org.activiti.engine.impl.history.HistoryManagerInterface#recordSubProcessInstanceStart(org.activiti.engine.impl
     * .persistence.entity.ExecutionEntity, org.activiti.engine.impl.persistence.entity.ExecutionEntity)
     */
    @Override
    public void recordSubProcessInstanceStart(ExecutionEntity parentExecution, ExecutionEntity subProcessInstance)
    {
        if (isHistoryLevelAtLeast(HistoryLevel.ACTIVITY))
        {
            ...
            HistoricProcessInstanceEntity historicProcessInstance =
                new HistoricProcessInstanceEntity((ExecutionEntity)subProcessInstance);
            ...
            {
                historicProcessInstance.setStartActivityId(subProcessInstance.getProcessDefinition()
                    .getInitial()
                    .getId());
     ...
     * 
     * @see
     * org.activiti.engine.impl.history.HistoryManagerInterface#recordActivityStart(org.activiti.engine.impl.persistence
    ...
    public void recordActivityStart(ExecutionEntity executionEntity)
    {
        if (isHistoryLevelAtLeast(HistoryLevel.ACTIVITY))
        {
            if (executionEntity.getActivity() != null)
            {
                ...
                historicActivityInstance.setStartTime(Context.getProcessEngineConfiguration()
                    .getClock()
                    .getCurrentTime());
     ...
     * 
     * @see
     * org.activiti.engine.impl.history.HistoryManagerInterface#recordActivityEnd(org.activiti.engine.impl.persistence
     * .entity.ExecutionEntity)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.activiti.engine.impl.history.HistoryManagerInterface#recordStartEventEnded(java.lang.String,
     * java.lang.String)
     */
    @Override
    public void recordStartEventEnded(String executionId, String activityId)
    {
        if (isHistoryLevelAtLeast(HistoryLevel.ACTIVITY))
        {
            ...
            // Search for the historic activity instance in the dbsqlsession cache, since process hasn't been persisted
            // to db yet
     ...
     * 
     * @see
     * org.activiti.engine.impl.history.HistoryManagerInterface#findActivityInstance(org.activiti.engine.impl.persistence
     * .entity.ExecutionEntity)
     */
    @Override
    public HistoricActivityInstanceEntity findActivityInstance(ExecutionEntity execution)
    {
        ...
        List<HistoricActivityInstance> historicActivityInstances =
            new HistoricActivityInstanceQueryImpl(Context.getCommandContext()).executionId(executionId)
     ...
     * (non-Javadoc)
     * 
     * @see org.activiti.engine.impl.history.HistoryManagerInterface#recordExecutionReplacedBy(org.activiti.engine.impl.
     * persistence.entity.ExecutionEntity, org.activiti.engine.impl.pvm.runtime.InterpretableExecution)
     */
    @Override
    ...
    public void recordExecutionReplacedBy(ExecutionEntity execution, InterpretableExecution replacedBy)
    {
        if (isHistoryLevelAtLeast(HistoryLevel.ACTIVITY))
        {
            ...
            List<HistoricActivityInstanceEntity> historicActivityInstances =
                (List)new HistoricActivityInstanceQueryImpl(Context.getCommandContext()).executionId(execution.getId())
                    .unfinished()
                    .list();
     ...
     * (non-Javadoc)
     * 
     * @see org.activiti.engine.impl.history.HistoryManagerInterface#recordProcessDefinitionChange(java.lang.String,
     * java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * org.activiti.engine.impl.history.HistoryManagerInterface#recordTaskCreated(org.activiti.engine.impl.persistence
     * .entity.TaskEntity, org.activiti.engine.impl.persistence.entity.ExecutionEntity)
     */
    @Override
     ...
     * 
     * @see
     * org.activiti.engine.impl.history.HistoryManagerInterface#recordTaskAssignment(org.activiti.engine.impl.persistence
     * .entity.TaskEntity)
     */
    @Override
     ...
     * 
     * @see
     * org.activiti.engine.impl.history.HistoryManagerInterface#recordTaskId(org.activiti.engine.impl.persistence.entity
     * .TaskEntity)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.activiti.engine.impl.history.HistoryManagerInterface#recordTaskAssigneeChange(java.lang.String,
     * java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.activiti.engine.impl.history.HistoryManagerInterface#recordTaskOwnerChange(java.lang.String,
     * java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.activiti.engine.impl.history.HistoryManagerInterface#recordTaskNameChange(java.lang.String,
     * java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.activiti.engine.impl.history.HistoryManagerInterface#recordTaskDescriptionChange(java.lang.String,
     * java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.activiti.engine.impl.history.HistoryManagerInterface#recordTaskDueDateChange(java.lang.String,
     * java.util.Date)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.activiti.engine.impl.history.HistoryManagerInterface#recordTaskCategoryChange(java.lang.String,
     * java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.activiti.engine.impl.history.HistoryManagerInterface#recordTaskParentTaskIdChange(java.lang.String,
     * java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.activiti.engine.impl.history.HistoryManagerInterface#recordTaskExecutionIdChange(java.lang.String,
     * java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * org.activiti.engine.impl.history.HistoryManagerInterface#recordTaskDefinitionKeyChange(org.activiti.engine.impl
     * .persistence.entity.TaskEntity, java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * org.activiti.engine.impl.history.HistoryManagerInterface#recordVariableCreate(org.activiti.engine.impl.persistence
     * .entity.VariableInstanceEntity)
     */
    @Override
     ...
     * 
     * @see
     * org.activiti.engine.impl.history.HistoryManagerInterface#recordHistoricDetailVariableCreate(org.activiti.engine
     * .impl.persistence.entity.VariableInstanceEntity, org.activiti.engine.impl.persistence.entity.ExecutionEntity,
     * boolean)
     */
    @Override
     ...
     * 
     * @see
     * org.activiti.engine.impl.history.HistoryManagerInterface#recordVariableUpdate(org.activiti.engine.impl.persistence
     * .entity.VariableInstanceEntity)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.activiti.engine.impl.history.HistoryManagerInterface#createIdentityLinkComment(java.lang.String,
     ...
     * (non-Javadoc)
     * 
     * @see org.activiti.engine.impl.history.HistoryManagerInterface#createAttachmentComment(java.lang.String,
     ...
     * 
     * @see
     * org.activiti.engine.impl.history.HistoryManagerInterface#reportFormPropertiesSubmitted(org.activiti.engine.impl
     * .persistence.entity.ExecutionEntity, java.util.Map, java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.activiti.engine.impl.history.HistoryManagerInterface#recordIdentityLinkCreated(org.activiti.engine.impl.
     ...
     * 
     * @see
     * org.activiti.engine.impl.history.HistoryManagerInterface#updateProcessBusinessKeyInHistory(org.activiti.engine
     * .impl.persistence.entity.ExecutionEntity)
     */
    @Override
    public void updateProcessBusinessKeyInHistory(ExecutionEntity processInstance)
    {
        if (isHistoryEnabled())
        {
            ...
            {
                HistoricProcessInstanceEntity historicProcessInstance =
                    getDbSqlSession().selectById(HistoricProcessInstanceEntity.class, processInstance.getId());
                if (historicProcessInstance != null)
                {
