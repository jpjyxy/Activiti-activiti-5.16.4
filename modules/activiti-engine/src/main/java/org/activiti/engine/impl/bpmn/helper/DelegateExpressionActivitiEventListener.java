...
/**
 * An {@link ActivitiEventListener} implementation which resolves an expression to a delegate
 * {@link ActivitiEventListener} instance and uses this for event notification. <br>
 * <br>
 * In case an entityClass was passed in the constructor, only events that are {@link ActivitiEntityEvent}'s that target
 * an entity of the given type, are dispatched to the delegate.
 * 
