...
public class TestActivityBehaviorFactory extends AbstractBehaviorFactory implements ActivityBehaviorFactory
{
    ...
    /**
     * The ActivityBehaviorFactory that is constructed when the process engine was created This class delegates to this
     * instance, unless some mocking has been defined.
     */
    ...
    private ClassDelegate createNoOpServiceTask(ServiceTask serviceTask)
    {
        ...
        fieldDeclarations.add(new FieldDeclaration("name", Expression.class.getName(), new FixedValue(
    ...
    {
        return wrappedActivityBehaviorFactory.createIntermediateThrowSignalEventActivityBehavior(throwEvent,
            signal,
    ...
    {
        return wrappedActivityBehaviorFactory.createIntermediateThrowCompensationEventActivityBehavior(throwEvent,
