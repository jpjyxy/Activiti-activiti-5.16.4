...
public class ScriptBindings implements Bindings
{
    ...
    /**
     * The script engine implementations put some key/value pairs into the binding. This list contains those keys, such
     * that they wouldn't be stored as process variable.
     * 
