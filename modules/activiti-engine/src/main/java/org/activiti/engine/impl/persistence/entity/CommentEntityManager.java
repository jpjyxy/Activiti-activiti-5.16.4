...
public class CommentEntityManager extends AbstractManager
{
    ...
    public void delete(PersistentObject persistentObject)
    {
        ...
        if (getProcessEngineConfiguration().getEventDispatcher().isEnabled())
        {
            ...
            getProcessEngineConfiguration().getEventDispatcher()
                .dispatchEvent(ActivitiEventBuilder.createEntityEvent(ActivitiEventType.ENTITY_DELETED,
                    persistentObject,
                    processInstanceId,
                    processInstanceId,
                    processDefinitionId));
    ...
    public List<Comment> findCommentsByTaskIdAndType(String taskId, String type)
    {
        ...
        return getDbSqlSession().selectListWithRawParameter("selectCommentsByTaskIdAndType",
            params,
            0,
            Integer.MAX_VALUE);
    }
    ...
    public List<Comment> findCommentsByProcessInstanceId(String processInstanceId, String type)
    {
        ...
        params.put("type", type);
        return getDbSqlSession().selectListWithRawParameter("selectCommentsByProcessInstanceIdAndType",
            params,
            0,
            Integer.MAX_VALUE);
    }
