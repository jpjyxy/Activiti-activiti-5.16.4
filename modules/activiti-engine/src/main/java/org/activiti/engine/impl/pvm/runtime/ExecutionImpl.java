 ...
 * @author Falko Menge
 */
public class ExecutionImpl implements Serializable, ActivityExecution, ExecutionListenerExecution, PvmExecution,
    InterpretableExecution
{
    ...
    /**
     * must be called before memberfield parent is used. can be used by subclasses to provide parent member field
     * initialization.
     */
    ...
    /**
     * must be called before memberfield executions is used. can be used by subclasses to provide executions member
    ...
    /**
     * must be called before memberfield processDefinition is used. can be used by subclasses to provide
     * processDefinition member field initialization.
     */
    ...
    /**
     * must be called before memberfield processInstance is used. can be used by subclasses to provide processInstance
