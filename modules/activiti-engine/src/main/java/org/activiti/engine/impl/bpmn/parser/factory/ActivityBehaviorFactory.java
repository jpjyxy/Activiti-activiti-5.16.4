...
/**
 * Factory class used by the {@link BpmnParser} and {@link BpmnParse} to instantiate the behaviour classes. For example
 * when parsing an exclusive gateway, this factory will be requested to create a new {@link ActivityBehavior} that will
 * be set on the {@link ActivityImpl} of that step of the process and will implement the spec-compliant behavior of the
 * exclusive gateway.
 * 
 * You can provide your own implementation of this class. This way, you can give different execution semantics to a
 * standard bpmn xml construct. Eg. you could tweak the exclusive gateway to do something completely different if you
 * would want that. Creating your own {@link ActivityBehaviorFactory} is only advisable if you want to change the
 * default behavior of any BPMN default construct. And even then, think twice, because it won't be spec compliant bpmn
 * anymore.
 * 
 * Note that you can always express any custom step as a service task with a class delegation.
 * 
 * The easiest and advisable way to implement your own {@link ActivityBehaviorFactory} is to extend the
 * {@link DefaultActivityBehaviorFactory} class and override the method specific to the {@link ActivityBehavior} you
 * want to change.
 * 
...
public interface ActivityBehaviorFactory
{
    ...
    public abstract EventSubProcessStartEventActivityBehavior createEventSubProcessStartEventActivityBehavior(
    ...
    public abstract BusinessRuleTaskActivityBehavior createBusinessRuleTaskActivityBehavior(
    ...
    public abstract SequentialMultiInstanceBehavior createSequentialMultiInstanceBehavior(ActivityImpl activity,
        AbstractBpmnActivityBehavior innerActivityBehavior);
    
    public abstract ParallelMultiInstanceBehavior createParallelMultiInstanceBehavior(ActivityImpl activity,
        AbstractBpmnActivityBehavior innerActivityBehavior);
    ...
    public abstract ErrorEndEventActivityBehavior createErrorEndEventActivityBehavior(EndEvent endEvent,
    ...
    public abstract BoundaryEventActivityBehavior createBoundaryEventActivityBehavior(BoundaryEvent boundaryEvent,
        boolean interrupting, ActivityImpl activity);
    
    public abstract CancelBoundaryEventActivityBehavior createCancelBoundaryEventActivityBehavior(
