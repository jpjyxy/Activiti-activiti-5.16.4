...
/**
 * Superclass for all 'connectable' BPMN 2.0 process elements: tasks, gateways and events. This means that any subclass
 * can be the source or target of a sequenceflow.
 * 
...
public abstract class FlowNodeActivityBehavior implements SignallableActivityBehavior
{
    ...
    /**
     * Default way of leaving a BPMN 2.0 activity: evaluate the conditions on the outgoing sequence flow and take those
