...
public interface VariableTypes
{
    ...
    /**
     * Add type at the given index. The index is used when finding a type for an object. When different types can store
     * a specific object value, the one with the smallest index will be used.
     */
