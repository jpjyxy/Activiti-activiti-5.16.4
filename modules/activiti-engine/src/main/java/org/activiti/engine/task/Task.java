...
public interface Task extends TaskInfo
{
    ...
    /**
     * Change the category of the task. This is an optional field and allows to 'tag' tasks as belonging to a certain
     * category.
     */
    void setCategory(String category);
    
    /**
     * delegates this task to the given user and sets the {@link #getDelegationState() delegationState} to
