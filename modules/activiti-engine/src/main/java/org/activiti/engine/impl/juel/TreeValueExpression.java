 ...
 * {@link #getValue(ELContext)}, {@link #isReadOnly(ELContext)} or {@link #setValue(ELContext, Object)}.
 * 
...
public final class TreeValueExpression extends org.activiti.engine.impl.javax.el.ValueExpression
{
     ...
     */
    public TreeValueExpression(TreeStore store, FunctionMapper functions, VariableMapper variables,
        TypeConverter converter, String expr, Class<?> type)
    {
        super();
     ...
     * 
     * @param context used to resolve properties (<code>base.property</code> and <code>base[property]</code>) and to
     *            determine the result from the last base/property pair
     ...
     * 
     * @param context used to resolve properties (<code>base.property</code> and <code>base[property]</code>) and to
     *            perform the assignment to the last base/property pair
    ...
    /**
     * Answer <code>true</code> if this could be used as an lvalue. This is the case for eval expressions consisting of
     * a simple identifier or a nonliteral prefix, followed by a sequence of property operators (<code>.</code> or
     * <code>[]</code>)
     */
    ...
    /**
     * Answer <code>true</code> if this is a deferred expression (containing sub-expressions starting with
     * <code>#{</code>)
     */
    ...
    /**
     * Expressions are compared using the concept of a <em>structural id</em>: variable and function names are
     * anonymized such that two expressions with same tree structure will also have the same structural id and vice
     * versa. Two value expressions are equal if
     * <ol>
