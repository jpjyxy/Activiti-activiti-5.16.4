    ...
    protected void executeParse(BpmnParse bpmnParse, IntermediateCatchEvent event)
    {
        ...
        else
        {
            ...
            if (eventBasedGatewayId != null)
            {
                ...
                nestedActivity =
                    createActivityOnScope(bpmnParse, event, BpmnXMLConstants.ELEMENT_EVENT_CATCH, gatewayActivity);
            }
            else
            {
            ...
            nestedActivity.setActivityBehavior(bpmnParse.getActivityBehaviorFactory()
