...
public class ScopeUtil
{
    ...
    public static ExecutionEntity findScopeExecutionForScope(ExecutionEntity execution, PvmScope scopeActivity)
    {
        ...
        else
        {
            ...
            if (originalExecution == candiadateExecution && originalExecution.getActivity().isScope()
     ...
     * 
     * create a new event scope execution under the parent of the given execution and move all event subscriptions to
     * that execution.
     * 
