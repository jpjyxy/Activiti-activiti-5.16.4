...
public class AddIdentityLinkForProcessInstanceCmd implements Command<Void>, Serializable
{
    ...
    public Void execute(CommandContext commandContext)
    {
        ...
        {
            throw new ActivitiObjectNotFoundException("Cannot find process instance with id " + processInstanceId,
                ExecutionEntity.class);
        }
        
        processInstance.addIdentityLink(userId, groupId, type);
        
        commandContext.getHistoryManager().createProcessInstanceIdentityLinkComment(processInstanceId,
            userId,
            groupId,
            type,
            true);
