...
/**
 * Variable type capable of storing a list of reference to JPA-entities. Only JPA-Entities which are configured by
 * annotations are supported. Use of compound primary keys is not supported. <br>
