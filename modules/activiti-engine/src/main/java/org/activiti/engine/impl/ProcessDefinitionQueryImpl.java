 ...
 */
public class ProcessDefinitionQueryImpl extends AbstractQuery<ProcessDefinitionQuery, ProcessDefinition> implements
    ProcessDefinitionQuery
{
    ...
    public List<String> getAuthorizationGroups()
    {
        ...
        {
            List<Group> groups =
                Context.getCommandContext().getGroupIdentityManager().findGroupsByUser(authorizationUserId);
    ...
    public void checkQueryOk()
    {
        ...
        if (latest
            && ((id != null) || (name != null) || (nameLike != null) || (version != null) || (deploymentId != null)))
        {
