...
public class HistoricVariableInstanceQueryImpl extends
    AbstractQuery<HistoricVariableInstanceQuery, HistoricVariableInstance> implements HistoricVariableInstanceQuery
{
                ...
                if (historicVariableInstance instanceof HistoricVariableInstanceEntity)
                {
                    ...
                    if (variableEntity != null && variableEntity.getVariableType() != null)
                    {
                        ...
                        if (JPAEntityVariableType.TYPE_NAME.equals(variableEntity.getVariableType().getTypeName())
                            || JPAEntityListVariableType.TYPE_NAME.equals(variableEntity.getVariableType()
                                .getTypeName()))
                        {
