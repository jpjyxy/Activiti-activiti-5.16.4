...
public class Parser
{
    ...
    public static abstract class ExtensionHandler
    {
        ...
        /**
         * Called by the parser if it handles a extended token associated with this handler at the appropriate extension
         * point.
         * 
         * @param children
    ...
    private static final String EXPR_FIRST = IDENTIFIER + "|" + STRING + "|" + FLOAT + "|" + INTEGER + "|" + TRUE + "|"
        + FALSE + "|" + NULL + "|" + MINUS + "|" + NOT + "|" + EMPTY + "|" + LPAREN;
     ...
     * throw exception
     */
    protected void fail(Symbol expected)
        throws ParseException
    {
     ...
     */
    protected final Token lookahead(int index)
     ...
     */
    protected final Token consumeToken()
        throws ScanException, ParseException
    {
        Token result = token;
        if (lookahead.isEmpty())
     ...
     */
    protected final Token consumeToken(Symbol expected)
        throws ScanException, ParseException
    {
        ...
        throws ScanException, ParseException
    {
        ...
        switch (token.getSymbol())
        {
            case IDENTIFIER:
                ...
                if (token.getSymbol() == COLON && lookahead(0).getSymbol() == IDENTIFIER
