...
public class EntityManagerSessionImpl implements EntityManagerSession
{
    ...
    public EntityManagerSessionImpl(EntityManagerFactory entityManagerFactory, boolean handleTransactions,
        ...
        if (closeEntityManager && entityManager != null && !entityManager.isOpen())
        {
            ...
            catch (IllegalStateException ise)
            {
                throw new ActivitiException(
                    "Error while closing EntityManager, may have already been closed or it is container-managed", ise);
            }
        }
    }
