...
public class JPAEntityMappings
{
    ...
    public String getJPAClassString(Object value)
    {
        ...
        {
            throw new ActivitiIllegalArgumentException("Object is not a JPA Entity: class='" + value.getClass() + "', "
                + value);
        }
    ...
    public String getIdString(Object value)
    {
        ...
        else if (value instanceof Long || value instanceof String || value instanceof Byte || value instanceof Short
        ...
        {
            throw new ActivitiIllegalArgumentException("Unsupported Primary key type for JPA-Entity: "
