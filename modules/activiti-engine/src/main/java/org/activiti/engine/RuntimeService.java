...
public interface RuntimeService
{
     ...
     * Starts a new process instance in the latest version of the process definition with the given key.
     * 
     * A business key can be provided to associate the process instance with a certain identifier that has a clear
     * business meaning. For example in an order process, the business key could be an order id. This business key can
     * then be used to easily look up that process instance , see
     * {@link ProcessInstanceQuery#processInstanceBusinessKey(String)}. Providing such a business key is definitely a
     * best practice.
     * 
     * @param processDefinitionKey key of process definition, cannot be null.
     * @param businessKey a key that uniquely identifies the process instance in the context or the given process
     *            definition.
     * @throws ActivitiObjectNotFoundException when no process definition is deployed with the given key.
     */
     ...
     * </p>
     * 
     * See {@link #startProcessInstanceByMessage(String)}. In addition, this method allows specifying a the payload of
     * the message as a map of process variables.
     * 
     * @param messageName the 'name' of the message as specified as an attribute on the bpmn20
     *            {@code <message name="messageName" />} element.
     * @param processVariables the 'payload' of the message. The variables are added as processes variables to the
    ...
    /**
     * Similar to {@link RuntimeService#startProcessInstanceByMessage(String, Map<String, Object>)}, but with tenant
     * context.
     */
     ...
     * </p>
     * 
     * See {@link #startProcessInstanceByMessage(String, Map)}. In addition, this method allows specifying a business
     * key.
     * 
     * @param messageName the 'name' of the message as specified as an attribute on the bpmn20
     *            {@code <message name="messageName" />} element.
    ...
    /**
     * Similar to {@link RuntimeService#startProcessInstanceByMessage(String, String, Map<String, Object>)}, but with
     * tenant context.
     */
    ...
    /**
     * Finds the activity ids for all executions that are waiting in activities. This is a list because a single
     * activity can be active multiple times.
     * 
    ...
    /**
     * Retrieves the {@link IdentityLink}s associated with the given process instance. Such an {@link IdentityLink}
    ...
    /**
     * All variable values that are defined in the execution scope, without taking outer scopes into account. If you
     * have many task local variables and you only need a few, consider using
    ...
    /**
     * The variable values for all given variableNames, takes all variables into account which are visible from the
     * given execution scope (including parent scopes).
     * 
     * @param executionId id of execution, cannot be null.
    ...
    /**
     * The variable values for the given variableNames only taking the given execution scope into account, not looking
     * in outer scopes.
     * 
     * @param executionId id of execution, cannot be null.
     * @param variableNames the collection of variable names that should be retrieved.
     ...
     * <p>
     * Variables are set according to the algorithm as documented for {@link VariableScope#setVariables(Map)}, applied
    ...
    /**
     * Update or create given variables for an execution (not considering parent scopes). If the variables are not
     * already existing, it will be created in the given execution.
     * 
     * @param executionId id of the execution, cannot be null.
     * @param variables map containing name (key) and value of variables, can be null.
     * @throws ActivitiObjectNotFoundException when no execution is found for the given executionId.
     ...
     * 
     * If a process instance is in state suspended, activiti will not execute jobs (timers, messages) associated with
     * this instance.
     * 
     * If you have a process instance hierarchy, suspending one process instance form the hierarchy will not suspend
     * other process instances form that hierarchy.
     * 
    ...
    /**
     * Notifies the process engine that a signal event of name 'signalName' has been received. This method delivers the
     * signal to all executions waiting on the signal.
     * <p/>
     * 
    ...
    /**
     * Notifies the process engine that a signal event of name 'signalName' has been received. This method delivers the
     * signal to a single execution, being the execution referenced by 'executionId'. The waiting execution is notified
     * synchronously.
     * 
     * @param signalName the name of the signal event
    ...
    /**
     * Notifies the process engine that a message event with name 'messageName' has been received and has been
     * correlated to an execution with id 'executionId'.
     * 
    ...
    /**
     * Notifies the process engine that a message event with the name 'messageName' has been received and has been
     * correlated to an execution with id 'executionId'.
     * 
     * The waiting execution is notified synchronously.
     * 
     * <p>
     * Variables are set for the scope of the execution of the message event subscribed to the message name. For
     * example:
     * <p>
