...
public abstract class AbstractSetProcessDefinitionStateCmd implements Command<Void>
{
    ...
    protected List<ProcessDefinitionEntity> findProcessDefinition(CommandContext commandContext)
    {
        ...
        if (processDefinitionId != null)
        {
            ...
            if (processDefinitionEntity == null)
            {
                throw new ActivitiObjectNotFoundException("Cannot find process definition for id '"
        ...
        ProcessDefinition processDefinition, int currentPageStartIndex)
    {
        ...
        {
            return new ProcessInstanceQueryImpl(commandContext).processDefinitionId(processDefinition.getId())
                .suspended()
    ...
    /**
     * Subclasses should return the type of the {@link JobHandler} here. it will be used when the user provides an
     * execution date on which the actual state change will happen.
     */
