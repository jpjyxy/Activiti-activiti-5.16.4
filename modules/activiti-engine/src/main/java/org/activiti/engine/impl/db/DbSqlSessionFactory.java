...
public class DbSqlSessionFactory implements SessionFactory
{
    ...
    static
    {
        ...
        addDatabaseSpecificStatement("mysql",
        ...
        addDatabaseSpecificStatement("mysql",
            "selectModelCountByQueryCriteria",
        ...
        addDatabaseSpecificStatement("postgres",
        ...
        addDatabaseSpecificStatement("oracle",
        ...
        addDatabaseSpecificStatement("db2",
            "selectExclusiveJobsToExecute",
            "selectExclusiveJobsToExecute_integerBoolean");
    ...
    protected static void addDatabaseSpecificStatement(String databaseType, String activitiStatement,
