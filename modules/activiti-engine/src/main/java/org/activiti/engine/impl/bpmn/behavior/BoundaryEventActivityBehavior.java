...
public class BoundaryEventActivityBehavior extends FlowNodeActivityBehavior
{
        ...
        throws Exception
    {
        ...
        if (interrupting)
        {
            ...
            {
                interruptedExecution.deleteCascade("interrupting boundary event '" + execution.getActivity().getId()
                    + "' fired");
            }
        ...
        else
        {
            ...
            ExecutionEntity concurrentRoot =
                executionEntity.getParent().isConcurrent() ? executionEntity.getParent() : executionEntity;
