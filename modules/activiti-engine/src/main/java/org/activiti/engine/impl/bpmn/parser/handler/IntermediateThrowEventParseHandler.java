...
public class IntermediateThrowEventParseHandler extends AbstractActivityBpmnParseHandler<ThrowEvent>
{
    ...
    protected void executeParse(BpmnParse bpmnParse, ThrowEvent intermediateEvent)
    {
        ...
        ActivityImpl nestedActivityImpl =
            createActivityOnCurrentScope(bpmnParse, intermediateEvent, BpmnXMLConstants.ELEMENT_EVENT_THROW);
        ...
        {
            nestedActivityImpl.setActivityBehavior(bpmnParse.getActivityBehaviorFactory()
    ...
    //
    // protected CompensateEventDefinition createCompensateEventDefinition(BpmnParse bpmnParse,
    // org.activiti.bpmn.model.CompensateEventDefinition eventDefinition, ScopeImpl scopeElement) {
