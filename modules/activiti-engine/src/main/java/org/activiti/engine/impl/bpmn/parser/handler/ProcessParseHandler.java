...
public class ProcessParseHandler extends AbstractBpmnParseHandler<Process>
{
    ...
    protected ProcessDefinitionEntity transformProcess(BpmnParse bpmnParse, Process process)
    {
        ...
        /*
         * Mapping object model - bpmn xml: processDefinition.id -> generated by activiti engine processDefinition.key
         * -> bpmn id (required) processDefinition.name -> bpmn name (optional)
         */
        ...
        currentProcessDefinition.setProperty(PROPERTYNAME_DOCUMENTATION, process.getDocumentation()); // Kept for
                                                                                                      // backwards
                                                                                                      // compatibility.
                                                                                                      // See ACT-1020
        ...
        ProcessDefinitionEntity currentProcessDefinition)
    {
        ...
        if (eventListeners != null && !eventListeners.isEmpty())
        {
            for (EventListener eventListener : eventListeners)
            {
                ...
                {
                    currentProcessDefinition.getEventSupport().addEventListener(bpmnParse.getListenerFactory()
