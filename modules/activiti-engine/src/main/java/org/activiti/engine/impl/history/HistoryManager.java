...
public interface HistoryManager extends Session
{
    ...
    /**
     * Record a sub-process-instance started and alters the calledProcessinstanceId on the current active activity's
     * historic counterpart. Only effective when activity history is enabled.
     */
    ...
    /**
     * Finds the {@link HistoricActivityInstanceEntity} that is active in the given execution. Uses the
     * {@link DbSqlSession} cache to make sure the right instance is returned, regardless of whether or not entities
     * have already been flushed to DB.
     */
    public abstract HistoricActivityInstanceEntity findActivityInstance(ExecutionEntity execution);
    
    /**
     * Replaces any open historic activityInstances' execution-id's to the id of the replaced execution, if activity
     * history is enabled.
     */
     ...
     * Record a variable has been created, if audit history is enabled.
     */
    public abstract void recordHistoricDetailVariableCreate(VariableInstanceEntity variable,
     ...
     */
    public abstract void createIdentityLinkComment(String taskId, String userId, String groupId, String type,
        boolean create);
     ...
     * Creates a new comment to indicate a new {@link IdentityLink} has been created or deleted, if history is enabled.
     */
    public abstract void createProcessInstanceIdentityLinkComment(String processInstanceId, String userId,
     ...
     */
    public abstract void createAttachmentComment(String taskId, String processInstanceId, String attachmentName,
        boolean create);
    
    /**
     * Report form properties submitted, if audit history is enabled.
     */
    public abstract void reportFormPropertiesSubmitted(ExecutionEntity processInstance, Map<String, String> properties,
        String taskId);
