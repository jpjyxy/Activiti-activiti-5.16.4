...
public abstract class VariableScopeImpl implements Serializable, VariableScope
{
    ...
    /**
     * only called when a new variable is created on this variable scope. This method is also responsible for
     * propagating the creation of this variable to the history.
     */
