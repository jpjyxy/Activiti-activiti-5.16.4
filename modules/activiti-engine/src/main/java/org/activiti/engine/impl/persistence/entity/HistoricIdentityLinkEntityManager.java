...
public class HistoricIdentityLinkEntityManager extends AbstractManager
{
    ...
    @SuppressWarnings("unchecked")
    public List<HistoricIdentityLinkEntity> findHistoricIdentityLinkByTaskUserGroupAndType(String taskId,
    ...
    @SuppressWarnings("unchecked")
    public List<HistoricIdentityLinkEntity> findHistoricIdentityLinkByProcessDefinitionUserAndGroup(
    ...
    public void deleteHistoricIdentityLinksByProcInstance(String processInstanceId)
    {
        ...
        List<HistoricIdentityLinkEntity> identityLinksFromCache =
            Context.getCommandContext().getDbSqlSession().findInCache(HistoricIdentityLinkEntity.class);
