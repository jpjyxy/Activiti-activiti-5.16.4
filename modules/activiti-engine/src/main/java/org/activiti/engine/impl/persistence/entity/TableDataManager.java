...
public class TableDataManager extends AbstractManager
{
    ...
    public static Map<Class<? extends PersistentObject>, String> persistentObjectToTableNameMap =
        new HashMap<Class<? extends PersistentObject>, String>();
    ...
    protected long getTableCount(String tableName)
    {
        ...
        Long count =
            (Long)getDbSqlSession().selectOne("selectTableCount", Collections.singletonMap("tableName", tableName));
        return count;
    }
    ...
    public TablePage getTablePage(TablePageQueryImpl tablePageQuery, int firstResult, int maxResults)
    {
        ...
        List tableData =
            getDbSqlSession().getSqlSession().selectList("selectTableData",
                tablePageQuery,
