...
public class MembershipEntityManager extends AbstractManager implements MembershipIdentityManager
{
    ...
    public void createMembership(String userId, String groupId)
    {
        ...
        if (getProcessEngineConfiguration().getEventDispatcher().isEnabled())
        {
            getProcessEngineConfiguration().getEventDispatcher()
                .dispatchEvent(ActivitiEventBuilder.createMembershipEvent(ActivitiEventType.MEMBERSHIP_CREATED,
                    groupId,
                    userId));
        }
    }
    ...
    public void deleteMembership(String userId, String groupId)
    {
        ...
        {
            getProcessEngineConfiguration().getEventDispatcher()
                .dispatchEvent(ActivitiEventBuilder.createMembershipEvent(ActivitiEventType.MEMBERSHIP_DELETED,
                    groupId,
                    userId));
        }
    }
