...
public interface ModelQuery extends Query<ModelQuery, Model>
{
    ...
    /**
     * Only select models where the category matches the given parameter. The syntax that should be used is the same as
     * in SQL, eg. %activiti%
     */
    ...
    /**
     * Only select models where the name matches the given parameter. The syntax that should be used is the same as in
     * SQL, eg. %activiti%
     */
     ...
     * 
     * Note: if modelKey(key) is not used in this query, all the models with the highest version for each key will be
     * returned (similar to process definitions)
     */
