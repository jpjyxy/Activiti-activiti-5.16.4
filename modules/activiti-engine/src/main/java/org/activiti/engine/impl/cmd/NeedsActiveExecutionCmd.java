...
public abstract class NeedsActiveExecutionCmd<T> implements Command<T>, Serializable
{
    ...
    /**
     * Subclasses should implement this method. The provided {@link ExecutionEntity} is guaranteed to be active (ie. not
     * suspended).
     */
    protected abstract T execute(CommandContext commandContext, ExecutionEntity execution);
    
    /**
     * Subclasses can override this to provide a more detailed exception message that will be thrown when the execution
     * is suspended.
     */
