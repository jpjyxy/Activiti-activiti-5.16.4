...
/**
 * behavior for activities that delegate to a complete separate execution of a process definition. In BPMN terminology
...
public interface SubProcessActivityBehavior extends ActivityBehavior
{
    ...
    /**
     * called before the process instance is destroyed to allow this activity to extract data from the sub process
     * instance. No control flow should be done on the execution yet.
     */
