...
public interface VariableType
{
     ...
     * </p>
     * <p>
     * If caching is supported, the result of {@link #getValue(ValueFields)} is saved for the duration of the session
     * and used for subsequent reads of the variable's value.
     * </p>
     * <p>
     * If caching is not supported, all reads of a variable's value require a fresh call to
