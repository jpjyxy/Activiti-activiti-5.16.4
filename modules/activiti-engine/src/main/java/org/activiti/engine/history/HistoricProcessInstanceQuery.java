...
public interface HistoricProcessInstanceQuery extends Query<HistoricProcessInstanceQuery, HistoricProcessInstance>
{
    ...
    /**
     * Only select historic process instances with the given process instance. {@link ProcessInstance) ids and
     * 
    ...
    /**
     * Only select historic process instances whose id is in the given set of ids. {@link ProcessInstance) ids and
     * 
     * @link HistoricProcessInstance} ids match.
     */
    ...
    /**
     * Only select historic process instances that don't have a process-definition of which the key is present in the
     * given list
     */
    ...
    /**
     * Only select historic process instances that are defined by a process definition with the given deployment
     * identifier.
     */
    HistoricProcessInstanceQuery deploymentId(String deploymentId);
    
    /**
     * Only select historic process instances that are defined by a process definition with one of the given deployment
     * identifiers.
     */
    ...
    /**
     * Only select process instances which had a global variable with the given value when they ended. The type only
     * applies to already ended process instances, otherwise use a {@link ProcessInstanceQuery} instead! of variable is
     * determined based on the value, using types configured in {@link ProcessEngineConfiguration#getVariableTypes()}.
    ...
    /**
     * Only select process instances which had at least one global variable with the given value when they ended. The
     * type only applies to already ended process instances, otherwise use a {@link ProcessInstanceQuery} instead! of
     * variable is determined based on the value, using types configured in
     * {@link ProcessEngineConfiguration#getVariableTypes()}. Byte-arrays and {@link Serializable} objects (which are
    ...
    /**
     * Only select process instances which had a global variable with the given name, but with a different value than
     * the passed value when they ended. Only select process instances which have a variable value greater than the
    ...
    /**
     * Only select process instances which had a global variable value greater than or equal to the passed value when
     * they ended. Booleans, Byte-arrays and {@link Serializable} objects (which are not primitive type wrappers) are
     * not supported. Only applies to already ended process instances, otherwise use a {@link ProcessInstanceQuery}
     * instead!
     * 
     * @param name cannot be null.
     * @param value cannot be null.
    ...
    /**
     * Only select process instances which had a global variable value less than the passed value when the ended. Only
     * applies to already ended process instances, otherwise use a {@link ProcessInstanceQuery} instead! Booleans,
     * Byte-arrays and {@link Serializable} objects (which are not primitive type wrappers) are not supported.
     * 
     * @param name cannot be null.
     * @param value cannot be null.
    ...
    /**
     * Only select process instances which has a global variable value less than or equal to the passed value when they
     * ended. Only applies to already ended process instances, otherwise use a {@link ProcessInstanceQuery} instead!
     * Booleans, Byte-arrays and {@link Serializable} objects (which are not primitive type wrappers) are not supported.
     * 
     * @param name cannot be null.
     * @param value cannot be null.
    ...
    /**
     * Only select process instances which had global variable value like the given value when they ended. Only applies
     * to already ended process instances, otherwise use a {@link ProcessInstanceQuery} instead! This can be used on
    ...
    /**
     * Begin an OR statement. Make sure you invoke the endOr method at the end of your OR statement. Only one OR
     * statement is allowed, for the second call to this method an exception will be thrown.
     */
    HistoricProcessInstanceQuery or();
    
    /**
     * End an OR statement. Only one OR statement is allowed, for the second call to this method an exception will be
     * thrown.
     */
    ...
    /**
     * Only select historic process instances started by the given process instance. {@link ProcessInstance) ids and
     * 
     * @link HistoricProcessInstance} ids match.
     */
