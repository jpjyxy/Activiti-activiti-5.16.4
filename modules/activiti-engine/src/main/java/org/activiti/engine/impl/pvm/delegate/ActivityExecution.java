...
public interface ActivityExecution extends DelegateExecution
{
    ...
    /**
     * creates a new execution. This execution will be the parent of the newly created execution. properties
     * processDefinition, processInstance and activity will be initialized.
     */
    ...
    /**
     * Inactivates this execution. This is useful for example in a join: the execution still exists, but it is not
     * longer active.
     */
    void inactivate();
    ...
    /**
     * Takes the given outgoing transitions, and potentially reusing the given list of executions that were previously
     * joined.
     */
     ...
     * 
     * Performs destroy scope behavior: all child executions and sub-process instances and other related resources are
     * removed. The execution itself can continue execution.
     */
