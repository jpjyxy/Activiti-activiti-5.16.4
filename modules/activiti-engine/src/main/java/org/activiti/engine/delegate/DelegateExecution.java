...
public interface DelegateExecution extends VariableScope
{
    ...
    /**
     * The {@link ExecutionListener#EVENTNAME_START event name} in case this execution is passed in for an
     ...
     * 
     * @deprecated use {@link #getProcessBusinessKey()} to get the business key for the process associated with this
     *             execution, regardless whether or not this execution is a process-instance.
     */
