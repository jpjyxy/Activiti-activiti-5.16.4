...
/**
 * Interceptor responsible for handling calls to 'user code'. User code represents external Java code (e.g. services and
 * listeners) invoked by activiti. The following is a list of classes that represent user code:
 * <ul>
 ...
 * </ul>
 * 
 * The interceptor is passed in an instance of {@link DelegateInvocation}. Implementations are responsible for calling
