...
/**
 * An abstract superclass for {@link Command} implementations that want to verify the provided task is always active
 * (ie. not suspended).
 * 
 * @author Joram Barrez
 */
public abstract class NeedsActiveTaskCmd<T> implements Command<T>, Serializable
{
    ...
    /**
     * Subclasses can override this method to provide a customized exception message that will be thrown when the task
     * is suspended.
     */
