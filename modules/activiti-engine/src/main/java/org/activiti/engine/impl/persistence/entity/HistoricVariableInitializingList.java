...
public class HistoricVariableInitializingList extends ArrayList<HistoricVariableInstanceEntity>
{
    ...
    /**
     * If the passed {@link HistoricVariableInstanceEntity} is a binary variable and the command-context is active, the
     * variable value is fetched to ensure the byte-array is populated.
     */
