...
public class VariableInitializingList extends ArrayList<VariableInstanceEntity>
{
    ...
    /**
     * If the passed {@link VariableInstanceEntity} is a binary variable and the command-context is active, the variable
     * value is fetched to ensure the byte-array is populated.
     */
