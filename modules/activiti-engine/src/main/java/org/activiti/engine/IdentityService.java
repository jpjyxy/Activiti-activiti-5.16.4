...
public interface IdentityService
{
    ...
    /**
     * @param userId id of user to delete, cannot be null. When an id is passed for an unexisting user, this operation
     *            is ignored.
     */
     ...
     * @throws RuntimeException when the given user or group doesn't exist or when the user is already member of the
     *             group.
     */
    void createMembership(String userId, String groupId);
    
    /**
     * Delete the membership of the user in the group. When the group or user don't exist or when the user is not a
     * member of the group, this operation is ignored.
     * 
    ...
    /**
     * Passes the authenticated user id for this particular thread. All service method (from any service) invocations
     * done by the same thread will have access to this authenticatedUserId.
     */
