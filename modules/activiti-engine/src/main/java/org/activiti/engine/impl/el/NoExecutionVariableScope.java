...
/**
 * Variable-scope only used to resolve variables when NO execution is active but expression-resolving is needed. This
 * occurs eg. when start-form properties have default's defined. Even though variables are not available yet,
...
public class NoExecutionVariableScope implements VariableScope
{
    ...
    /**
     * Since a {@link NoExecutionVariableScope} has no state, it's safe to use the same instance to prevent too many
     * useless instances created.
     */
