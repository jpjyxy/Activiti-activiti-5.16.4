...
public class TaskEntityManager extends AbstractManager
{
    ...
    public void deleteTasksByProcessInstanceId(String processInstanceId, String deleteReason, boolean cascade)
    {
        ...
        String reason =
            (deleteReason == null || deleteReason.length() == 0) ? TaskEntity.DELETE_REASON_DELETED : deleteReason;
    ...
    public List<Task> findTasksAndVariablesByQueryCriteria(TaskQueryImpl taskQuery)
    {
        ...
        List<Task> instanceList =
            getDbSqlSession().selectListWithRawParameterWithoutFilter(query,
                taskQuery,
    ...
    {
        return getDbSqlSession().selectListWithRawParameter("selectTaskByNativeQuery",
            parameterMap,
            firstResult,
            maxResults);
    }
