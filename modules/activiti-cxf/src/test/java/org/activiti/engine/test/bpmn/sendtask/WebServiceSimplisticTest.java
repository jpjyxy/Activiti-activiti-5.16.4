...
public class WebServiceSimplisticTest extends AbstractWebServiceTaskTest
{
    ...
    @Deployment
    public void testAsyncInvocationWithSimplisticDataFlow()
        throws Exception
    {
        ...
        processEngine.getRuntimeService().startProcessInstanceByKey("asyncWebServiceInvocationWithSimplisticDataFlow",
            variables);
