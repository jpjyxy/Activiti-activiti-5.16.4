...
public class WebServiceSimplisticTest extends AbstractWebServiceTaskTest
{
    ...
    @Deployment
    public void testWebServiceInvocationWithSimplisticDataFlow()
        throws Exception
    {
        ...
        ProcessInstance instance =
            processEngine.getRuntimeService().startProcessInstanceByKey("webServiceInvocationWithSimplisticDataFlow",
                variables);
