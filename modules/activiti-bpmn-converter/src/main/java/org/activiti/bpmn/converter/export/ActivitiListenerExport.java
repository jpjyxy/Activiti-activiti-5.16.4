...
public class ActivitiListenerExport implements BpmnXMLConstants
{
    ...
    public static boolean writeListeners(BaseElement element, boolean didWriteExtensionStartElement, XMLStreamWriter xtw)
        throws Exception
    {
        if (element instanceof HasExecutionListeners)
        {
            didWriteExtensionStartElement =
                writeListeners(ELEMENT_EXECUTION_LISTENER,
        ...
        {
            didWriteExtensionStartElement =
                writeListeners(ELEMENT_TASK_LISTENER,
