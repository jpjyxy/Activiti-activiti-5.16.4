...
public class ServiceTaskXMLConverter extends BaseBpmnXMLConverter
{
        ...
        throws Exception
    {
        ...
        else if ("##WebService".equals(xtr.getAttributeValue(null, ATTRIBUTE_TASK_IMPLEMENTATION)))
        {
            ...
            serviceTask.setOperationRef(parseOperationRef(xtr.getAttributeValue(null, ATTRIBUTE_TASK_OPERATION_REF),
                model));
        }
        
        serviceTask.setResultVariableName(xtr.getAttributeValue(ACTIVITI_EXTENSIONS_NAMESPACE,
        ...
        serviceTask.setExtensionId(xtr.getAttributeValue(ACTIVITI_EXTENSIONS_NAMESPACE,
        ...
        throws Exception
    {
        ...
        else
        {
            didWriteExtensionStartElement =
                FieldExtensionExport.writeFieldExtensions(serviceTask.getFieldExtensions(),
                    didWriteExtensionStartElement,
                    xtw);
        }
