...
public class DefinitionsRootExport implements BpmnXMLConstants
{
    ...
    protected static final Set<String> defaultNamespaces = new HashSet<String>(Arrays.asList(XSI_PREFIX,
        XSD_PREFIX,
    ...
    protected static final List<ExtensionAttribute> defaultAttributes = Arrays.asList(new ExtensionAttribute(
        TYPE_LANGUAGE_ATTRIBUTE), new ExtensionAttribute(EXPRESSION_LANGUAGE_ATTRIBUTE), new ExtensionAttribute(
        ...
        throws Exception
    {
        ...
        BpmnXMLUtil.writeCustomAttributes(model.getDefinitionsAttributes().values(),
            xtw,
            model.getNamespaces(),
            defaultAttributes);
    }
