...
public class InterfaceParser implements BpmnXMLConstants
{
        ...
        throws Exception
    {
        ...
        interfaceObject.setImplementationRef(parseMessageRef(xtr.getAttributeValue(null, ATTRIBUTE_IMPLEMENTATION_REF),
            model));
        ...
        try
        {
            while (readyWithInterface == false && xtr.hasNext())
            {
                ...
                if (xtr.isStartElement() && ELEMENT_OPERATION.equals(xtr.getLocalName()))
                {
                    ...
                    operation.setImplementationRef(parseMessageRef(xtr.getAttributeValue(null,
                        ATTRIBUTE_IMPLEMENTATION_REF), model));
