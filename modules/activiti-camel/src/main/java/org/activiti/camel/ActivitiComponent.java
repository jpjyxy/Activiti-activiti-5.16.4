...
/**
 * This class has been modified to be consistent with the changes to CamelBehavior and its implementations. The set of
 * changes significantly increases the flexibility of our Camel integration, as you can either choose one of three
 * "out-of-the-box" modes, or you can choose to create your own. Please reference the comments for the "CamelBehavior"
 * class for more information on the out-of-the-box implementation class options.
 * 
...
public class ActivitiComponent extends DefaultComponent
{
    ...
    @Override
    protected Endpoint createEndpoint(String s, String s1, Map<String, Object> stringObjectMap)
        throws Exception
    {
