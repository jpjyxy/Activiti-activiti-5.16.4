 ...
 * Exchange body. The variable must be named "camelBody" to be copied into the Camel Exchange body on the producer side
 * of the transfer (i.e. when handing control from Activiti to Camel).
 * 
