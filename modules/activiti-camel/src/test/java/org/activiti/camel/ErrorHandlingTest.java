...
public class ErrorHandlingTest extends SpringActivitiTestCase
{
    ...
    /**
     * Process instance should be removed after completion. Works as intended, if no exception interrupts the Camel
     * route.
     * 
     * @throws Exception
     */
    @Deployment(resources = {"process/errorHandling.bpmn20.xml"})
    public void testCamelRouteWorksAsIntended()
        throws Exception
    {
    ...
    /**
     * Expected behavior, with default error handling in Camel: Roll-back to previous wait state. Fails with Activiti
     * 5.12.
     * 
     * @throws Exception
     */
        ...
        throws Exception
    {
        ...
        assertEquals("No roll-back to previous wait state",
            1,
    ...
    /**
     * Exception caught and processed by Camel dead letter queue handler. Process instance proceeds to ReceiveTask as
     * expected.
     * 
     * @throws Exception
     */
    @Deployment(resources = {"process/errorHandling.bpmn20.xml"})
    public void testErrorHandledByCamel()
        throws Exception
    {
        Map<String, Object> variables = new HashMap<String, Object>();
