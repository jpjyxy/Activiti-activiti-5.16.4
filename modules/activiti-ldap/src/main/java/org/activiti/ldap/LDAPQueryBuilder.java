...
/**
 * Class with overridable methods that are called when doing the calls to the ldap system. You can extend this class and
 * plug it into the {@link LDAPConfigurator} if the default queries are inadequate for your use case.
 * 
 * @author Joram Barrez
 */
public class LDAPQueryBuilder
{
                ...
                public String executeInContext(InitialDirContext initialDirContext)
                {
                    ...
                    try
                    {
                        ...
                        NamingEnumeration<?> namingEnum =
                            initialDirContext.search(baseDn, userDnSearch, createSearchControls(ldapConfigurator));
    ...
    public String buildQueryByFullNameLike(final LDAPConfigurator ldapConfigurator, String searchText)
    {
        ...
        {
            searchExpression =
                MessageFormat.format(ldapConfigurator.getQueryUserByFullNameLike(),
