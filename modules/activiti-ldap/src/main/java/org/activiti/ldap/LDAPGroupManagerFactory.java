...
/**
 * {@link SessionFactory} responsible for creating the {@link LDAPGroupManager}. Is plugged into the
 * {@link ProcessEngineConfiguration} automatically through the {@link LDAPConfigurator}.
 * 
 * @author Joram Barrez
 */
public class LDAPGroupManagerFactory implements SessionFactory
{
    ...
    public LDAPGroupManagerFactory(LDAPConfigurator ldapConfigurator, ClockReader clockReader)
    {
        ...
        {
            ldapGroupCache =
                new LDAPGroupCache(ldapConfigurator.getGroupCacheSize(),
                    ldapConfigurator.getGroupCacheExpirationTime(), clockReader);
