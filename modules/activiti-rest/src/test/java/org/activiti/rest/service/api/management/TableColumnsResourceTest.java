...
public class TableColumnsResourceTest extends BaseSpringRestTestCase
{
        ...
        throws Exception
    {
        ...
        HttpResponse response =
            executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
                + RestUrls.createRelativeResourceUrl(RestUrls.URL_TABLE_COLUMNS, tableName)),
                HttpStatus.SC_OK);
    ...
    public void testGetColumnsForUnexistingTable()
        throws Exception
    {
        executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
            + RestUrls.createRelativeResourceUrl(RestUrls.URL_TABLE_COLUMNS, "unexisting")),
