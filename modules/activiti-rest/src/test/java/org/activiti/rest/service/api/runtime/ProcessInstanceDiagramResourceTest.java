...
public class ProcessInstanceDiagramResourceTest extends BaseSpringRestTestCase
{
        ...
        throws Exception
    {
        ...
        HttpResponse response =
            executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
                + RestUrls.createRelativeResourceUrl(RestUrls.URL_PROCESS_INSTANCE_DIAGRAM, processInstance.getId())),
                HttpStatus.SC_OK);
        assertNotNull(response.getEntity().getContent());
    }
    
    @Deployment
    public void testGetProcessDiagramWithoutDiagram()
        throws Exception
    {
    ...
    {
        executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
            + RestUrls.createRelativeResourceUrl(RestUrls.URL_PROCESS_INSTANCE_DIAGRAM, "unexistingpi")),
