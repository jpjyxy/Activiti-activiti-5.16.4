...
public class UserCollectionResourceTest extends BaseSpringRestTestCase
{
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            url =
                RestUrls.createRelativeResourceUrl(RestUrls.URL_USER_COLLECTION) + "?emailLike="
                    + encode("no-reply@activiti.org%");
            assertResultsPresentInDataResponse(url, user1.getId());
            ...
            url =
                RestUrls.createRelativeResourceUrl(RestUrls.URL_USER_COLLECTION) + "?potentialStarter="
                    + processDefinitionId;
            assertResultsPresentInDataResponse(url, user3.getId());
