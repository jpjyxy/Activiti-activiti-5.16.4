...
public class ProcessInstanceVariablesCollectionResourceTest extends BaseSpringRestTestCase
{
        ...
        throws Exception
    {
        ...
        HttpResponse response =
            executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
                + RestUrls.createRelativeResourceUrl(RestUrls.URL_PROCESS_INSTANCE_VARIABLE_COLLECTION,
     ...
     */
    @Deployment(resources = {"org/activiti/rest/service/api/runtime/ProcessInstanceVariablesCollectionResourceTest.testProcess.bpmn20.xml"})
    public void testCreateSingleProcessInstanceVariable()
        throws Exception
    {
     ...
     */
    @Deployment(resources = {"org/activiti/rest/service/api/runtime/ProcessInstanceVariablesCollectionResourceTest.testProcess.bpmn20.xml"})
    public void testCreateSingleBinaryProcessVariable()
        throws Exception
    {
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("oneTaskProcess");
        ...
        assertTrue(responseNode.get("valueUrl")
            .asText()
            .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_PROCESS_INSTANCE_VARIABLE_DATA,
                processInstance.getId(),
                "binaryVariable")));
    ...
    /**
     * Test creating a single process variable using a binary stream containing a serializable. POST
     * runtime/process-instances/{processInstanceId}/variables
     */
    @Deployment(resources = {"org/activiti/rest/service/api/runtime/ProcessInstanceVariablesCollectionResourceTest.testProcess.bpmn20.xml"})
    public void testCreateSingleSerializableProcessVariable()
        throws Exception
    {
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("oneTaskProcess");
    ...
    /**
     * Test creating a single process variable, testing edge case exceptions. POST
     * runtime/process-instances/{processInstanceId}/variables
     */
    @Deployment(resources = {"org/activiti/rest/service/api/runtime/ProcessInstanceVariablesCollectionResourceTest.testProcess.bpmn20.xml"})
    public void testCreateSingleProcessVariableEdgeCases()
        throws Exception
    {
    ...
    /**
     * Test creating a single process variable, testing default types when omitted. POST
     * runtime/process-instances/{processInstanceId}/variables
     */
    @Deployment(resources = {"org/activiti/rest/service/api/runtime/ProcessInstanceVariablesCollectionResourceTest.testProcess.bpmn20.xml"})
    public void testCreateSingleProcessVariableDefaultTypes()
        throws Exception
    {
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("oneTaskProcess");
     ...
     */
    @Deployment(resources = {"org/activiti/rest/service/api/runtime/ProcessInstanceVariablesCollectionResourceTest.testProcess.bpmn20.xml"})
    public void testCreateMultipleProcessVariables()
        throws Exception
    {
     ...
     */
    @Deployment(resources = {"org/activiti/rest/service/api/runtime/ProcessInstanceVariablesCollectionResourceTest.testProcess.bpmn20.xml"})
    public void testCreateMultipleProcessVariablesWithOverride()
        throws Exception
    {
     ...
     */
    @Deployment(resources = {"org/activiti/rest/service/api/runtime/ProcessInstanceVariablesCollectionResourceTest.testProcess.bpmn20.xml"})
    public void testDeleteAllProcessVariables()
        throws Exception
    {
