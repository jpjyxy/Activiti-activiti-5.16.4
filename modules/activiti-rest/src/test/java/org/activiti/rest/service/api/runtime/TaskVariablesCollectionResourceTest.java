...
public class TaskVariablesCollectionResourceTest extends BaseSpringRestTestCase
{
        ...
        throws Exception
    {
        ...
        // Set local task variables, including one that has the same name as one that is defined in the parent scope
        // (process instance)
     ...
     */
    @Deployment
    public void testCreateSingleTaskVariable()
        throws Exception
    {
        ...
        assertEquals("Another simple string value",
            runtimeService.getVariableLocal(task.getExecutionId(), "myVariable"));
     ...
     */
    public void testCreateSingleBinaryTaskVariable()
        throws Exception
    {
        try
        {
     ...
     * Test creating a single task variable using a binary stream. POST runtime/tasks/{taskId}/variables
     */
    public void testCreateSingleSerializableTaskVariable()
        throws Exception
    {
        try
        {
     ...
     */
    public void testCreateSingleTaskVariableEdgeCases()
        throws Exception
    {
        try
        {
     ...
     */
    public void testCreateSingleTaskVariableDefaultTypes()
        throws Exception
    {
        try
        {
     ...
     */
    public void testCreateMultipleTaskVariables()
        throws Exception
    {
        try
        {
     ...
     */
    @Deployment
    public void testDeleteAllLocalVariables()
        throws Exception
    {
        // Start process with all types of variables
        Map<String, Object> processVariables = new HashMap<String, Object>();
