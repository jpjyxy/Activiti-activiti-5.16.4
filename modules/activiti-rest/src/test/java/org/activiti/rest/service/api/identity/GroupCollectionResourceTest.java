...
public class GroupCollectionResourceTest extends BaseSpringRestTestCase
{
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            url =
                RestUrls.createRelativeResourceUrl(RestUrls.URL_GROUP_COLLECTION) + "?potentialStarter="
                    + processDefinitionId;
            assertResultsPresentInDataResponse(url, group3.getId());
        ...
        throws Exception
    {
        try
        {
            ...
            HttpPost httpPost =
                new HttpPost(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_GROUP_COLLECTION));
    ...
    public void testCreateGroupExceptions()
        throws Exception
    {
        // Create without ID
        ObjectNode requestNode = objectMapper.createObjectNode();
