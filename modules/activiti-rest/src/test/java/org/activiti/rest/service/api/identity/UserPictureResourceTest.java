...
public class UserPictureResourceTest extends BaseSpringRestTestCase
{
     ...
     */
    public void testGetPictureForUnexistingUser()
        throws Exception
    {
        executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
            + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER_PICTURE, "unexisting")),
     ...
     */
    public void testGetPictureForUserWithoutPicture()
        throws Exception
    {
        User savedUser = null;
        try
        ...
        try
        {
            ...
            HttpPut httpPut =
                new HttpPut(SERVER_URL_PREFIX
                    + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER_PICTURE, newUser.getId()));
            httpPut.setEntity(HttpMultipartHelper.getMultiPartEntity("myPicture.png",
                "image/png",
    ...
    public void testUpdatePictureWithCustomMimeType()
        throws Exception
    {
        User savedUser = null;
        try
