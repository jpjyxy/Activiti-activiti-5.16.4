...
public class TaskVariableResourceTest extends BaseSpringRestTestCase
{
        ...
        try
        {
            ...
            HttpResponse response =
                executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
                    + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_VARIABLE, task.getId(), "localTaskVariable")),
                    HttpStatus.SC_OK);
            ...
            response =
                executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
                    + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_VARIABLE,
                        processTask.getId(),
                        "sharedVariable")),
                    HttpStatus.SC_OK);
            ...
            response =
                executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
                    + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_VARIABLE,
                        processTask.getId(),
                        "sharedVariable") + "?scope=illegal"),
                    HttpStatus.SC_BAD_REQUEST);
            
            // Unexisting task
            response =
                executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
                    + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_VARIABLE, "unexisting", "sharedVariable")),
     ...
     */
    public void testGetTaskVariableData()
        throws Exception
    {
        try
        {
            ...
            // Force content-type to TEXT_PLAIN to make sure this is ignored and application-octect-stream is always
            // returned
            HttpResponse response =
                executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
                    + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_VARIABLE_DATA,
                        task.getId(),
                        "localTaskVariable")),
                    HttpStatus.SC_OK);
     ...
     * Test getting a task variable. GET runtime/tasks/{taskId}/variables/{variableName}/data
     */
    public void testGetTaskVariableDataSerializable()
        throws Exception
    {
        try
        {
     ...
     * Test getting a task variable. GET runtime/tasks/{taskId}/variables/{variableName}/data
     */
    public void testGetTaskVariableDataForIllegalVariables()
        throws Exception
    {
        try
        {
        ...
        throws Exception
    {
        ...
        httpDelete =
            new HttpDelete(SERVER_URL_PREFIX
                + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_VARIABLE, task.getId(), "anotherTaskVariable")
                + "?scope=local");
        executeHttpRequest(httpDelete, HttpStatus.SC_NO_CONTENT);
     ...
     */
    public void testUpdateBinaryTaskVariable()
        throws Exception
    {
        try
        {
            ...
            assertTrue(responseNode.get("valueUrl")
                .asText()
                .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_VARIABLE_DATA,
                    task.getId(),
                    "binaryVariable")));
