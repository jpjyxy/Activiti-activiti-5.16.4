...
public class JobCollectionResourceTest extends BaseSpringRestTestCase
{
        ...
        throws Exception
    {
        ...
        Job timerJob =
            managementService.createJobQuery().processInstanceId(processInstance.getId()).timers().singleResult();
        ...
        url =
            RestUrls.createRelativeResourceUrl(RestUrls.URL_JOB_COLLECTION) + "?processInstanceId="
        ...
        url =
            RestUrls.createRelativeResourceUrl(RestUrls.URL_JOB_COLLECTION) + "?executionId="
        ...
        url =
            RestUrls.createRelativeResourceUrl(RestUrls.URL_JOB_COLLECTION) + "?processDefinitionId="
        ...
        executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
            + RestUrls.createRelativeResourceUrl(RestUrls.URL_JOB_COLLECTION) + "?timersOnly=true&messagesOnly=true"),
            HttpStatus.SC_BAD_REQUEST);
        
        // Fetch using dueBefore
        url =
            RestUrls.createRelativeResourceUrl(RestUrls.URL_JOB_COLLECTION) + "?dueBefore="
        ...
        url =
            RestUrls.createRelativeResourceUrl(RestUrls.URL_JOB_COLLECTION) + "?dueAfter="
                + getISODateString(hourAgo.getTime());
        assertResultsPresentInDataResponse(url, timerJob.getId());
        ...
        url =
            RestUrls.createRelativeResourceUrl(RestUrls.URL_JOB_COLLECTION) + "?exceptionMessage="
                + encode(timerJob.getExceptionMessage());
        assertResultsPresentInDataResponse(url, timerJob.getId());
