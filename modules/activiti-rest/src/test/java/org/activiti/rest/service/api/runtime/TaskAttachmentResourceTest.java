...
public class TaskAttachmentResourceTest extends BaseSpringRestTestCase
{
        ...
        throws Exception
    {
        try
        {
            ...
            Attachment urlAttachment =
                taskService.createAttachment("simpleType",
                    task.getId(),
                    null,
                    "Simple attachment",
                    "Simple attachment description",
                    "http://activiti.org");
            taskService.saveAttachment(urlAttachment);
            
            // Create Binary-attachment
            Attachment binaryAttachment =
                taskService.createAttachment("binaryType",
                    task.getId(),
                    null,
                    "Binary attachment",
                    "Binary attachment description",
     ...
     * Test getting all attachments for a task. GET runtime/tasks/{taskId}/attachments
     */
    public void testGetAttachmentsUnexistingTask()
        throws Exception
    {
        executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
            + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_ATTACHMENT_COLLECTION, "unexistingtask")),
        ...
        throws Exception
    {
        try
        {
            ...
            HttpResponse response =
                executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
                    + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_ATTACHMENT,
                        task.getId(),
                        urlAttachment.getId())),
                    HttpStatus.SC_OK);
            ...
            assertTrue(responseNode.get("url")
                .textValue()
                .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_ATTACHMENT,
                    task.getId(),
                    urlAttachment.getId())));
            assertTrue(responseNode.get("taskUrl")
                .textValue()
                .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK, task.getId())));
            ...
            assertTrue(responseNode.get("url")
                ...
                .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_ATTACHMENT,
                    task.getId(),
                    binaryAttachment.getId())));
            assertTrue(responseNode.get("contentUrl")
                .textValue()
                .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_ATTACHMENT_DATA,
                    task.getId(),
                    binaryAttachment.getId())));
            assertTrue(responseNode.get("taskUrl")
                .textValue()
    ...
    /**
     * Test getting a single attachments for a task, using unexisting task and unexisting attachment. GET
     * runtime/tasks/{taskId}/attachments/{attachmentId}
     */
    public void testGetAttachmentUnexistingTaskAndAttachment()
        throws Exception
    {
        try
        {
            ...
            executeHttpRequest(new HttpGet(
                SERVER_URL_PREFIX
                    + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_ATTACHMENT,
                        task.getId(),
                        "unexistingattachment")),
                HttpStatus.SC_NOT_FOUND);
        ...
        throws Exception
    {
        try
        {
            ...
            HttpResponse response =
                executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
                    + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_ATTACHMENT_DATA,
                        task.getId(),
                        binaryAttachment.getId())),
                    HttpStatus.SC_OK);
    ...
    /**
     * Test getting the content for a single attachments for a task, with a mime-type set. GET
     * runtime/tasks/{taskId}/attachments/{attachmentId}/content
     */
    public void testGetAttachmentContentWithMimeType()
        throws Exception
    {
        try
        {
            ...
            // Create Binary-attachment
            Attachment binaryAttachment =
                taskService.createAttachment("application/xml",
                    task.getId(),
                    null,
                    "Binary attachment",
                    "Binary attachment description",
    ...
    /**
     * Test getting the content for a single attachments for a task, for an attachment without content. GET
     * runtime/tasks/{taskId}/attachments/{attachmentId}/content
     */
    public void testGetAttachmentContentWithoutContent()
        throws Exception
    {
        try
        {
        ...
        throws Exception
    {
        try
        {
            ...
            HttpPost httpPost =
                new HttpPost(SERVER_URL_PREFIX
                    + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_ATTACHMENT_COLLECTION, task.getId()));
    ...
    /**
     * Test creating a single attachments for a task, using multipart-request to supply content POST
     * runtime/tasks/{taskId}/attachments/{attachmentId}
     */
    public void testCreateAttachmentWithContent()
        throws Exception
    {
        ...
        try
        {
            ...
            assertEquals("This is binary content",
                IOUtils.toString(taskService.getAttachmentContent(binaryAttachment.getId())));
     ...
     * runtime/tasks/{taskId}/attachments/{attachmentId}
     */
    public void testCreateAttachmentNoName()
        throws Exception
    {
        try
        {
     ...
     * Test getting a single attachments for a task. GET runtime/tasks/{taskId}/attachments/{attachmentId}
     */
    public void testGetAttachmentForCompletedTask()
        throws Exception
    {
        try
        {
