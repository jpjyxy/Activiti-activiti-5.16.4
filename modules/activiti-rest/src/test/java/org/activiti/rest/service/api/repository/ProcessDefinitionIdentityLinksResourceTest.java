...
public class ProcessDefinitionIdentityLinksResourceTest extends BaseSpringRestTestCase
{
        ...
        throws Exception
    {
        ...
        HttpGet httpGet =
            new HttpGet(SERVER_URL_PREFIX
                + RestUrls.createRelativeResourceUrl(RestUrls.URL_PROCESS_DEFINITION_IDENTITYLINKS_COLLECTION,
        ...
        for (int i = 0; i < responseNode.size(); i++)
        {
            ...
            if (!link.get("user").isNull())
            {
                ...
                assertTrue(link.get("url")
                    .asText()
                    .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_PROCESS_DEFINITION_IDENTITYLINK,
                        processDefinition.getId(),
                        "users",
                        "kermit")));
    ...
    public void testGetIdentityLinksForUnexistingProcessDefinition()
        throws Exception
    {
        HttpGet httpGet =
            new HttpGet(SERVER_URL_PREFIX
    ...
    @Deployment(resources = {"org/activiti/rest/service/api/repository/oneTaskProcess.bpmn20.xml"})
    public void testAddCandidateStarterToProcessDefinition()
        throws Exception
    {
        ProcessDefinition processDefinition = repositoryService.createProcessDefinitionQuery().singleResult();
        ...
        List<IdentityLink> createdLinks =
    ...
    public void testAddCandidateStarterToUnexistingProcessDefinition()
        throws Exception
    {
        // Create user candidate
        ObjectNode requestNode = objectMapper.createObjectNode();
    ...
    @Deployment(resources = {"org/activiti/rest/service/api/repository/oneTaskProcess.bpmn20.xml"})
    public void testGetCandidateStarterFromProcessDefinition()
        throws Exception
    {
        ProcessDefinition processDefinition = repositoryService.createProcessDefinitionQuery().singleResult();
        repositoryService.addCandidateStarterGroup(processDefinition.getId(), "admin");
        ...
        HttpGet httpGet =
            new HttpGet(SERVER_URL_PREFIX
                + RestUrls.createRelativeResourceUrl(RestUrls.URL_PROCESS_DEFINITION_IDENTITYLINK,
                    processDefinition.getId(),
                    "users",
                    "kermit"));
        HttpResponse response = executeHttpRequest(httpGet, HttpStatus.SC_OK);
    ...
    @Deployment(resources = {"org/activiti/rest/service/api/repository/oneTaskProcess.bpmn20.xml"})
    public void testDeleteCandidateStarterFromProcessDefinition()
        throws Exception
    {
        ProcessDefinition processDefinition = repositoryService.createProcessDefinitionQuery().singleResult();
        repositoryService.addCandidateStarterGroup(processDefinition.getId(), "admin");
        ...
        List<IdentityLink> remainingLinks =
            repositoryService.getIdentityLinksForProcessDefinition(processDefinition.getId());
    ...
    public void testDeleteCandidateStarterFromUnexistingProcessDefinition()
        throws Exception
    {
        HttpDelete httpDelete =
            new HttpDelete(SERVER_URL_PREFIX
    ...
    public void testGetCandidateStarterFromUnexistingProcessDefinition()
        throws Exception
    {
        HttpGet httpGet =
            new HttpGet(SERVER_URL_PREFIX
