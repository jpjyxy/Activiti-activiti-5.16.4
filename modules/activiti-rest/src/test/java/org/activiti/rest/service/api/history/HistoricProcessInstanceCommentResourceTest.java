...
public class HistoricProcessInstanceCommentResourceTest extends BaseSpringRestTestCase
{
        ...
        try
        {
            ...
            HttpResponse response =
                executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
                    + RestUrls.createRelativeResourceUrl(RestUrls.URL_HISTORIC_PROCESS_INSTANCE_COMMENT_COLLECTION,
                        pi.getId())),
                    HttpStatus.SC_OK);
            ...
            assertTrue(commentNode.get("processInstanceUrl")
                .textValue()
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            HttpResponse response =
                executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
                    + RestUrls.createRelativeResourceUrl(RestUrls.URL_HISTORIC_PROCESS_INSTANCE_COMMENT,
                        pi.getId(),
                        comment.getId())),
                    200);
