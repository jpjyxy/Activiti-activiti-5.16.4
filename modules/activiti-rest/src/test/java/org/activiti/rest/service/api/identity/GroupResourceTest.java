...
public class GroupResourceTest extends BaseSpringRestTestCase
{
        ...
        throws Exception
    {
        try
        {
            ...
            HttpPut httpPut =
                new HttpPut(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_GROUP, "testgroup"));
     ...
     */
    public void testUpdateGroupNoFields()
        throws Exception
    {
        try
        {
     ...
     */
    public void testUpdateGroupNullFields()
        throws Exception
    {
        try
        {
    ...
    {
        HttpPut httpPut =
            new HttpPut(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_GROUP, "unexisting"));
