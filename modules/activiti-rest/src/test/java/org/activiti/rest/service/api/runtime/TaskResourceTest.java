...
public class TaskResourceTest extends BaseSpringRestTestCase
{
     ...
     */
    @Deployment
    public void testGetProcessTask()
        throws Exception
    {
        ...
        assertTrue(responseNode.get("executionUrl")
            .asText()
            .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_EXECUTION, task.getExecutionId())));
        assertTrue(responseNode.get("processInstanceUrl")
            .asText()
            .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_PROCESS_INSTANCE, task.getProcessInstanceId())));
        assertTrue(responseNode.get("processDefinitionUrl")
            .asText()
            .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_PROCESS_DEFINITION, task.getProcessDefinitionId())));
     ...
     */
    public void testGetProcessAdhoc()
        throws Exception
    {
        try
        {
            ...
            assertTrue(responseNode.get("parentTaskUrl")
                .asText()
                .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK, parentTask.getId())));
     ...
     */
    public void testUpdateTaskNoOverrides()
        throws Exception
    {
        try
        {
            ...
            HttpPut httpPut =
                new HttpPut(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK, task.getId()));
     ...
     */
    public void testUpdateUnexistingTask()
        throws Exception
    {
        ObjectNode requestNode = objectMapper.createObjectNode();
        ...
        // Execute the request with an empty request JSON-object
        HttpPut httpPut =
            new HttpPut(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK, "unexistingtask"));
        httpPut.setEntity(new StringEntity(requestNode.toString()));
        ...
        throws Exception
    {
        try
        {
            ...
            HttpDelete httpDelete =
                new HttpDelete(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK, taskId));
     ...
     * Test updating an unexisting task. PUT runtime/tasks/{taskId}
     */
    public void testDeleteUnexistingTask()
        throws Exception
    {
        HttpDelete httpDelete =
            new HttpDelete(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK, "unexistingtask"));
     ...
     */
    @Deployment
    public void testDeleteTaskInProcess()
        throws Exception
    {
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("oneTaskProcess");
        Task task = taskService.createTaskQuery().processInstanceId(processInstance.getId()).singleResult();
        ...
        HttpDelete httpDelete =
            new HttpDelete(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK, task.getId()));
        ...
        throws Exception
    {
        try
        {
            ...
            HttpPost httpPost =
                new HttpPost(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK, task.getId()));
            ...
            if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT))
            {
                ...
                List<HistoricVariableInstance> updates =
        ...
        throws Exception
    {
        try
        {
            ...
            HttpPost httpPost =
                new HttpPost(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK, taskId));
            httpPost.setEntity(new StringEntity(requestNode.toString()));
            executeHttpRequest(httpPost, HttpStatus.SC_OK);
            task = taskService.createTaskQuery().taskId(taskId).singleResult();
            assertNotNull(task);
        ...
        throws Exception
    {
        try
        {
            ...
            // Delegating again shouldn't cause an exception and should delegate to user without affecting initial
            // delegator (owner)
     ...
     */
    public void testActionsUnexistingTask()
        throws Exception
    {
        ObjectNode requestNode = objectMapper.createObjectNode();
        requestNode.put("action", "complete");
        HttpPost httpPost =
            new HttpPost(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK, "unexisting"));
        httpPost.setEntity(new StringEntity(requestNode.toString()));
