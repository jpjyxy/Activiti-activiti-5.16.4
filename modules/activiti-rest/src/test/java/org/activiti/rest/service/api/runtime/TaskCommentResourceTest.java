...
public class TaskCommentResourceTest extends BaseSpringRestTestCase
{
        ...
        throws Exception
    {
        try
        {
            ...
            assertTrue(commentNode.get("taskUrl")
                .textValue()
                .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_COMMENT, task.getId(), comment.getId())));
        ...
        throws Exception
    {
        try
        {
            ...
            assertTrue(responseNode.get("taskUrl")
                .textValue()
                .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_COMMENT,
                    task.getId(),
    ...
    public void testCreateCommentWithProcessInstanceId()
        throws Exception
    {
        ...
        assertTrue(responseNode.get("taskUrl")
            .textValue()
            .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_COMMENT, task.getId(), commentsOnTask.get(0)
                .getId())));
     ...
     */
    public void testGetCommentWithCompletedTask()
        throws Exception
    {
        try
        {
