...
public class UserResourceTest extends BaseSpringRestTestCase
{
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            HttpPut httpPut =
                new HttpPut(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER, newUser.getId()));
    ...
    {
        HttpPut httpPut =
            new HttpPut(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_USER, "unexisting"));
