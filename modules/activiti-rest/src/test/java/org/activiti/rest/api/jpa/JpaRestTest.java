...
public class JpaRestTest extends BaseJPARestTestCase
{
    ...
    public void testGetJpaVariableViaTaskVariablesCollections()
        throws Exception
    {
        ...
        ProcessInstance processInstance =
            processEngine.getRuntimeService().startProcessInstanceByKey("jpa-process", processVariables);
    ...
    @Test
    @Deployment(resources = {"org/activiti/rest/api/jpa/jpa-process.bpmn20.xml"})
    public void testGetJpaVariableViaTaskCollection()
        throws Exception
    {
        ...
        HttpResponse response =
            executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
                + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_COLLECTION) + "?includeProcessVariables=true"),
                HttpStatus.SC_OK);
    ...
    @Test
    @Deployment(resources = {"org/activiti/rest/api/jpa/jpa-process.bpmn20.xml"})
    public void testGetJpaVariableViaHistoricProcessCollection()
        throws Exception
    {
        ...
        HttpResponse response =
            executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
                + RestUrls.createRelativeResourceUrl(RestUrls.URL_HISTORIC_PROCESS_INSTANCES) + "?processInstanceId="
    ...
    @Test
    @Deployment(resources = {"org/activiti/rest/api/jpa/jpa-process.bpmn20.xml"})
    public void testGetJpaVariableViaHistoricVariablesCollections()
        throws Exception
    {
        ...
        HttpResponse response =
            executeHttpRequest(new HttpGet(SERVER_URL_PREFIX
                + RestUrls.createRelativeResourceUrl(RestUrls.URL_HISTORIC_VARIABLE_INSTANCES) + "?processInstanceId="
