...
public class TaskEventResourceTest extends BaseSpringRestTestCase
{
        ...
        throws Exception
    {
        try
        {
            ...
            assertTrue(responseNode.get("url")
                .asText()
                .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_EVENT, task.getId(), event.getId())));
    ...
    /**
     * Test getting an unexisting event for task and event for unexisting task. GET
     * runtime/tasks/{taskId}/events/{eventId}
     */
    public void testGetUnexistingEventAndTask()
        throws Exception
    {
        try
        {
