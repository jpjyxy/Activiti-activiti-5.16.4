...
public class ModelResourceSourceTest extends BaseSpringRestTestCase
{
    ...
    public void testGetModelEditorSourceNoSource()
        throws Exception
    {
        Model model = null;
        try
    ...
    public void testGetModelEditorSourceExtraNoSource()
        throws Exception
    {
        Model model = null;
        try
    ...
    public void testGetModelSourceUnexistingModel()
        throws Exception
    {
        HttpGet httpGet =
            new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_MODEL_SOURCE, "unexisting"));
        executeHttpRequest(httpGet, HttpStatus.SC_NOT_FOUND);
    }
    
    public void testGetModelSourceExtraUnexistingModel()
        throws Exception
    {
        HttpGet httpGet =
            new HttpGet(SERVER_URL_PREFIX
    ...
    public void testSetModelEditorSource()
        throws Exception
    {
        ...
        try
        {
            ...
            HttpPut httpPut =
                new HttpPut(SERVER_URL_PREFIX
                    + RestUrls.createRelativeResourceUrl(RestUrls.URL_MODEL_SOURCE, model.getId()));
            httpPut.setEntity(HttpMultipartHelper.getMultiPartEntity("sourcefile",
                "application/octet-stream",
                new ByteArrayInputStream("This is the new editor source".getBytes()),
                null));
    ...
    public void testSetModelEditorSourceExtra()
        throws Exception
    {
        ...
        try
        {
            ...
            httpPut.setEntity(HttpMultipartHelper.getMultiPartEntity("sourcefile",
                "application/octet-stream",
                new ByteArrayInputStream("This is the new extra editor source".getBytes()),
                null));
            executeBinaryHttpRequest(httpPut, HttpStatus.SC_NO_CONTENT);
    ...
    public void testSetModelSourceUnexistingModel()
        throws Exception
    {
        HttpPut httpPut =
            new HttpPut(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_MODEL_SOURCE, "unexisting"));
        httpPut.setEntity(new StringEntity(""));
        executeBinaryHttpRequest(httpPut, HttpStatus.SC_NOT_FOUND);
    }
    
    public void testSetModelSourceExtraUnexistingModel()
        throws Exception
    {
        HttpPut httpPut =
            new HttpPut(SERVER_URL_PREFIX
