...
public class ModelResourceTest extends BaseSpringRestTestCase
{
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            HttpGet httpGet =
                new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_MODEL, model.getId()));
    ...
    public void testGetUnexistingModel()
        throws Exception
    {
        HttpGet httpGet =
            new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_MODEL, "unexisting"));
    ...
    public void testDeleteUnexistingModel()
        throws Exception
    {
        HttpDelete httpDelete =
            new HttpDelete(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_MODEL, "unexisting"));
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            HttpPut httpPut =
                new HttpPut(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_MODEL, model.getId()));
    ...
    @Deployment(resources = {"org/activiti/rest/service/api/repository/oneTaskProcess.bpmn20.xml"})
    public void testUpdateModelOverrideWithNull()
        throws Exception
    {
        Model model = null;
        try
    ...
    @Deployment(resources = {"org/activiti/rest/service/api/repository/oneTaskProcess.bpmn20.xml"})
    public void testUpdateModelNoFields()
        throws Exception
    {
    ...
    public void testUpdateUnexistingModel()
        throws Exception
    {
        HttpPut httpPut =
            new HttpPut(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_MODEL, "unexisting"));
