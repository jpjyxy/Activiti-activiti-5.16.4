...
public class HistoricActivityInstanceCollectionResourceTest extends BaseSpringRestTestCase
{
    ...
    public void testQueryActivityInstances()
        throws Exception
    {
        ...
        assertResultsPresentInDataResponse(url + "?processInstanceId=" + processInstance.getId(),
            3,
            "theStart",
            "processTask",
            "processTask2");
        
        assertResultsPresentInDataResponse(url + "?processInstanceId=" + processInstance2.getId(),
            2,
            "theStart",
            "processTask");
        ...
        throws JsonProcessingException, IOException
    {
        ...
        if (expectedActivityIds != null)
        {
            ...
            Assert.assertTrue("Not all entries have been found in result, missing: "
