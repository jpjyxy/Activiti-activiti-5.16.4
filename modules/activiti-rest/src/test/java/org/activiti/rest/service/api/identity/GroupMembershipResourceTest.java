...
public class GroupMembershipResourceTest extends BaseSpringRestTestCase
{
        ...
        throws Exception
    {
        try
        {
            ...
            assertTrue(responseNode.get("url")
                .textValue()
                .endsWith(RestUrls.createRelativeResourceUrl(RestUrls.URL_GROUP_MEMBERSHIP,
                    testGroup.getId(),
                    testUser.getId())));
            ...
            assertEquals("testuser", identityService.createUserQuery()
                .memberOfGroup("testgroup")
                .singleResult()
                .getId());
        }
        finally
     ...
     */
    public void testDeleteMembershipNoMember()
        throws Exception
    {
        try
        {
     ...
     */
    public void testDeleteMemberfromUnexistingGroup()
        throws Exception
    {
        HttpDelete httpDelete =
            new HttpDelete(SERVER_URL_PREFIX
     ...
     */
    public void testAddMemberToUnexistingGroup()
        throws Exception
    {
        HttpPost httpPost =
            new HttpPost(SERVER_URL_PREFIX
     ...
     */
    public void testAddMemberNoUserId()
        throws Exception
    {
        HttpPost httpPost =
            new HttpPost(SERVER_URL_PREFIX
