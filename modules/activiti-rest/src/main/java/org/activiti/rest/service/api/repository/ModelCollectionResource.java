...
public class ModelCollectionResource extends BaseModelResource
{
    ...
    public DataResponse getModels(@RequestParam
    Map<String, String> allRequestParams, HttpServletRequest request)
    {
        ...
        return new ModelsPaginateList(restResponseFactory, request.getRequestURL()
            .toString()
            .replace("/repository/models", "")).paginateList(allRequestParams, modelQuery, "id", allowedSortProperties);
    }
    
    @RequestMapping(value = "/repository/models", method = RequestMethod.POST, produces = "application/json")
    public ModelResponse createModel(@RequestBody
    ModelRequest modelRequest, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        return restResponseFactory.createModelResponse(model,
            request.getRequestURL().toString().replace("/repository/models", ""));
    }
}
