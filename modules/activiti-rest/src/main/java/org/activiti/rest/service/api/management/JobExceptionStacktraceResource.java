...
public class JobExceptionStacktraceResource
{
    ...
    public String getJobStacktrace(@PathVariable
    String jobId, HttpServletResponse response)
    {
        ...
        if (stackTrace == null)
        {
            throw new ActivitiObjectNotFoundException("Job with id '" + job.getId()
                + "' doesn't have an exception stacktrace.", String.class);
        }
