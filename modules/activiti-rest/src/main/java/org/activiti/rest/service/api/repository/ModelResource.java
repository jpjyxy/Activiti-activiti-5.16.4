...
public class ModelResource extends BaseModelResource
{
    ...
    public ModelResponse getModel(@PathVariable
    String modelId, HttpServletRequest request)
    {
    ...
    public ModelResponse updateModel(@PathVariable
    String modelId, @RequestBody
    ModelRequest modelRequest, HttpServletRequest request)
    {
        Model model = getModelFromRequest(modelId);
