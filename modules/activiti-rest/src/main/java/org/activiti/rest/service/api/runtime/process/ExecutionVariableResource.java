...
public class ExecutionVariableResource extends BaseExecutionVariableResource
{
    ...
    public RestVariable getVariable(@PathVariable("executionId")
    String executionId, @PathVariable("variableName")
    ...
    public RestVariable updateVariable(@PathVariable("executionId")
    String executionId, @PathVariable("variableName")
    ...
    public void deleteVariable(@PathVariable("executionId")
    String executionId, @PathVariable("variableName")
    String variableName, @RequestParam(value = "scope", required = false)
