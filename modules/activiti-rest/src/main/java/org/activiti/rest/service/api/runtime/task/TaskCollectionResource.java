...
public class TaskCollectionResource extends TaskBaseResource
{
    ...
    public DataResponse getTasks(@RequestParam
    Map<String, String> requestParams, HttpServletRequest httpRequest)
    {
    ...
    TaskRequest taskRequest, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        return restResponseFactory.createTaskResponse(task,
            request.getRequestURL().toString().replace("/runtime/tasks", ""));
    }
}
