...
public class HistoricTaskInstanceBaseResource
{
    ...
    static
    {
        ...
        // Duplicate usage of HistoricTaskInstanceQueryProperty.START, to keep naming consistent and keep
        ...
        Map<String, String> allRequestParams, String serverRootUrl)
    {
        ...
        return new HistoricTaskInstancePaginateList(restResponseFactory, serverRootUrl).paginateList(allRequestParams,
            queryRequest,
            query,
            "taskInstanceId",
        ...
        for (QueryVariable variable : variables)
        {
            ...
            switch (variable.getVariableOperation())
            {
                ...
                case NOT_EQUALS_IGNORE_CASE:
                    if (actualValue instanceof String)
                    {
                        taskInstanceQuery.processVariableValueNotEqualsIgnoreCase(variable.getName(),
                            (String)actualValue);
                    }
                    else
                    {
