...
public class HistoricTaskInstanceVariableDataResource
{
    ...
    public @ResponseBody
    byte[] getVariableData(@PathVariable("taskId")
    String taskId, @PathVariable("variableName")
    String variableName, @RequestParam(value = "scope", required = false)
    String scope, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        HttpServletRequest request)
    {
        ...
        if (taskObject == null)
        {
            throw new ActivitiObjectNotFoundException("Historic task instance '" + taskId + "' couldn't be found.",
        ...
        if (value == null)
        {
            throw new ActivitiObjectNotFoundException("Historic task instance '" + taskId + "' variable value for "
        ...
        else
        {
            ...
            return restResponseFactory.createRestVariable(variableName,
                ...
                includeBinary,
                serverRootUrl.substring(0, serverRootUrl.indexOf("/history/historic-task-instances/")));
        }
    }
}
