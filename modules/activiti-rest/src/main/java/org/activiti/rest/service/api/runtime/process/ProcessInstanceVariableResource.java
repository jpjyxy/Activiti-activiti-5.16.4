...
public class ProcessInstanceVariableResource extends BaseExecutionVariableResource
{
    ...
    String processInstanceId, @PathVariable("variableName")
    ...
    String variableName, HttpServletRequest request)
    {
        ...
        {
            result =
                setBinaryVariable((MultipartHttpServletRequest)request,
                    execution,
    ...
    String scope, HttpServletResponse response)
    {
        ...
        {
            // Safe to use parentId, as the hasVariableOnScope would have stopped a global-var update on a
            // root-execution
