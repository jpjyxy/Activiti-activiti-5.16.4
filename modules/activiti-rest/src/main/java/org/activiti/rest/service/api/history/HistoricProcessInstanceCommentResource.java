...
public class HistoricProcessInstanceCommentResource
{
    ...
    String processInstanceId, @PathVariable("commentId")
    String commentId, HttpServletRequest request)
    {
        ...
        {
            throw new ActivitiObjectNotFoundException("Process instance '" + instance.getId()
                + "' doesn't have a comment with id '" + commentId + "'.", Comment.class);
        }
