...
public class GroupCollectionResource
{
    ...
    public DataResponse getGroups(@RequestParam
    Map<String, String> allRequestParams, HttpServletRequest request)
    {
        ...
        return new GroupPaginateList(restResponseFactory, request.getRequestURL()
            .toString()
            .replace("/identity/groups", "")).paginateList(allRequestParams, query, "id", properties);
    }
    
    @RequestMapping(value = "/identity/groups", method = RequestMethod.POST, produces = "application/json")
    public GroupResponse createGroup(@RequestBody
    GroupRequest groupRequest, HttpServletRequest httpRequest, HttpServletResponse response)
    {
        ...
        return restResponseFactory.createGroupResponse(created,
            httpRequest.getRequestURL().toString().replace("/identity/groups", ""));
    }
