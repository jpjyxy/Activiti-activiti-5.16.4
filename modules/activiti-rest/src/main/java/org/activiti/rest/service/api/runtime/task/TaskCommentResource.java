...
public class TaskCommentResource extends TaskBaseResource
{
    ...
    String taskId, @PathVariable("commentId")
    String commentId, HttpServletRequest request)
    {
        ...
        {
            throw new ActivitiObjectNotFoundException("Task '" + task.getId() + "' doesn't have a comment with id '"
    ...
    String taskId, @PathVariable("commentId")
    String commentId, HttpServletResponse response)
    {
