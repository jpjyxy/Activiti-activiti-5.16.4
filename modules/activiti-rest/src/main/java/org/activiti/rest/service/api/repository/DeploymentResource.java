...
public class DeploymentResource
{
    ...
    public DeploymentResponse getDeployment(@PathVariable
    ...
    public void deleteDeployment(@PathVariable
    String deploymentId, @RequestParam(value = "cascade", required = false, defaultValue = "false")
