...
public class TaskResource extends TaskBaseResource
{
    ...
    TaskRequest taskRequest, HttpServletRequest request)
    {
    ...
    String taskId, @RequestParam(value = "cascadeHistory", required = false)
    Boolean cascadeHistory, @RequestParam(value = "deleteReason", required = false)
