...
public class TaskVariableResource extends TaskVariableBaseResource
{
    ...
    String taskId, @PathVariable("variableName")
    String variableName, @RequestParam(value = "scope", required = false)
    String scopeString, HttpServletResponse response)
    {
        ...
        {
            // Safe to use executionId, as the hasVariableOnScope whould have stopped a global-var update on standalone
            // task
