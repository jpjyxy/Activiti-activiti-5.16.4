...
public class UserCollectionResource
{
    ...
    public DataResponse getUsers(@RequestParam
    Map<String, String> allRequestParams, HttpServletRequest request)
    {
        ...
        return new UserPaginateList(restResponseFactory, request.getRequestURL()
            .toString()
            .replace("/identity/users", "")).paginateList(allRequestParams, query, "id", properties);
    }
    
    @RequestMapping(value = "/identity/users", method = RequestMethod.POST, produces = "application/json")
    public UserResponse createUser(@RequestBody
    UserRequest userRequest, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        return restResponseFactory.createUserResponse(created,
            true,
            request.getRequestURL().toString().replace("/identity/users", ""));
    }
