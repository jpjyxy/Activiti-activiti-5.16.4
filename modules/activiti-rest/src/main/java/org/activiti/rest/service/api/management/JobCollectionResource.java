...
public class JobCollectionResource
{
    ...
    public DataResponse getJobs(@RequestParam
    Map<String, String> allRequestParams, HttpServletRequest request)
    {
        ...
        return new JobPaginateList(restResponseFactory, request.getRequestURL()
            .toString()
            .replace("/management/jobs", "")).paginateList(allRequestParams, query, "id", properties);
    }
}
