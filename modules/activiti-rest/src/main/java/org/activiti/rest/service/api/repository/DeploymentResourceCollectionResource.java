...
public class DeploymentResourceCollectionResource
{
    ...
    public List<DeploymentResourceResponse> getDeploymentResources(@PathVariable
    String deploymentId, HttpServletRequest request)
    {
        ...
        {
            responseList.add(restResponseFactory.createDeploymentResourceResponse(deploymentId,
                resourceId,
                contentTypeResolver.resolveContentType(resourceId),
                serverRootUrl));
        }
        return responseList;
    }
