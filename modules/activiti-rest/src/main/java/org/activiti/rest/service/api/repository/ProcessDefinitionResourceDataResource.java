...
public class ProcessDefinitionResourceDataResource extends BaseDeploymentResourceDataResource
{
    ...
    public @ResponseBody
    byte[] getProcessDefinitionResource(@PathVariable
    String processDefinitionId, HttpServletResponse response)
    {
        ProcessDefinition processDefinition = getProcessDefinitionFromRequest(processDefinitionId);
        return getDeploymentResourceData(processDefinition.getDeploymentId(),
            processDefinition.getResourceName(),
            response);
    }
    
    /**
     * Returns the {@link ProcessDefinition} that is requested. Throws the right exceptions when bad request was made or
    ...
    protected ProcessDefinition getProcessDefinitionFromRequest(String processDefinitionId)
    {
        ...
        {
            throw new ActivitiObjectNotFoundException("Could not find a process definition with id '"
