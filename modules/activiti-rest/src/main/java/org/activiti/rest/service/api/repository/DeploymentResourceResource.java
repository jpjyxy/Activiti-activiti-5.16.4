...
public class DeploymentResourceResource
{
    ...
    public DeploymentResourceResponse getDeploymentResource(@PathVariable("deploymentId")
    String deploymentId, HttpServletRequest request)
    {
        ...
        if (resourceList.contains(resourceName))
        {
            ...
            DeploymentResourceResponse response =
                restResponseFactory.createDeploymentResourceResponse(deploymentId,
                    resourceName,
