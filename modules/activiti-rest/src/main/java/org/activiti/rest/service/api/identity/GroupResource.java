...
public class GroupResource extends BaseGroupResource
{
    ...
    public GroupResponse getGroup(@PathVariable
    ...
    public GroupResponse updateGroup(@PathVariable
    String groupId, @RequestBody
    GroupRequest groupRequest, HttpServletRequest request)
    {
    ...
    String groupId, HttpServletResponse response)
    {
        Group group = getGroupFromRequest(groupId);
