...
public class HistoricProcessInstanceVariableDataResource
{
    ...
    public @ResponseBody
    byte[] getVariableData(@PathVariable("processInstanceId")
    String processInstanceId, @PathVariable("variableName")
    String variableName, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        HttpServletRequest request)
    {
        ...
        HistoricProcessInstance processObject =
        ...
        else
        {
            ...
            return restResponseFactory.createRestVariable(variableName,
                ...
                includeBinary,
                serverRootUrl.substring(0, serverRootUrl.indexOf("/history/historic-process-instances/")));
        }
    }
}
