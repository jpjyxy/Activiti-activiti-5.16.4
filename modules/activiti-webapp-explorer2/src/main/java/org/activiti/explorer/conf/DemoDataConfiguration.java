            ...
            public void run()
            {
                ...
                while (!tasks.isEmpty())
                {
                    for (Task task : tasks)
                    {
                        ...
                        processEngineConfiguration.getClock().setCurrentTime(new Date(task.getCreateTime().getTime()
        ...
        if (modelList == null || modelList.isEmpty())
        {
            ...
            try
            {
                InputStream svgStream =
                    this.getClass().getClassLoader().getResourceAsStream("org/activiti/explorer/demo/model/test.svg");
