...
public class HumanStepAssignment
{
    ...
    /**
     * @param type the type of assignment represented. Dependeing on the type, existing assignee/candidate will be
     *            removed if they are not allowed for the given type.
     */
