 ...
 * 
 * It is necessary for a correct conversion to set (or inject) {@link StepDefinition} converters (instances of
 * {@link StepDefinitionConverter}) and conversion life cycle listeners (instance of
...
public class WorkflowDefinitionConversionFactory
{
    ...
    public void setDefaultWorkflowDefinitionConversionListeners(
        List<WorkflowDefinitionConversionListener> defaultWorkflowDefinitionConversionListeners)
    {
    ...
    public void setWorkflowDefinitionConversionListeners(
        List<WorkflowDefinitionConversionListener> workflowDefinitionConversionListeners)
    {
    ...
    /**
     * @param definition {@link StepDefinition} to get converter for. First, the injected list of
     *            {@link StepDefinitionConverter} is checked, before falling back to the default list of
     *            {@link StepDefinitionConverter}.
     * @return Converter that can be used on the given definition.
     * @throws IllegalArgumentException when there is no converter known for the given definition.
     */
