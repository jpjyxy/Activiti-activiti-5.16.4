 ...
 * 
 * All {@link StepDefinitionConverter} should extend this class and implement any BPMN 2.0 xml generation logic in the
 * {@link #createProcessArtifact(StepDefinition, WorkflowDefinitionConversion)} method.
 * 
...
public abstract class BaseStepDefinitionConverter<U extends StepDefinition, T> implements StepDefinitionConverter<U, T>
{
    ...
    /**
     * Subclasses should override this method if they want to create additional artifacts for this specific step. The
     * default generated process artifact is passed as parameter.
     */
    protected void createAdditionalArtifacts(WorkflowDefinitionConversion conversion, U stepDefinition,
    ...
    protected SequenceFlow addSequenceFlow(WorkflowDefinitionConversion conversion, FlowNode sourceActivity,
    ...
    /**
     * Add a sequence-flow to the current process from source to target. Sequence-flow name is set to a user-friendly
     * name, containing an incrementing number.
     * 
     * @param conversion
