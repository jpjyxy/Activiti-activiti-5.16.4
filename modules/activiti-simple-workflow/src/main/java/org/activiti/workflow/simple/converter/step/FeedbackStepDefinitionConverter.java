 ...
 * @author Joram Barrez
 */
public class FeedbackStepDefinitionConverter extends
    BaseStepDefinitionConverter<FeedbackStepDefinition, Map<String, BaseElement>>
{
    ...
    @Override
    protected Map<String, BaseElement> createProcessArtifact(FeedbackStepDefinition feedbackStepDefinition,
        WorkflowDefinitionConversion conversion)
    {
        ...
        UserTask gatherFeedbackUserTask =
            createGatherFeedbackUserTask(feedbackStepDefinition, conversion, processElements);
    ...
    protected UserTask createSelectPeopleUserTask(FeedbackStepDefinition feedbackStepDefinition,
        WorkflowDefinitionConversion conversion, Map<String, BaseElement> processElements)
    {
        ...
        if (feedbackStepDefinition.getFeedbackProviders() != null
            && !feedbackStepDefinition.getFeedbackProviders().isEmpty())
        {
            ...
            script.append("importPackage (java.util); var feedbackProviders = new ArrayList();"
                + System.getProperty("line.separator"));
            for (String feedbackProvider : feedbackStepDefinition.getFeedbackProviders())
            {
                script.append("feedbackProviders.add('" + feedbackProvider + "');"
                    + System.getProperty("line.separator"));
            }
            script.append("task.getExecution().setVariable('" + VARIABLE_FEEDBACK_PROVIDERS + "', feedbackProviders);"
                + System.getProperty("line.separator"));
    ...
    protected ParallelGateway createForkParallelGateway(WorkflowDefinitionConversion conversion,
    ...
    protected UserTask createGatherFeedbackUserTask(FeedbackStepDefinition feedbackStepDefinition,
        WorkflowDefinitionConversion conversion, Map<String, BaseElement> processElements)
    {
    ...
    protected ParallelGateway createJoinParallelGateway(WorkflowDefinitionConversion conversion,
        Map<String, BaseElement> processElements)
    {
    ...
    protected BoundaryEvent createBoundarySignalCatch(WorkflowDefinitionConversion conversion, Signal signal,
