...
public class ChoiceStepsDefinition extends AbstractConditionStepListContainer<ChoiceStepsDefinition> implements
    StepDefinition
{
    ...
    public WorkflowDefinition endChoice()
    {
        if (workflowDefinition == null)
        {
            throw new SimpleWorkflowException(
                "Can only call endChoice when inChoice was called on a workflow definition first");
        }
