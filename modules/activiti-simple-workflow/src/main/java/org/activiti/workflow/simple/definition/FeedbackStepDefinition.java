 ...
 * 
 * The feedback initiator has the possibility to stop to the collection of the feedback, even if not all selected users
 ...
 * <li>
 * The list of users/groups is provided at runtime through the form by the user. In this case, the name of the variables
 * which are submitted through the form <b>must</b> must match the default one, see
