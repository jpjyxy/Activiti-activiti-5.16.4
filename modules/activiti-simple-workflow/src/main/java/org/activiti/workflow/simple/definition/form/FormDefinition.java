...
/**
 * A {@link HumanStepDefinition} (or other) can have a form associated with it that a user must complete to continue the
 * workflow. Such a form contains {@link FormPropertyDefinition}s and {@link FormPropertyGroup}s or potentially a form
 * key, when the properties are not used.
 * 
 * @author Joram Barrez
