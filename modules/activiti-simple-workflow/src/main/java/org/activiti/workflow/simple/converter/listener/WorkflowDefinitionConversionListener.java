 ...
 * 
 * Instances of this class can be added to a {@link WorkflowDefinitionConversionFactory} and the specific methods will
 * be called during the conversion.
 * 
...
public interface WorkflowDefinitionConversionListener
{
    ...
    /**
     * Called when the {@link WorkflowDefinitionConversion} has called all {@link StepDefinitionConverter} that were
     * added to the {@link WorkflowDefinitionConversionFactory}.
     */
