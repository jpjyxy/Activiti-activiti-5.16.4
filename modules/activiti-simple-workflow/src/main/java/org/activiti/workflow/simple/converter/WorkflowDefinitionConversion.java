 ...
 * 
 * An instance of this class is capabale of doing the actual conversion of a {@link WorkflowDefinition} and it will
 * contain all artifacts produces by the {@link StepDefinitionConverter} objects and
...
public class WorkflowDefinitionConversion
{
    ...
    /**
     * It is assumed the conversion will always create a {@link BpmnModel} and a {@link Process} (altough, strictly even
     * that is pluggable). Other artifacts that are produced during conversion are stored in this generic map.
     */
    ...
    /**
     * Call this method to actually execute the conversion of the {@link WorkflowDefinition} which was provided in the
     * constructor.
     */
    public void convert()
    {
    ...
    /**
     * @param baseName base name of the unique identifier
     * @return a string that can be used as a unique id. Eg. if a baseName with value "userTask" is passed, the first
     *         time "userTask1" will be returned. When called agian with the same baseName, "userTask2" is returned.
     *         Counts are incremented for each baseName independently withing this context instance.
     */
    ...
    /**
     * @return id of the activity that is at the end of the current process. Used to add additional steps and
     *         sequence-flows to the process.
     */
    ...
    /**
     * @param lastActivityId id of the activity that is at the end of the current process. Used to add additional steps
     *            and sequence-flows to the process.
     */
