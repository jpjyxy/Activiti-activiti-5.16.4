...
@JsonTypeName("list")
public class ListConditionStepDefinition<T> extends AbstractStepDefinitionContainer<ListConditionStepDefinition<T>>
    implements StepDefinition, NamedStepDefinition
{
    ...
    public T endList()
    {
        if (stepListContainer == null)
        {
            throw new SimpleWorkflowException(
                "Can only call endList when inList was called on a workflow definition first");
        }
