...
public class BpmnModelUtil
{
    ...
    public static Signal createSignal(WorkflowDefinitionConversion conversion, String signalName,
    ...
    public static ThrowEvent createSignalThrowEvent(WorkflowDefinitionConversion conversion,
