...
public class DefaultProcessDiagramGenerator implements ProcessDiagramGenerator
{
    ...
    protected final Map<Class<? extends BaseElement>, ActivityDrawInstruction> activityDrawInstructions =
        new HashMap<Class<? extends BaseElement>, ActivityDrawInstruction>();
    
    protected final Map<Class<? extends BaseElement>, ArtifactDrawInstruction> artifactDrawInstructions =
    ...
    public DefaultProcessDiagramGenerator(final double scaleFactor)
    {
        ...
        artifactDrawInstructions.put(Association.class, new ArtifactDrawInstruction()
        {
            ...
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact)
            {
                ...
                graphicInfoList =
                    connectionPerfectionizer(processDiagramCanvas,
                        bpmnModel,
                        sourceElement,
                        targetElement,
                        graphicInfoList);
        ...
        String labelFontName, ClassLoader customClassLoader, double scaleFactor)
    {
        ...
        DefaultProcessDiagramCanvas processDiagramCanvas =
            initProcessDiagramCanvas(bpmnModel, imageType, activityFontName, labelFontName, customClassLoader);
    ...
    protected static GraphicInfo getLineCenter(List<GraphicInfo> graphicInfoList)
    {
        ...
        for (int i = 1; i < graphicInfoList.size(); i++)
        {
            ...
            length +=
                Math.sqrt(Math.pow((int)graphicInfo.getX() - (int)previousGraphicInfo.getX(), 2)
