...
public class SubProcess extends Activity implements FlowElementsContainer
{
    ...
    public void setValues(SubProcess otherElement)
    {
        ...
        /*
         * This is required because data objects in Designer have no DI info and are added as properties, not flow
         * elements
         * 
        ...
        /*
         * flowElementList = new ArrayList<FlowElement>(); if (otherElement.getFlowElements() != null &&
         * otherElement.getFlowElements().size() > 0) { for (FlowElement element : otherElement.getFlowElements()) {
         * flowElementList.add(element.clone()); } }
         * 
         * artifactList = new ArrayList<Artifact>(); if (otherElement.getArtifacts() != null &&
         * otherElement.getArtifacts().size() > 0) { for (Artifact artifact : otherElement.getArtifacts()) {
