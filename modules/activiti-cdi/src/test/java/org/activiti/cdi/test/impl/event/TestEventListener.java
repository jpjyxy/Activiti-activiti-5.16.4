...
public class TestEventListener
{
    ...
    public void onProcessEventByKey(@Observes
    @BusinessProcess("process1")
    ...
    public void onStartActivityService1(@Observes
    ...
    public void onEndActivityService1(@Observes
    @EndActivity("service1")
    BusinessProcessEvent businessProcessEvent)
    {
        endActivityService1 += 1;
    }
    
    public void onStartActivityService2(@Observes
    ...
    public void onEndActivityService2(@Observes
    @EndActivity("service2")
    BusinessProcessEvent businessProcessEvent)
    {
        endActivityService2 += 1;
    }
    
    public void takeTransitiont1(@Observes
    @TakeTransition("t1")
    BusinessProcessEvent businessProcessEvent)
    {
        takeTransitiont1 += 1;
    ...
    public void takeTransitiont2(@Observes
    @TakeTransition("t2")
    BusinessProcessEvent businessProcessEvent)
    {
        takeTransitiont2 += 1;
    ...
    public void takeTransitiont3(@Observes
    @TakeTransition("t3")
    BusinessProcessEvent businessProcessEvent)
    {
        takeTransitiont3 += 1;
    ...
    public void onCreateTask1(@Observes
    @CreateTask("usertask1")
    BusinessProcessEvent businessProcessEvent)
    {
        createTask1 += 1;
    }
    
    public void onCreateTask2(@Observes
    @CreateTask("usertask2")
    BusinessProcessEvent businessProcessEvent)
    {
        createTask2 += 1;
    }
    
    public void onAssignTask1(@Observes
    @AssignTask("usertask1")
    BusinessProcessEvent businessProcessEvent)
    {
        assignTask1 += 1;
    }
    
    public void onCompleteTask1(@Observes
    ...
    public void onCompleteTask2(@Observes
    ...
    public void onCompleteTask3(@Observes
    @CompleteTask("usertask3")
    BusinessProcessEvent businessProcessEvent)
    {
        completeTask3 += 1;
    }
    
    public void onDeleteTask3(@Observes
    @DeleteTask("usertask3")
    BusinessProcessEvent businessProcessEvent)
    {
        deleteTask3 += 1;
    }
