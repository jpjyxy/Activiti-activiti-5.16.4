...
public class CdiBusinessProcessEvent implements BusinessProcessEvent
{
    ...
    public CdiBusinessProcessEvent(String activityId, String transitionName, ProcessDefinition processDefinition,
        VariableScope execution, BusinessProcessEventType type, String processInstanceId, String executionId,
        Date timeStamp)
    {
    ...
    {
        return "Event '" + processDefinition.getKey() + "' ['" + type + "', "
