 ...
 * <p/>
 * The map delegates changes to {@link BusinessProcess#setVariable(String, Object)} and
 * {@link BusinessProcess#getVariable(String)}, so that they are not flushed prematurely.
 * 
 * @author Daniel Meyer
 */
public class ProcessVariableMap implements Map<String, Object>
{
    ...
    {
        throw new UnsupportedOperationException(ProcessVariableMap.class.getName()
