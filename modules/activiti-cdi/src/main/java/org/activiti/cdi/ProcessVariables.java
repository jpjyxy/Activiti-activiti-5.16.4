...
/**
 * Allows to access the process variables of a managed process instance. A process instance can be managed, using the
...
public class ProcessVariables
{
    ...
    protected Object getProcessVariable(InjectionPoint ip)
    {
        ...
        {
            logger.debug("Getting process variable '{}' from ProcessInstance[{}].",
                processVariableName,
