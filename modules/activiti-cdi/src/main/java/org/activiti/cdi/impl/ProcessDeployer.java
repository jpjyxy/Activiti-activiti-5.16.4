...
/**
 * Used to deploy processes. When the activiti-cdi extension is initialized, the classpath is scanned for a file named
 * {@value #PROCESSES_FILE_NAME}. All processes listed in that file are automatically deployed to the engine.
 * 
 * @author Daniel Meyer
 */
public class ProcessDeployer
{
    ...
    public Set<String> getResourceNames()
    {
        ...
        {
            Document document =
                DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(processFileUrl.openStream());
