...
public class StartProcessInterceptor implements Serializable
{
        ...
        throws Exception
    {
        ...
        {
            throw new ActivitiException("Error while starting process using @StartProcess on method  '"
                + ctx.getMethod() + "': " + e.getMessage(), e);
        }
    }
    
    private Map<String, Object> extractVariables(StartProcess startProcessAnnotation, InvocationContext ctx)
        throws Exception
    {
