...
/**
 * {@link ProcessEngineLookup} for looking up or building a local {@link ProcessEngine} using the provided
 * processEngineName ( {@link ProcessEngines#NAME_DEFAULT} is used as default value). Can be used for looking up
 * existing {@link ProcessEngine}s in the same ClassLoader as this Class.
 * <p />
