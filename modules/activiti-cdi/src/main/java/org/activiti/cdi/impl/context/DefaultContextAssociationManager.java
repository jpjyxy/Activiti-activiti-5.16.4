...
/**
 * Default implementation of the business process association manager. Uses a fallback-strategy to associate the process
 * instance with the "broadest" active scope, starting with the conversation.
 * <p />
...
public class DefaultContextAssociationManager implements ContextAssociationManager, Serializable
{
     ...
     * 
     * @returns a list of {@link Scope}-types, which are used in the given order to resolve the broadest active context
     *          (@link #getBroadestActiveContext()})
     */
    ...
    public void setExecution(Execution execution)
    {
        ...
        {
            throw new ActivitiCdiException("Cannot associate " + execution + ", already associated with "
                + associatedExecution + ". Disassociate first!");
        }
        
        if (log.isTraceEnabled())
        {
            log.trace("Associating {} (@{})",
                execution,
