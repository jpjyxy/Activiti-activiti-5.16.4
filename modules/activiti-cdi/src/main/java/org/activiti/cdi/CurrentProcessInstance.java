...
/**
 * Allows to access executions and tasks of a managed process instance via dependency injection. A process instance can
 * be managed, using the {@link BusinessProcess}-bean.
 * 
 * The producer methods provided by this class have been extracted from the {@link BusinessProcess}-bean in order to
 * allow for specializing it.
 * 
 * @author Falko Menge
 */
public class CurrentProcessInstance
{
     ...
     * 
     * @throws ActivitiCdiException if no {@link Execution} is associated. Use {@link BusinessProcess#isAssociated()} to
     ...
     * 
     * @throws ActivitiCdiException if no {@link Task} is associated. Use {@link BusinessProcess#isTaskAssociated()} to
     *             check whether an association exists.
     */
