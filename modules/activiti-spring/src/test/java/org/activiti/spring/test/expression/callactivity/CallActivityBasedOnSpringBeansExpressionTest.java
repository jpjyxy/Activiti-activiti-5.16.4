...
/**
 * The CallActivityBasedOnSpringBeansExpressionTest is isUsed to test dynamically wiring in the calledElement in the
 * callActivity task. This test case helps verify that we do not have to hard code the sub process definition key within
 * the process.
 * 
