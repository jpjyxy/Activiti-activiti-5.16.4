...
/**
 * Creates an advanced cycle business calendar manager (ACBCM). The ACBCM can handle daylight savings changes when the
 * scheduled time zone is different than the server time zone.
 * <p>
...
public class SpringAdvancedBusinessCalendarManagerFactory
{
    ...
    public BusinessCalendarManager getBusinessCalendarManager()
    {
        ...
        mapBusinessCalendarManager.addBusinessCalendar(DueDateBusinessCalendar.NAME, new DueDateBusinessCalendar(
            getClock()));
        mapBusinessCalendarManager.addBusinessCalendar(AdvancedCycleBusinessCalendar.NAME,
