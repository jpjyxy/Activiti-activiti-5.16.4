...
public class SpringProcessEngineConfiguration extends ProcessEngineConfigurationImpl implements ApplicationContextAware
{
    ...
    /**
     * Gets the {@link AutoDeploymentStrategy} for the provided mode. This method may be overridden to implement custom
     * deployment strategies if required, but implementors should take care not to return <code>null</code>.
     * 
