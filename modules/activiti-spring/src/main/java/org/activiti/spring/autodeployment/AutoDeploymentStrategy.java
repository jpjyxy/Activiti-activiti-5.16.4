...
/**
 * Strategy interface for implementations of automatically deploying resources. A strategy may perform any amount of
 * deployments for the {@link Resource}s it is provided with.
 * <p>
 * <p>
 * A strategy is capable of handling deployments corresponding to a certain indicated deployment mode. This
 * applicability is verified using the {@link #handlesMode(String)} method.
 * 
...
public interface AutoDeploymentStrategy
{
     ...
     * {@link RepositoryService} to perform deployment(s).
     * 
     ...
     */
    void deployResources(final String deploymentNameHint, final Resource[] resources,
