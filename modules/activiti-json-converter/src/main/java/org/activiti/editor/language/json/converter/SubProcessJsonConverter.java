...
public class SubProcessJsonConverter extends BaseBpmnJsonConverter
{
    ...
    protected void convertElementToJson(ObjectNode propertiesNode, FlowElement flowElement)
    {
        ...
        processor.processFlowElements(subProcess.getFlowElements(),
            model,
        ...
        /*
         * No point in copying the data conversion methods here. It would be helpful if BaseBpmnJsonConverter inherited
         * from BpmnJsonConverter.
         */
    ...
    protected FlowElement convertJsonToElement(JsonNode elementNode, JsonNode modelNode, Map<String, JsonNode> shapeMap)
    {
        ...
        if (processDataPropertiesNode != null)
        {
            List<ValuedDataObject> dataObjects =
                new BpmnJsonConverter().convertJsonToDataProperties(processDataPropertiesNode, subProcess);
