...
public class UserTaskJsonConverter extends BaseBpmnJsonConverter
{
    ...
    protected void convertElementToJson(ObjectNode propertiesNode, FlowElement flowElement)
    {
        ...
        if (StringUtils.isNotEmpty(owner) || StringUtils.isNotEmpty(assignee) || StringUtils.isNotEmpty(candidateUsers)
        ...
        if (!userTask.getCustomUserIdentityLinks().isEmpty() || !userTask.getCustomGroupIdentityLinks().isEmpty())
        {
            ...
            for (String linkType : userTask.getCustomUserIdentityLinks().keySet())
            {
                ...
                String users =
                    convertListToCommaSeparatedString(new ArrayList<String>(userTask.getCustomUserIdentityLinks()
                        .get(linkType)));
            ...
            for (String linkType : userTask.getCustomGroupIdentityLinks().keySet())
            {
                ...
                identityItemNode.put(PROPERTY_USERTASK_IDENTITY_LINK_TYPE, linkType);
                String groups =
                    convertListToCommaSeparatedString(new ArrayList<String>(userTask.getCustomGroupIdentityLinks()
                        .get(linkType)));
            ...
            if (itemsNode != null)
            {
                ...
                while (assignmentIterator.hasNext())
                {
                        ...
                        && assignmentItemNode.get(PROPERTY_USERTASK_ASSIGNMENT_EXPRESSION) != null)
                    {
                        ...
                        {
                            task.setCandidateUsers(getValueAsList(PROPERTY_USERTASK_ASSIGNMENT_EXPRESSION,
                                assignmentItemNode));
                        }
                        else if (PROPERTY_USERTASK_CANDIDATE_GROUPS.equals(assignmentType))
                        {
                            task.setCandidateGroups(getValueAsList(PROPERTY_USERTASK_ASSIGNMENT_EXPRESSION,
                                assignmentItemNode));
                        }
                    }
                }
        ...
        if (customIdentityLinksNode != null)
        {
            ...
            if (itemsNode != null)
            {
                ...
                while (customIdentityLinksIterator.hasNext())
                {
                    ...
                    if (customIdentityLinksItemNode.get(PROPERTY_USERTASK_IDENTITY_TYPE) != null
                        && customIdentityLinksItemNode.get(PROPERTY_USERTASK_IDENTITY_LINK_TYPE) != null
                        && customIdentityLinksItemNode.get(PROPERTY_USERTASK_IDENTITY_LINK_EXPRESSION) != null)
                    {
                        ...
                        String identityLinkType =
                            customIdentityLinksItemNode.get(PROPERTY_USERTASK_IDENTITY_LINK_TYPE).asText();
                        
                        List<String> identitiesList =
                            getValueAsList(PROPERTY_USERTASK_IDENTITY_LINK_EXPRESSION, customIdentityLinksItemNode);
