...
public class BoundaryEventJsonConverter extends BaseBpmnJsonConverter
{
    ...
    protected void convertElementToJson(ObjectNode propertiesNode, FlowElement flowElement)
    {
        ...
        propertiesNode.put(PROPERTY_CANCEL_ACTIVITY, boundaryEvent.isCancelActivity() ? PROPERTY_VALUE_YES
            : PROPERTY_VALUE_NO);
    ...
    protected FlowElement convertJsonToElement(JsonNode elementNode, JsonNode modelNode, Map<String, JsonNode> shapeMap)
    {
        ...
        boundaryEvent.setAttachedToRefId(lookForAttachedRef(elementNode.get(EDITOR_SHAPE_ID).asText(),
