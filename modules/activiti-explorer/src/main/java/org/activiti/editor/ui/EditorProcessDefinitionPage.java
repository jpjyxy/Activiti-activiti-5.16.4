...
public class EditorProcessDefinitionPage extends AbstractTablePage
{
    ...
    // Services
    protected transient RepositoryService repositoryService = ProcessEngines.getDefaultProcessEngine()
    ...
    /**
     * Used when the page is reached through an URL. The page will be built and the given process definition will be
     * selected.
     */
    ...
    {
        UriFragment processDefinitionFragment =
            new UriFragment(ProcessModelNavigator.PROCESS_MODEL_URI_PART, processDefinitionId);
