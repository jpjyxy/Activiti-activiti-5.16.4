...
public class AccountSelectionPopup extends TabbedSelectionWindow
{
    ...
    protected Map<String, Object> createAccountDetails(String acountName, String userName, String password,
