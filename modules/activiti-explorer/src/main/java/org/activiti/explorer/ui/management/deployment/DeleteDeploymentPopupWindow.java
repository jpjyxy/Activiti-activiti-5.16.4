    ...
    protected void addDeleteWarning()
    {
        ...
        for (ProcessDefinition processDefinition : processDefinitions)
        {
            nrOfProcessInstances +=
                runtimeService.createProcessInstanceQuery().processDefinitionId(processDefinition.getId()).count();
        }
        ...
        else
        {
            ...
            Label warningLabel =
                new Label(i18nManager.getMessage(Messages.DEPLOYMENT_DELETE_POPUP_WARNING, nrOfProcessInstances),
                    Label.CONTENT_XHTML);
