...
public class TaskMenuBar extends ToolBar
{
    ...
    protected void initItems()
    {
        ...
        ToolbarEntry inboxEntry =
            addToolbarEntry(ENTRY_INBOX, i18nManager.getMessage(Messages.TASK_MENU_INBOX), new ToolbarCommand()
            {
        ...
        ToolbarEntry tasksEntry =
            addToolbarEntry(ENTRY_TASKS, i18nManager.getMessage(Messages.TASK_MENU_TASKS), new ToolbarCommand()
            {
                public void toolBarItemSelected()
                {
        ...
        ToolbarEntry involvedEntry =
            addToolbarEntry(ENTRY_INVOLVED, i18nManager.getMessage(Messages.TASK_MENU_INVOLVED), new ToolbarCommand()
            {
                public void toolBarItemSelected()
                {
        ...
        ToolbarEntry archivedEntry =
            addToolbarEntry(ENTRY_ARCHIVED, i18nManager.getMessage(Messages.TASK_MENU_ARCHIVED), new ToolbarCommand()
            {
                public void toolBarItemSelected()
                {
