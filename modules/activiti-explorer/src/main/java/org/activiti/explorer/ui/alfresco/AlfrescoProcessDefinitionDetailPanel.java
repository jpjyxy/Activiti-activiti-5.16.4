...
public class AlfrescoProcessDefinitionDetailPanel extends ProcessDefinitionDetailPanel
{
    ...
    protected void initProcessInstancesTable()
    {
        ...
        // Header
        Label instancesTitle =
            new Label(i18nManager.getMessage(Messages.PROCESS_INSTANCES) + " (" + query.size() + ")");
        ...
        if (query.size() > 0)
        {
            ...
            instancesTable.addContainerProperty(AlfrescoProcessInstanceTableItem.PROPERTY_BUSINESSKEY,
                String.class,
                null);
            instancesTable.addContainerProperty(AlfrescoProcessInstanceTableItem.PROPERTY_ACTIONS,
                Component.class,
                null);
