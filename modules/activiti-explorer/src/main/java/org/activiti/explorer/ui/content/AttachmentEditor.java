...
public interface AttachmentEditor extends Serializable
{
    ...
    /**
     * Get the name of this editor. Only one editor with the same name can e used. The last one wit the same name added
     * to {@link AttachmentRendererManager} will be used.
     */
    String getName();
     ...
     * 
     * @param attachment the attachment to edit. Null if the editor should create a new attachment when submitted.
     */
