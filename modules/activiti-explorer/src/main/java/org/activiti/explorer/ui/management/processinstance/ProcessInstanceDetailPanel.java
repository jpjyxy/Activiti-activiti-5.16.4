...
public class ProcessInstanceDetailPanel extends DetailPanel
{
    ...
    protected void addHeader()
    {
        ...
        PrettyTimeLabel startTimeLabel =
            new PrettyTimeLabel(i18nManager.getMessage(Messages.PROCESS_START_TIME),
        ...
        if (processDefinitionEntity != null)
        {
            ...
            if (ExplorerApp.get().isUseJavascriptDiagram())
            {
                try
                {
                    ...
                    if (!bpmnModel.getFlowLocationMap().isEmpty())
                    {
                        ...
                        URL url =
                            new URL(explorerURL.getProtocol(), explorerURL.getHost(), explorerURL.getPort(),
            ...
            if (!didDrawImage && processDefinitionEntity.isGraphicalNotationDefined())
            {
                ...
                StreamResource diagram =
                    new ProcessDefinitionImageStreamResourceBuilder().buildStreamResource(processInstance,
                        repositoryService,
                        runtimeService,
                        diagramGenerator,
    ...
    protected void addDeleteButton()
    {
        ...
        deleteProcessInstanceButton.addListener(new DeleteProcessInstanceClickListener(processInstance.getId(),
            processInstancePage));
