...
public class ImageAttachmentRenderer extends GenericAttachmentRenderer
{
    ...
    public Component getDetailComponent(Attachment attachment)
    {
        ...
        InputStream imageStream =
            ImageUtil.resizeImage(taskService.getAttachmentContent(attachment.getId()), mimeType, 900, 550);
        Resource resource =
            new StreamResource(new InputStreamStreamSource(imageStream), attachment.getName()
                + extractExtention(attachment.getType()), ExplorerApp.get());
        ...
        Label fullSizeLabel =
            new Label(ExplorerApp.get().getI18nManager().getMessage(Messages.RELATED_CONTENT_SHOW_FULL_SIZE));
        ...
        else
        {
            ...
            Resource res =
                new StreamResource(new InputStreamStreamSource(taskService.getAttachmentContent(attachment.getId())),
