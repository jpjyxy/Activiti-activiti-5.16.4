...
public class AdministrationPage extends ManagementPage
{
    ...
    protected Table createList()
    {
        ...
        managementTable.addListener(new Property.ValueChangeListener()
        {
            ...
            {
                Item item = managementTable.getItem(event.getProperty().getValue()); // the value of the property is the
                ...
                if (item != null)
                {
                    ...
                    ExplorerApp.get().setCurrentUriFragment(new UriFragment(
                        AdministrationNavigator.MANAGEMENT_URI_PART, event.getProperty().getValue().toString()));
                }
                else
                {
                    // Nothing is selected
                    ...
                    ExplorerApp.get().setCurrentUriFragment(new UriFragment(
                        AdministrationNavigator.MANAGEMENT_URI_PART, managementId));
                }
            }
        });
