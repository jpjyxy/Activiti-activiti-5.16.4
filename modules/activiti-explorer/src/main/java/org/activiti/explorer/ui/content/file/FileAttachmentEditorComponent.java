...
public class FileAttachmentEditorComponent extends VerticalLayout implements AttachmentEditorComponent
{
    ...
    protected void initFileUpload()
    {
        ...
        uploadComponent.addFinishedListener(new FinishedListener()
        {
            ...
            public void uploadFinished(FinishedEvent event)
            {
                ...
                successIndicator.setCaption(i18nManager.getMessage(Messages.RELATED_CONTENT_TYPE_FILE_UPLOADED,
                    fileName));
        ...
        throws InvalidValueException
    {
        ...
        if (!fileUploaded)
        {
            InvalidValueException ive =
                new InvalidValueException(i18nManager.getMessage(Messages.RELATED_CONTENT_TYPE_FILE_REQUIRED));
        ...
        else
        {
            ...
            attachment =
                taskService.createAttachment(mimeType,
                    taskId,
                    processInstanceId,
                    getAttachmentName(),
