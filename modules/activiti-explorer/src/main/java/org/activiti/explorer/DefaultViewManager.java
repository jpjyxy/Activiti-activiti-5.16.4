...
public class DefaultViewManager implements ViewManager, Serializable
{
    ...
    public void showTaskPage(String taskId)
    {
        ...
        if (task == null)
        {
            ...
            boolean isOwner =
                historyService.createHistoricTaskInstanceQuery().taskId(taskId).taskOwner(loggedInUserId).count() == 1;
            if (isOwner)
            {
    ...
    protected void showNavigationError(String taskId)
    {
        ExplorerApp.get()
            ...
            .showErrorNotification(Messages.NAVIGATION_ERROR_NOT_INVOLVED_TITLE,
    ...
    {
        switchView(new ProcessDefinitionPage(),
    ...
    {
        switchView(new ProcessDefinitionPage(processDefinitionId),
            ViewManager.MAIN_NAVIGATION_PROCESS,
            ProcessMenuBar.DEPLOYED_PROCESS_DEFINITIONS);
    }
    ...
    {
        switchView(new EditorProcessDefinitionPage(),
            ViewManager.MAIN_NAVIGATION_PROCESS,
    ...
    {
        switchView(new EditorProcessDefinitionPage(modelId),
            ViewManager.MAIN_NAVIGATION_PROCESS,
            ProcessMenuBar.EDITOR_PROCESS_DEFINITIONS);
    }
    ...
    {
        switchView(new MyProcessInstancesPage(),
            ViewManager.MAIN_NAVIGATION_PROCESS,
    ...
    {
        switchView(new MyProcessInstancesPage(processInstanceId),
            ViewManager.MAIN_NAVIGATION_PROCESS,
            ProcessMenuBar.ENTRY_MY_PROCESS_INSTANCES);
    }
    ...
    {
        switchView(new SavedReportsPage(reportId),
    ...
    {
        switchView(new DeploymentPage(deploymentId),
    ...
    {
        switchView(new ActiveProcessDefinitionPage(),
            ViewManager.MAIN_NAVIGATION_MANAGE,
    ...
    {
        switchView(new ActiveProcessDefinitionPage(processDefinitionId),
            ViewManager.MAIN_NAVIGATION_MANAGE,
            ManagementMenuBar.ENTRY_ACTIVE_PROCESS_DEFINITIONS);
    }
    ...
    {
        switchView(new AdministrationPage(managementId),
            ViewManager.MAIN_NAVIGATION_MANAGE,
    ...
    protected void switchView(AbstractPage page, String mainMenuActive, String subMenuActive)
    {
        ...
        {
            page.getToolBar().setActiveEntry(subMenuActive); // Must be set AFTER adding page to window (toolbar will be
                                                             // created in atach())
        }
    }
