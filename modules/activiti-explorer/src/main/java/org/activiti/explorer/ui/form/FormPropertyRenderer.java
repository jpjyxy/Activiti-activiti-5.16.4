...
public interface FormPropertyRenderer extends Serializable
{
    ...
    /**
     * The component to show for the given form-property. Return null if the form-property (and it's label) shouldn't be
     * rendered.
     */
    ...
    /**
     * Extract the string representation of the value set in the field, for the given form property. This value is used
     * as form property value when submitting the (start)form to activiti. The field is the one created by
