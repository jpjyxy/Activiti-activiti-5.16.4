...
public class ChangeProcessSuspensionStatePopupWindow extends PopupWindow
{
    ...
    {
        Label timeLabel =
            new Label(suspend ? i18nManager.getMessage(Messages.PROCESS_SUSPEND_POPUP_TIME_DESCRIPTION)
    ...
    protected void addIncludeProcessInstancesSection(boolean suspend)
    {
        ...
        includeProcessInstancesCheckBox =
            new CheckBox(
                suspend ? i18nManager.getMessage(Messages.PROCESS_SUSPEND_POPUP_INCLUDE_PROCESS_INSTANCES_DESCRIPTION)
