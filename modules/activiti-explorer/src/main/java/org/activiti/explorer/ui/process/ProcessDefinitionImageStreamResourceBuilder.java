...
/**
 * Builder that is capable of creating a {@link StreamResource} for a given process-definition, containing the diagram
 * image, if available.
 * 
...
public class ProcessDefinitionImageStreamResourceBuilder
{
    ...
    public StreamResource buildStreamResource(ProcessInstance processInstance, RepositoryService repositoryService,
        RuntimeService runtimeService, ProcessDiagramGenerator diagramGenerator,
        ...
        if (processDefinition != null && processDefinition.isGraphicalNotationDefined())
        {
            try
            {
                ...
                InputStream definitionImageStream =
                    diagramGenerator.generateDiagram(bpmnModel,
                        "png",
            ...
            catch (Throwable t)
            {
                ...
                LOGGER.warn("Process image cannot be generated due to exception: {} - {}",
                    t.getClass().getName(),
                    t.getMessage());
            }
        }
