...
public class SimpleTableEditor extends AbstractPage
{
    ...
    protected ToolBar initToolbar()
    {
        ...
        toolBar.addToolbarEntry(KEY_EDITOR, ExplorerApp.get()
            .getI18nManager()
            .getMessage(Messages.PROCESS_EDITOR_TITLE), new ToolbarCommand()
        {
        ...
        toolBar.addToolbarEntry(KEY_PREVIEW,
            ExplorerApp.get().getI18nManager().getMessage(Messages.PROCESS_EDITOR_BPMN_PREVIEW),
            new ToolbarCommand()
            {
                public void toolBarItemSelected()
                {
    ...
    protected void initDescriptionField(GridLayout layout)
    {
        ...
        layout.addComponent(new Label(ExplorerApp.get()
            .getI18nManager()
            .getMessage(Messages.PROCESS_EDITOR_DESCRIPTION)));
    ...
    protected void initButtons(GridLayout layout)
    {
        final Button saveButton =
            new Button(ExplorerApp.get().getI18nManager().getMessage(Messages.PROCESS_EDITOR_SAVE));
    ...
    protected void showDiagram()
    {
        StreamResource.StreamSource streamSource = new StreamSource()
        {
            ...
            public InputStream getStream()
            {
                ...
                final ProcessEngineImpl defaultProcessEngine =
                ...
                return diagramGenerator.generateDiagram(workflowDefinitionConversion.getBpmnModel(),
                    "png",
    ...
    protected void save()
    {
        ...
        try
        {
            ...
            ExplorerApp.get()
                .getSimpleWorkflowJsonConverter()
                .writeWorkflowDefinition(workflowDefinition, new OutputStreamWriter(baos));
            ...
            repositoryService.addModelEditorSourceExtra(model.getId(),
                IOUtils.toByteArray(diagramGenerator.generateDiagram(conversion.getBpmnModel(),
                    "png",
                    processEngineConfiguration.getActivityFontName(),
                    processEngineConfiguration.getLabelFontName(),
                    processEngineConfiguration.getClassLoader())));
        ...
        for (int i = 0; i < steps.size(); i++)
        {
            ...
            while (nextIndex < steps.size() && steps.get(nextIndex).isStartsWithPrevious())
            {
                if (parallelStepsDefinition == null)
                {
                    ...
                    ListStepDefinition<ParallelStepsDefinition> listStepDef =
                        new ListStepDefinition<ParallelStepsDefinition>();
