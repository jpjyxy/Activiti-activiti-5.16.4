...
/**
 * Label that renders the given date in a human readable format. The tooltip contains the date, using the default date
 * formatting.
 * 
...
public class PrettyTimeLabel extends Label
{
     ...
     * 
     * @param labelTemplate template to use for date, eg. "Date: {0}". Null, if date/time should just be shown.
     * @param date to show
     * @param noDateCaption caption of label to show when dat is null. Empty label is shown when null.
     */
