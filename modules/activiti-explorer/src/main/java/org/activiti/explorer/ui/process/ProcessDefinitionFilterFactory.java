...
/**
 * Factory class for the {@link ProcessDefinitionFilter} to use when populating process definition list. Regardless of
 * the environment, initialized with a {@link DefaultProcessDefinitionFilter}.
 * 
 * If another filter-impl is needed, this needs to be configured in the environment using the setter-method accessible
 * on this class.
 * 
...
public class ProcessDefinitionFilterFactory implements ComponentFactory<ProcessDefinitionFilter>
{
    ...
    /**
     * @param ComponentFactories the factories that is used to register this class to, when set.
     */
