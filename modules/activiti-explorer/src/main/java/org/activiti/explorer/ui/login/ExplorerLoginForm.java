...
public class ExplorerLoginForm extends LoginForm
{
    ...
    protected byte[] getLoginHTML()
    {
        ...
        b =
            "<body onload='setTarget();'" + "  class='" + ExplorerLayout.STYLE_LOGIN_PAGE + "'>" + "<div>"
                ...
                + "      method='post'>" + "<table width='100%'>" + "<tr><td class='" + STYLE_LOGIN_FIELD_CAPTION
                + "'>" + usernameCaption + "</td>" + "<td width='80%'><input class='" + STYLE_LOGIN_FIELD
                + "' type='text' name='username'></td></tr>" + "<tr><td class='" + STYLE_LOGIN_FIELD_CAPTION + "'>"
                + passwordCaption + "</td>" + "    <td><input class='" + STYLE_LOGIN_FIELD + "'"
                + "          type='password'" + "          name='password'></td></tr>" + "</table>" + "<div>"
                + "<div onclick='document.forms[0].submit();'" + "     tabindex='0' class='" + STYLE_LOGIN_BUTTON
                + "' role='button'>" + "<span>" + submitCaption + "</span>" + "</span></div></div></form></div></body>";
