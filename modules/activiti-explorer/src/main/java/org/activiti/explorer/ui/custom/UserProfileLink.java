...
/**
 * Component that renders link that shows the user's profile in a popup. Optionally, shows the profile picture (if
 * available).
 * 
        ...
        if (renderPicture)
        {
            ...
            if (picture != null)
            {
                Resource imageResource =
                    new StreamResource(new InputStreamStreamSource(picture.getInputStream()), userName
                        + picture.getMimeType(), ExplorerApp.get());
