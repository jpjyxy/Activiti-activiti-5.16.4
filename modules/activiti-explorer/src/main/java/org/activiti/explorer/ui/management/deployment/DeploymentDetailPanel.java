...
public class DeploymentDetailPanel extends DetailPanel
{
    ...
    protected void addDeploymentName()
    {
        ...
        PrettyTimeLabel deployTimeLabel =
            new PrettyTimeLabel(i18nManager.getMessage(Messages.DEPLOYMENT_DEPLOY_TIME),
    ...
    protected void addResourceLinks()
    {
        ...
        if (!resourceNames.isEmpty())
        {
            ...
            for (final String resourceName : resourceNames)
            {
                ...
                Link resourceLink =
                    new Link(resourceName, new StreamResource(streamSource, resourceName, ExplorerApp.get()));
