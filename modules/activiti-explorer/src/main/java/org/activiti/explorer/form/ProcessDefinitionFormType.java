...
public class ProcessDefinitionFormType extends AbstractFormType
{
    ...
    public Object convertFormValueToModelValue(String propertyValue)
    {
        if (propertyValue != null)
        {
            ...
            {
                throw new ActivitiObjectNotFoundException("Process definition with id " + propertyValue
                    + " does not exist", ProcessDefinitionEntity.class);
            }
    ...
    public String convertModelValueToFormValue(Object modelValue)
    {
        ...
        {
            throw new ActivitiIllegalArgumentException("This form type only support process definitions, but is "
                + modelValue.getClass());
        }
