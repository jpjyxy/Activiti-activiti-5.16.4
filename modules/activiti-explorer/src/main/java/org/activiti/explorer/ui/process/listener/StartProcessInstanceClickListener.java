...
public class StartProcessInstanceClickListener implements ClickListener
{
    ...
    public StartProcessInstanceClickListener(ProcessDefinition processDefinition,
    ...
    public void buttonClick(ClickEvent event)
    {
        ...
        if (startFormData != null
            && ((startFormData.getFormProperties() != null && !startFormData.getFormProperties().isEmpty()) || startFormData.getFormKey() != null))
        {
        ...
        else
        {
            ...
            notificationManager.showInformationNotification(Messages.PROCESS_STARTED_NOTIFICATION,
                getProcessDisplayName(processDefinition));
            
            // Switch to inbox page in case a task of this process was created
            List<Task> loggedInUsersTasks =
