...
public class TaskTable extends Table implements TaskFormModelListener
{
    ...
    public void addTaskRow(HumanStepDefinition humanStepDefinition)
    {
        Object taskItemId =
            addTaskRow(null,
                ...
                humanStepDefinition.getAssignee(),
                getCommaSeperated(humanStepDefinition.getCandidateGroups()),
                humanStepDefinition.getDescription(),
        ...
        String taskDescription, Boolean startWithPrevious)
    {
        ...
        try
        {
            for (User user : ProcessEngines.getDefaultProcessEngine()
                .getIdentityService()
                .createUserQuery()
        ...
        try
        {
            for (Group group : ProcessEngines.getDefaultProcessEngine()
                .getIdentityService()
                .createGroupQuery()
                .orderByGroupName()
                .asc()
    ...
    protected HorizontalLayout generateActionButtons(Object taskItemId)
    {
        ...
        Button formButton =
            new Button(form == null ? i18nManager.getMessage(Messages.PROCESS_EDITOR_TASK_FORM_CREATE)
    ...
    public List<HumanStepDefinition> getSteps()
    {
        ...
        for (Object itemId : getItemIds())
        {
            ...
            humanStepDefinition.setStartsWithPrevious((boolean)((CheckBox)item.getItemProperty(ID_START_WITH_PREVIOUS)
