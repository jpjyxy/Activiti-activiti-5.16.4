...
/**
 * Form that renders form-properties and allows posting the filled in value. Performs validation as well. Exposes
 * {@link FormPropertiesEvent}s which allow listening for submission and cancellation of the form.
 * 
...
public class FormPropertiesForm extends VerticalLayout
{
        ...
        submitFormButton.addListener(new ClickListener()
        {
            ...
            public void buttonClick(ClickEvent event)
            {
                ...
                try
                {
                    ...
                    fireEvent(new FormPropertiesEvent(FormPropertiesForm.this, FormPropertiesEvent.TYPE_SUBMIT,
                        formProperties));
    ...
    /**
     * Event indicating a form has been submitted or cancelled. When submitted, the values of the form-properties are
     * available.
     * 
     * @author Frederik Heremans
     */
