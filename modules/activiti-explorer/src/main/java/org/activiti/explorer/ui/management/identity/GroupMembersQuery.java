...
/**
 * {@link LazyLoadingQuery} that queries all members of a given group. Used in the {@link GroupDetailPanel} to display
 * all group members.
 * 
 * @author Joram Barrez
 */
public class GroupMembersQuery extends AbstractLazyLoadingQuery
{
    ...
    class GroupMemberItem extends PropertysetItem
    {
        ...
        public GroupMemberItem(final User user)
        {
            ...
            deleteIcon.addListener(new DeleteMembershipListener(identityService, user.getId(), groupId,
