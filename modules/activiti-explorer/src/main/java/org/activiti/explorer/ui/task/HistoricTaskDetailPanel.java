...
public class HistoricTaskDetailPanel extends DetailPanel
{
    ...
    protected void initHeader()
    {
        ...
        // Add due date
        PrettyTimeLabel dueDateLabel =
            new PrettyTimeLabel(i18nManager.getMessage(Messages.TASK_DUEDATE_SHORT), historicTask.getDueDate(),
                i18nManager.getMessage(Messages.TASK_DUEDATE_UNKNOWN), false);
        ...
        // Add create date
        PrettyTimeLabel createLabel =
            new PrettyTimeLabel(i18nManager.getMessage(Messages.TASK_CREATED_SHORT), historicTask.getStartTime(), "",
                true);
    ...
    protected void initParentTaskLink()
    {
        ...
        {
            final HistoricTaskInstance parentTask =
                historyService.createHistoricTaskInstanceQuery().taskId(historicTask.getParentTaskId()).singleResult();
            
            Button showParentTaskButton =
                new Button(i18nManager.getMessage(Messages.TASK_SUBTASK_OF_PARENT_TASK, parentTask.getName()));
    ...
    protected void initOwner()
    {
        ...
        UserDetailsComponent owner =
            new UserDetailsComponent(historicTask.getOwner(), i18nManager.getMessage(ownerRole));
    ...
    protected void initAssignee()
    {
        ...
        UserDetailsComponent assignee =
            new UserDetailsComponent(historicTask.getAssignee(), i18nManager.getMessage(assigneeRole));
    ...
    protected void initSubTasks()
    {
        ...
        List<HistoricTaskInstance> subTasks =
            historyService.createHistoricTaskInstanceQuery().taskParentTaskId(historicTask.getId()).list();
    ...
    protected void populateRelatedContent(Table table, List<Attachment> attachments)
    {
        ...
        for (Attachment attachment : attachments)
        {
            ...
            attachmentItem.getItemProperty("name").setValue(renderer.getOverviewComponent(attachment,
