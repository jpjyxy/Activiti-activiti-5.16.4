...
/**
 * Generic component for a popup window that allows to display multiple selection tabs on the left, and displays
 * configured components matching those the selection on the right.
 * 
 * Note: For best visual results, the components on the right should be of fixed size, since the window width and heigh
...
public class TabbedSelectionWindow extends PopupWindow
{
     ...
     * @param clickListener The listener that will be attached to the OK button displayed beneath the component.
     */
