...
public class ImageUtil
{
    ...
    /**
     * Resizes the given image (passed as {@link InputStream}. If the image is smaller then the given maximum width or
     * height, the image will be proportionally resized.
     */
