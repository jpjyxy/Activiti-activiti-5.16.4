...
public class EditModelClickListener implements ClickListener
{
    ...
    protected WorkflowDefinition loadWorkflowDefinition()
        throws JsonProcessingException, IOException
    {
        RepositoryService repositoryService = ProcessEngines.getDefaultProcessEngine().getRepositoryService();
        return ExplorerApp.get()
            .getSimpleWorkflowJsonConverter()
            .readWorkflowDefinition(repositoryService.getModelEditorSource(model.getId()));
    }
    ...
    protected void showSelectEditorPopupWindow()
    {
        ...
        selectEditorComponent.getModelerDescriptionLabel().setValue(ExplorerApp.get()
            .getI18nManager()
            .getMessage(Messages.PROCESS_EDITOR_CONVERSION_WARNING_MODELER));
            ...
            public void editorSelectionChanged()
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        ExplorerApp.get()
                            .getViewManager()
                            .showSimpleTableProcessEditor(model.getId(), workflowDefinition);
        ...
        throws MalformedURLException
    {
        ...
        URL url =
            new URL(explorerURL.getProtocol(), explorerURL.getHost(), explorerURL.getPort(), explorerURL.getPath()
                .replace("/ui", "") + "service/editor?id=" + model.getId());
