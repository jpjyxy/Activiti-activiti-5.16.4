...
public class TaskDetailPanel extends DetailPanel
{
    ...
    protected void initCreateTime(HorizontalLayout propertiesLayout)
    {
        PrettyTimeLabel createLabel =
            new PrettyTimeLabel(i18nManager.getMessage(Messages.TASK_CREATED_SHORT), task.getCreateTime(), "", true);
    ...
    protected void initProcessLink()
    {
        if (task.getProcessInstanceId() != null)
        {
            ...
            Button showProcessInstanceButton =
                new Button(i18nManager.getMessage(Messages.TASK_PART_OF_PROCESS,
    ...
    public void notifyAssigneeChanged()
    {
        ...
        { // switch view to inbox if assignee is current user
    ...
    public void notifyOwnerChanged()
    {
        ...
        { // switch view to tasks if owner is current user
