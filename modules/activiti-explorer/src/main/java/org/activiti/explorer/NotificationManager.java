...
public class NotificationManager implements Serializable
{
    ...
    public void showWarningNotification(String captionKey, String descriptionKey)
    {
        Notification notification =
            new Notification(i18nManager.getMessage(captionKey), i18nManager.getMessage(descriptionKey),
    ...
    {
        Notification notification =
            new Notification(i18nManager.getMessage(captionKey) + "<br/>",
                MessageFormat.format(i18nManager.getMessage(descriptionKey), params), Notification.TYPE_WARNING_MESSAGE);
