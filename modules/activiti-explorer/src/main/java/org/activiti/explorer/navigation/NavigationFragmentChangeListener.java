...
/**
 * FragmentChangedListener that is responsible to navigating the application to the right page depending on the URI
 * fragment.
 * 
    ...
    public void fragmentChanged(FragmentChangedEvent source)
    {
            ...
            && !ExplorerApp.get().getCurrentUriFragment().getUriParts().isEmpty())
        {
            ...
            Navigator navigationHandler =
                navigatorManager.getNavigator(ExplorerApp.get().getCurrentUriFragment().getUriParts().get(0));
