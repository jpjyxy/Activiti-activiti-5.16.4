...
/**
 * Component that can be used to upload files using file-select and HTML5 file dragging. Exposes events to listen to
 * upload start, progress, finish and cancel.
 * 
 * @author Joram Barrez
 * @author Frederik Heremans
 */
public class UploadComponent extends VerticalLayout implements StartedListener, FinishedListener, FailedListener,
    ProgressListener, DropHandler
{
