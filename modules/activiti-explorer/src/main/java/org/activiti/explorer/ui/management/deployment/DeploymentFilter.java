...
/**
 * Class used in {@link DeploymentListQuery} for filtering and consulted right before a new {@link Deployment} is about
 * to be deployed through the UI.
 * 
...
public interface DeploymentFilter
{
    ...
    /**
     * Called right before the deployment, created in the UI, is deployed to the API. This allows to ad additional
     * artifacts or alter deployment properties.
     */
