...
public class ActiveProcessDefinitionPage extends ManagementPage
{
    ...
    public ActiveProcessDefinitionPage()
    {
        ExplorerApp.get().setCurrentUriFragment(new UriFragment(
            ActiveProcessDefinitionNavigator.ACTIVE_PROC_DEF_URI_PART));
    }
        ...
        processDefinitionTable.addListener(new Property.ValueChangeListener()
        {
            ...
            public void valueChange(ValueChangeEvent event)
            {
                ...
                if (item != null)
                {
                    ...
                    setDetailComponent(new ActiveProcessDefinitionDetailPanel(processDefinitionId,
                        ActiveProcessDefinitionPage.this));
                    
                    // Update URL
                    ExplorerApp.get().setCurrentUriFragment(new UriFragment(
                        ActiveProcessDefinitionNavigator.ACTIVE_PROC_DEF_URI_PART, processDefinitionId));
