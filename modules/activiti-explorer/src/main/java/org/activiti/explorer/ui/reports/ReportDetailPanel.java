...
public class ReportDetailPanel extends DetailPanel
{
            ...
            processDefinitionStartForm.addListener(new FormPropertiesEventListener()
            {
                ...
                protected void handleFormSubmit(FormPropertiesEvent event)
                {
                    ...
                    ProcessInstance processInstance =
                        startProcessInstanceWithFormProperties(processDefinition.getId(), event.getFormProperties());
    ...
    protected ProcessInstance startProcessInstanceWithFormProperties(String processDefinitonId,
