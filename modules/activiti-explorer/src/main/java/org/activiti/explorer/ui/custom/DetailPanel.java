...
/**
 * Panel that should be used for main-content. Use {@link #setDetailContainer(ComponentContainer)} and
 * {@link #setFixedButtons(Component)} to add main components. By default, the detailContent will be a verticallayout
 * which has 100% width and undefined height and margins enabled. Add components to detail container using
...
public class DetailPanel extends VerticalLayout
{
    ...
    /**
     * Set the component that is rendered in a fixed position below the content. When content is scrolled, this
     * component stays visible all the time.
     */
