...
/**
 * A {@link ColumnGenerator} that always returns the same component to render, which is an {@link Embeddable} containing
 * the theme image passed in the constructor.
 * 
