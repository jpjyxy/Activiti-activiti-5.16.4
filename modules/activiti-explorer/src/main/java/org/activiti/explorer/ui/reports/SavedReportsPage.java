...
public class SavedReportsPage extends AbstractTablePage
{
    ...
    protected Table createList()
    {
        ...
        reportTable.addListener(new Property.ValueChangeListener()
        {
            ...
            {
                Item item = reportTable.getItem(event.getProperty().getValue()); // the value of the property is the
                ...
                else
                {
                    ...
                    ExplorerApp.get()
                        .setCurrentUriFragment(new UriFragment(SavedReportNavigator.SAVED_REPORT_URI_PART));
                }
            }
