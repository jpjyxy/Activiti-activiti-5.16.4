...
public class HumanTime
{
    ...
    private static final List<TimeUnit> timeUnits = Arrays.asList(new YearTimeUnit(),
        new MonthTimeUnit(),
        new WeekTimeUnit(),
        new DayTimeUnit(),
        new HourTimeUnit(),
    ...
    private String getUnitMessage(Long difference)
    {
        ...
        else
        {
            ...
            Long numberOfUnits =
                (difference - (difference % unitToUse.getNumberOfMillis())) / unitToUse.getNumberOfMillis();
