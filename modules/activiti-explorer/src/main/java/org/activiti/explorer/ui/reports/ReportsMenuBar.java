...
public class ReportsMenuBar extends ToolBar
{
    ...
    {
        addToolbarEntry(ENTRY_RUN_REPORTS,
            i18nManager.getMessage(Messages.REPORTING_MENU_RUN_REPORTS),
            new ToolbarCommand()
            {
    ...
    {
        addToolbarEntry(ENTRY_SAVED_REPORTS,
            i18nManager.getMessage(Messages.REPORTING_MENU_SAVED_REPORTS),
            new ToolbarCommand()
            {
                public void toolBarItemSelected()
                {
