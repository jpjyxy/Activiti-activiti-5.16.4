...
public abstract class AbstractPage extends CustomComponent
{
    ...
    /**
     * Returns an implementation of {@link AbstractSelect}, which will be displayed on the left side of the page,
     ...
     * 
     * Return null by default: no event-component will be used, in that case the main UI will be two columns instead of
     * three.
     * 
