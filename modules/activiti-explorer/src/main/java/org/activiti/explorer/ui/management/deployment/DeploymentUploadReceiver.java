...
public class DeploymentUploadReceiver implements Receiver, FinishedListener
{
    ...
    protected void deployUploadedFile()
    {
        ...
        DeploymentFilter deploymentFilter =
            ExplorerApp.get().getComponentFactory(DeploymentFilterFactory.class).create();
        try
        {
            try
            {
                ...
                {
                    validFile = true;
                    deploymentBuilder.addZipInputStream(new ZipInputStream(new ByteArrayInputStream(
