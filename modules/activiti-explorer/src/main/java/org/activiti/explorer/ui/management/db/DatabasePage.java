...
public class DatabasePage extends ManagementPage
{
    ...
    protected transient ManagementService managementService = ProcessEngines.getDefaultProcessEngine()
    ...
    {
        TreeMap<String, Long> tables = new TreeMap<String, Long>(managementService.getTableCount()); // treemap because
                                                                                                     // we want to sort
                                                                                                     // it on name
