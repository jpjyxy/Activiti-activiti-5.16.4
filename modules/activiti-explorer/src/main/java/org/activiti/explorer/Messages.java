...
public interface Messages
{
    ...
    String PROCESS_ACTIVATE_POPUP_INCLUDE_PROCESS_INSTANCES_DESCRIPTION =
        "process.activate.popup.process.instances.description";
    ...
    String PROCESS_SUSPEND_POPUP_INCLUDE_PROCESS_INSTANCES_DESCRIPTION =
