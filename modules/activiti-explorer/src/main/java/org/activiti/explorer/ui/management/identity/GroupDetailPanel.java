...
public class GroupDetailPanel extends DetailPanel implements MemberShipChangeListener
{
        ...
        deleteButton.addListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                ConfirmationDialogPopupWindow confirmPopup =
                    new ConfirmationDialogPopupWindow(i18nManager.getMessage(Messages.GROUP_CONFIRM_DELETE,
                        group.getId()));
    ...
    protected void initAddMembersButton(HorizontalLayout membersHeader)
    {
        ...
        addButton.addListener(new ClickListener()
        {
            public void buttonClick(ClickEvent event)
            {
                final SelectUsersPopupWindow selectUsersPopup =
                    new SelectUsersPopupWindow(i18nManager.getMessage(Messages.GROUP_SELECT_MEMBERS, group.getId()),
