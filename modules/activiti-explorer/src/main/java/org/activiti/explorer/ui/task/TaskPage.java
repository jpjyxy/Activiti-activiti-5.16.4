...
/**
 * Abstract super class for all task pages (inbox, queued, archived, etc.), Builds up the default UI: task list on the
 * left, central panel and events on the right.
 * 
 * @author Joram Barrez
 */
public abstract class TaskPage extends AbstractTablePage
{
    ...
    protected ValueChangeListener getListSelectionListener()
    {
        return new Property.ValueChangeListener()
        {
            ...
            {
                Item item = taskTable.getItem(event.getProperty().getValue()); // the value of the property is the
