...
public class PlaybackRunTest
{
    ...
    private static final String THE_SIMPLEST_PROCESS =
        "org/activiti/crystalball/simulator/impl/playback/PlaybackProcessStartTest.testDemo.bpmn20.xml";
    ...
    private void checkStatus(ProcessEngine processEngine)
    {
        ...
        final HistoricProcessInstance historicProcessInstance =
            historyService.createHistoricProcessInstanceQuery().finished().includeProcessVariables().singleResult();
