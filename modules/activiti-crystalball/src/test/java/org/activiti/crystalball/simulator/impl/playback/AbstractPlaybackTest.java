...
public abstract class AbstractPlaybackTest extends AbstractActivitiTestCase
{
    ...
    protected void initializeProcessEngine()
    {
        ...
        this.processEngine =
            (new RecordableProcessEngineFactory((ProcessEngineConfigurationImpl)processEngineConfiguration, listener)).getObject();
    }
        ...
        throws Throwable
    {
        ...
        try
        {
            ...
            FactoryBean<ProcessEngineImpl> simulationProcessEngineFactory =
                new SimulationProcessEngineFactory(
                    ProcessEngineConfiguration.createProcessEngineConfigurationFromResourceDefault());
        ...
        throws InvocationTargetException, IllegalAccessException
    {
        ...
        {
            log.warn("Could not get method by reflection. This could happen if you are using @Parameters in combination with annotations.",
                e);
            return;
        }
        ...
        if (checkStatusAnnotation != null)
        {
            ...
            {
                log.error("Could not get CheckStatus method: {} by reflection. This could happen if you are using @Parameters in combination with annotations.",
                    checkStatusMethodName,
                    e);
