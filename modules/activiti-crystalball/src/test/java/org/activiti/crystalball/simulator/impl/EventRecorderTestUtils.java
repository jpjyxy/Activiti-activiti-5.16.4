...
public final class EventRecorderTestUtils
{
    ...
    /**
     * increase clockUtils time Simulation operates in milliseconds. Sometime could happen (especially during automated
     * tests) that 2 recorded events have the same time. In that case it is not possible to recognize order.
     */
