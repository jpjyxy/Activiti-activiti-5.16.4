...
public class StartReplayProcessEventHandler implements SimulationEventHandler
{
    ...
    public StartReplayProcessEventHandler(String processInstanceId, String eventTypeToReplay,
        String eventTypeToSchedule, Collection<SimulationEvent> events, String processToStartIdKey, String businessKey,
        String variablesKey)
    {
    ...
    public void init()
    {
        ...
        SimulationEvent startEvent =
            new SimulationEvent.Builder(eventTypeToSchedule).properties(toReplayStartEvent.getProperties()).build();
    ...
    private SimulationEvent findProcessInstanceStartEvent()
    {
        ...
        {
            if (eventTypeToReplay.equals(event.getType())
                && processInstanceId.equals(event.getProperty(ProcessInstanceCreateTransformer.PROCESS_INSTANCE_ID)))
            {
                return event;
            }
        }
    ...
    public void handle(SimulationEvent event)
    {
        ...
        log.debug("Starting new processDefId[{}] businessKey[{}] with variables[{}]",
            processDefinitionId,
            businessKey,
            variables);
