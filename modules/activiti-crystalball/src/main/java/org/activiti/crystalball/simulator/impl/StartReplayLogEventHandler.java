...
public class StartReplayLogEventHandler implements SimulationEventHandler
{
    ...
    public StartReplayLogEventHandler(String processInstanceId, String processToStartIdKey, String businessKey,
        String variablesKey)
    {
    ...
    public void handle(SimulationEvent event)
    {
        ...
        log.debug("Starting new processDefId[{}] businessKey[{}] with variables[{}]",
            ...
            startBusinessKey,
            variables);
        SimulationRunContext.getRuntimeService().startProcessInstanceById(processDefinitionId,
            startBusinessKey,
            variables);
    }
}
