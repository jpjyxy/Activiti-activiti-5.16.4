...
/**
 * This class provides simulation run for replay purposes replay uses real time and running engine to execute simulation
 * events.
 * 
...
public class ReplaySimulationRun extends AbstractSimulationRun
{
    ...
    {
        this(processEngine, new SimpleEventCalendar(processEngine.getProcessEngineConfiguration().getClock(),
            new SimulationEventComparator()), customEventHandlerMap);
    }
    
    public ReplaySimulationRun(ProcessEngine processEngine, EventCalendar eventCalendar,
