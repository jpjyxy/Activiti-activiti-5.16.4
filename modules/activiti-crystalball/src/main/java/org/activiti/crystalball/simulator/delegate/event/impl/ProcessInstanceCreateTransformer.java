...
public class ProcessInstanceCreateTransformer extends Activiti2SimulationEventFunction
{
    ...
    public ProcessInstanceCreateTransformer(String simulationEventType, String processDefinitionIdKey,
    ...
    {
        if (ActivitiEventType.ENTITY_INITIALIZED.equals(event.getType()) && (event instanceof ActivitiEntityEvent)
            ...
            && ((ExecutionEntity)((ActivitiEntityEvent)event).getEntity()).isProcessInstanceType())
        {
            ...
            return new SimulationEvent.Builder(simulationEventType).simulationTime(Context.getProcessEngineConfiguration()
                .getClock()
                .getCurrentTime()
                .getTime())
