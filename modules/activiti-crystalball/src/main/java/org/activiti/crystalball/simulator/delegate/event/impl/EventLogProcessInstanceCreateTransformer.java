...
public class EventLogProcessInstanceCreateTransformer extends EventLog2SimulationEventFunction
{
    ...
    public EventLogProcessInstanceCreateTransformer(String simulationEventType, String processDefinitionIdKey,
    ...
    public SimulationEvent apply(EventLogEntry event)
    {
        if ("PROCESSINSTANCE_START".equals(event.getType()))
        {
            ...
            return new SimulationEvent.Builder(simulationEventType).priority((int)event.getLogNumber())
